...
describe('TicketTypeAttributeEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    // UPDATE
    const ticket_type_attribute_ref01_data_up0: any = {}
    ...
    ;(ticket_type_attribute_ref01_data_up0 as any)[ticket_type_attribute_ref01_markdef_up0.name] = ticket_type_attribute_ref01_markdef_up0.value
    ...
    assert((ticket_type_attribute_ref01_resdata_up0 as any)[ticket_type_attribute_ref01_markdef_up0.name] === ticket_type_attribute_ref01_markdef_up0.value)
