...
(0, node_test_1.describe)('WhatsappMessageStatusListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-whatsapp_message_status_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-whatsapp_message_status_list', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_WHATSAPP_MESSAGE_STATUS_LIST_ENTID'];
...
//# sourceMappingURL=WhatsappMessageStatusListDirect.test.js.map