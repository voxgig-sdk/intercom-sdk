...
(0, node_test_1.describe)('AiCallDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ai_call', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ai_call', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["conversation_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_AI_CALL_ENTID'];
...
//# sourceMappingURL=AiCallDirect.test.js.map