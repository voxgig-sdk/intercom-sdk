...
(0, node_test_1.describe)('ConversationAttributeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-conversation_attribute', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-conversation_attribute', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_CONVERSATION_ATTRIBUTE_ENTID'];
...
//# sourceMappingURL=ConversationAttributeDirect.test.js.map