...
(0, node_test_1.describe)('TicketTypeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ticket_type', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ticket_type', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-ticket_type', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-ticket_type', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_TICKET_TYPE_ENTID'];
...
//# sourceMappingURL=TicketTypeDirect.test.js.map