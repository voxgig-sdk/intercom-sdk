...
(0, node_test_1.describe)('ActivityLogDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-activity_log', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-activity_log', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            query.created_at_after = "1677253093";
        }
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_ACTIVITY_LOG_ENTID'];
...
//# sourceMappingURL=ActivityLogDirect.test.js.map