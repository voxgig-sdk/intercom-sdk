...
(0, node_test_1.describe)('CompanyScrollEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'company_scroll.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/company_scroll/CompanyScrollTestData.json');
    ...
    let idmap = transform(['company_scroll01', 'company_scroll02', 'company_scroll03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CompanyScrollEntity.test.js.map