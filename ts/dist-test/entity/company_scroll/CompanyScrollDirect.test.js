...
(0, node_test_1.describe)('CompanyScrollDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-company_scroll', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-company_scroll', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_COMPANY_SCROLL_ENTID'];
...
//# sourceMappingURL=CompanyScrollDirect.test.js.map