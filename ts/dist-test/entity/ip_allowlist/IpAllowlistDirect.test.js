...
(0, node_test_1.describe)('IpAllowlistDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-ip_allowlist', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-ip_allowlist', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_IP_ALLOWLIST_ENTID'];
...
//# sourceMappingURL=IpAllowlistDirect.test.js.map