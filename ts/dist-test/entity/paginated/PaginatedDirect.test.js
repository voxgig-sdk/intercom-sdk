...
(0, node_test_1.describe)('PaginatedDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-paginated', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-paginated', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["newsfeed01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_PAGINATED_ENTID'];
...
//# sourceMappingURL=PaginatedDirect.test.js.map