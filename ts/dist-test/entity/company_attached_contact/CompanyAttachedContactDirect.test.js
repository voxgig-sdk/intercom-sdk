...
(0, node_test_1.describe)('CompanyAttachedContactDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-company_attached_contact', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-company_attached_contact', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["company_attached_contact01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_COMPANY_ATTACHED_CONTACT_ENTID'];
...
//# sourceMappingURL=CompanyAttachedContactDirect.test.js.map