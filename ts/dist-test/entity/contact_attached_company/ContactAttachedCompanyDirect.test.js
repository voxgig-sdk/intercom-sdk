...
(0, node_test_1.describe)('ContactAttachedCompanyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-contact_attached_company', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-contact_attached_company', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["contact_attached_company01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_CONTACT_ATTACHED_COMPANY_ENTID'];
...
//# sourceMappingURL=ContactAttachedCompanyDirect.test.js.map