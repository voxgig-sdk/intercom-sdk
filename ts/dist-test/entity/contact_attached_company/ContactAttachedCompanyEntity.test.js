...
function basicSetup(extra) {
    ...
    let idmap = transform(['contact_attached_company01', 'contact_attached_company02', 'contact_attached_company03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
