...
(0, node_test_1.describe)('HelpCenterDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-help_center', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-help_center', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-help_center', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-help_center', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["help_center01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_HELP_CENTER_ENTID'];
...
//# sourceMappingURL=HelpCenterDirect.test.js.map