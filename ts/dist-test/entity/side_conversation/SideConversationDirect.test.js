...
(0, node_test_1.describe)('SideConversationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-side_conversation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-side_conversation', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["conversation01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_SIDE_CONVERSATION_ENTID'];
...
//# sourceMappingURL=SideConversationDirect.test.js.map