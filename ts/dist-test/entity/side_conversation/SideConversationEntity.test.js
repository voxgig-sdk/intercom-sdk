...
(0, node_test_1.describe)('SideConversationEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/side_conversation/SideConversationTestData.json');
    ...
    let idmap = transform(['side_conversation01', 'side_conversation02', 'side_conversation03', 'conversation01', 'conversation02', 'conversation03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=SideConversationEntity.test.js.map