...
(0, node_test_1.describe)('DeletedInternalArticleObjectDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-deleted_internal_article_object', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-deleted_internal_article_object', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_DELETED_INTERNAL_ARTICLE_OBJECT_ENTID'];
...
//# sourceMappingURL=DeletedInternalArticleObjectDirect.test.js.map