...
(0, node_test_1.describe)('TicketDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ticket', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ticket', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_TICKET_ENTID'];
...
//# sourceMappingURL=TicketDirect.test.js.map