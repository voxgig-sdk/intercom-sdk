...
(0, node_test_1.describe)('InternalArticleSearchEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'internal_article_search.' + op, live))
                return;
        }
        ...
        let internal_article_search_ref01_data = Object.values(setup.data.existing.internal_article_search)[0];
        // LOAD
        const internal_article_search_ref01_ent = client.InternalArticleSearch();
        const internal_article_search_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(null != internal_article_search_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/internal_article_search/InternalArticleSearchTestData.json');
    ...
    let idmap = transform(['internal_article_search01', 'internal_article_search02', 'internal_article_search03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=InternalArticleSearchEntity.test.js.map