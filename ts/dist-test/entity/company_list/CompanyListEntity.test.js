...
(0, node_test_1.describe)('CompanyListEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != company_list_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/company_list/CompanyListTestData.json');
    ...
    let idmap = transform(['company_list01', 'company_list02', 'company_list03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CompanyListEntity.test.js.map