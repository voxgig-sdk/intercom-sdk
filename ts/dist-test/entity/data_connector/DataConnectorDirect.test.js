...
(0, node_test_1.describe)('DataConnectorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-data_connector', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-data_connector', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-data_connector', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-data_connector', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_DATA_CONNECTOR_ENTID'];
...
//# sourceMappingURL=DataConnectorDirect.test.js.map