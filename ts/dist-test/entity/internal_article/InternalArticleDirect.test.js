...
(0, node_test_1.describe)('InternalArticleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-internal_article', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-internal_article', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_INTERNAL_ARTICLE_ENTID'];
...
//# sourceMappingURL=InternalArticleDirect.test.js.map