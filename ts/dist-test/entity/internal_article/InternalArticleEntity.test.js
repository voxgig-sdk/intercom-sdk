...
(0, node_test_1.describe)('InternalArticleEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(internal_article_ref01_resdata_up0.id === internal_article_ref01_data_up0.id);
        (0, node_assert_1.default)(internal_article_ref01_resdata_up0[internal_article_ref01_markdef_up0.name] === internal_article_ref01_markdef_up0.value);
        // LOAD
        ...
        (0, node_assert_1.default)(internal_article_ref01_data_dt0.id === internal_article_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/internal_article/InternalArticleTestData.json');
    ...
    let idmap = transform(['internal_article01', 'internal_article02', 'internal_article03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=InternalArticleEntity.test.js.map