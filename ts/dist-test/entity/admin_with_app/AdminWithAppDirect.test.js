...
(0, node_test_1.describe)('AdminWithAppDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-admin_with_app', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-admin_with_app', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_ADMIN_WITH_APP_ENTID'];
...
//# sourceMappingURL=AdminWithAppDirect.test.js.map