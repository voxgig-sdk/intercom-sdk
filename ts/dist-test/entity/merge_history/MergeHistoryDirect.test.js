...
(0, node_test_1.describe)('MergeHistoryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-merge_history', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-merge_history', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["contact01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_MERGE_HISTORY_ENTID'];
...
//# sourceMappingURL=MergeHistoryDirect.test.js.map