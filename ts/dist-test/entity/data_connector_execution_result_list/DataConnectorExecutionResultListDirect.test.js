...
(0, node_test_1.describe)('DataConnectorExecutionResultListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-data_connector_execution_result_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-data_connector_execution_result_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["data_connector_execution_result_list01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_DATA_CONNECTOR_EXECUTION_RESULT_LIST_ENTID'];
...
//# sourceMappingURL=DataConnectorExecutionResultListDirect.test.js.map