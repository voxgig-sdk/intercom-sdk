...
(0, node_test_1.describe)('ArticleVersionListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-article_version_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-article_version_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["article_version_list01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_ARTICLE_VERSION_LIST_ENTID'];
...
//# sourceMappingURL=ArticleVersionListDirect.test.js.map