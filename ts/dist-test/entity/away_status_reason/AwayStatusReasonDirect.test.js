...
(0, node_test_1.describe)('AwayStatusReasonDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-away_status_reason', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-away_status_reason', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_AWAY_STATUS_REASON_ENTID'];
...
//# sourceMappingURL=AwayStatusReasonDirect.test.js.map