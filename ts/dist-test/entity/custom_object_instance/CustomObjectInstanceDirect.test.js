...
(0, node_test_1.describe)('CustomObjectInstanceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-custom_object_instance', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-custom_object_instance', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_CUSTOM_OBJECT_INSTANCE_ENTID'];
...
//# sourceMappingURL=CustomObjectInstanceDirect.test.js.map