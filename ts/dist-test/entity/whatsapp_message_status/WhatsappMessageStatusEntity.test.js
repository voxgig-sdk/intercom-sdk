...
(0, node_test_1.describe)('WhatsappMessageStatusEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != whatsapp_message_status_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/whatsapp_message_status/WhatsappMessageStatusTestData.json');
    ...
    let idmap = transform(['whatsapp_message_status01', 'whatsapp_message_status02', 'whatsapp_message_status03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=WhatsappMessageStatusEntity.test.js.map