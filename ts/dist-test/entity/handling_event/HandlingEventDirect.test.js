...
(0, node_test_1.describe)('HandlingEventDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-handling_event', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-handling_event', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_HANDLING_EVENT_ENTID'];
...
//# sourceMappingURL=HandlingEventDirect.test.js.map