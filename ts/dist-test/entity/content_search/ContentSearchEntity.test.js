...
(0, node_test_1.describe)('ContentSearchEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/content_search/ContentSearchTestData.json');
    ...
    let idmap = transform(['content_search01', 'content_search02', 'content_search03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ContentSearchEntity.test.js.map