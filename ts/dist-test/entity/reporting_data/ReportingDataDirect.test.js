...
(0, node_test_1.describe)('ReportingDataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-reporting_data', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-reporting_data', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_REPORTING_DATA_ENTID'];
...
//# sourceMappingURL=ReportingDataDirect.test.js.map