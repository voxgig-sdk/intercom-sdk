...
(0, node_test_1.describe)('ExternalPageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-external_page', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-external_page', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-external_page', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-external_page', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_EXTERNAL_PAGE_ENTID'];
...
//# sourceMappingURL=ExternalPageDirect.test.js.map