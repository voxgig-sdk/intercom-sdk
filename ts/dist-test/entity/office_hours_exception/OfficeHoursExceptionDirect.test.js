...
(0, node_test_1.describe)('OfficeHoursExceptionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-office_hours_exception', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-office_hours_exception', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-office_hours_exception', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-office_hours_exception', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["office_hours_schedule01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.INTERCOM_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.IntercomSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.INTERCOM_APIKEY,
        }));
        let idmap = env['INTERCOM_TEST_OFFICE_HOURS_EXCEPTION_ENTID'];
...
//# sourceMappingURL=OfficeHoursExceptionDirect.test.js.map