...
function basicSetup(extra) {
    ...
    let idmap = transform(['contact_segment01', 'contact_segment02', 'contact_segment03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
