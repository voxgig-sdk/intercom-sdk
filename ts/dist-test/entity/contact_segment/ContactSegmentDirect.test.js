...
(0, node_test_1.describe)('ContactSegmentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-contact_segment', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-contact_segment', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["contact_segment01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_CONTACT_SEGMENT_ENTID'];
...
//# sourceMappingURL=ContactSegmentDirect.test.js.map