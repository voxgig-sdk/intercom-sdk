...
(0, node_test_1.describe)('NewsItemDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-news_item', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-news_item', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_NEWS_ITEM_ENTID'];
...
//# sourceMappingURL=NewsItemDirect.test.js.map