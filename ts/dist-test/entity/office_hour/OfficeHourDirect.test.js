...
(0, node_test_1.describe)('OfficeHourDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-office_hour', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-office_hour', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_OFFICE_HOUR_ENTID'];
...
//# sourceMappingURL=OfficeHourDirect.test.js.map