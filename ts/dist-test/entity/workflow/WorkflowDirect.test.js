...
(0, node_test_1.describe)('WorkflowDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-workflow', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-workflow', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_WORKFLOW_ENTID'];
...
//# sourceMappingURL=WorkflowDirect.test.js.map