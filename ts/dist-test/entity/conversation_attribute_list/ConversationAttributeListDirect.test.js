...
(0, node_test_1.describe)('ConversationAttributeListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-conversation_attribute_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-conversation_attribute_list', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_CONVERSATION_ATTRIBUTE_LIST_ENTID'];
...
//# sourceMappingURL=ConversationAttributeListDirect.test.js.map