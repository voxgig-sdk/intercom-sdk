...
(0, node_test_1.describe)('ContentSnippetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-content_snippet', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-content_snippet', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-content_snippet', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-content_snippet', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_CONTENT_SNIPPET_ENTID'];
...
//# sourceMappingURL=ContentSnippetDirect.test.js.map