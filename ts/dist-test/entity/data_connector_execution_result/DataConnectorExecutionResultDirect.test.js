...
(0, node_test_1.describe)('DataConnectorExecutionResultDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-data_connector_execution_result', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-data_connector_execution_result', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_DATA_CONNECTOR_EXECUTION_RESULT_ENTID'];
...
//# sourceMappingURL=DataConnectorExecutionResultDirect.test.js.map