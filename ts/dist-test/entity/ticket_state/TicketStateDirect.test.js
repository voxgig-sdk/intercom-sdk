...
(0, node_test_1.describe)('TicketStateDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-ticket_state', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-ticket_state', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_TICKET_STATE_ENTID'];
...
//# sourceMappingURL=TicketStateDirect.test.js.map