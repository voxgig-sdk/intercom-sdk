...
(0, node_test_1.describe)('ArticleVersionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-article_version', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-article_version', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_ARTICLE_VERSION_ENTID'];
...
//# sourceMappingURL=ArticleVersionDirect.test.js.map