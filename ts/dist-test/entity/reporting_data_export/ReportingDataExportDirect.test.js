...
(0, node_test_1.describe)('ReportingDataExportDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-reporting_data_export', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-reporting_data_export', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_REPORTING_DATA_EXPORT_ENTID'];
...
//# sourceMappingURL=ReportingDataExportDirect.test.js.map