...
(0, node_test_1.describe)('DataEventSummaryDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-data_event_summary', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-data_event_summary', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_DATA_EVENT_SUMMARY_ENTID'];
...
//# sourceMappingURL=DataEventSummaryDirect.test.js.map