...
(0, node_test_1.describe)('ActivityLogEventTypeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-activity_log_event_type', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-activity_log_event_type', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_ACTIVITY_LOG_EVENT_TYPE_ENTID'];
...
//# sourceMappingURL=ActivityLogEventTypeDirect.test.js.map