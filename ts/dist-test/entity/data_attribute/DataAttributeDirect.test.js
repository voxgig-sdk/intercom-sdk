...
(0, node_test_1.describe)('DataAttributeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-data_attribute', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-data_attribute', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INTERCOM_TEST_DATA_ATTRIBUTE_ENTID'];
...
//# sourceMappingURL=DataAttributeDirect.test.js.map