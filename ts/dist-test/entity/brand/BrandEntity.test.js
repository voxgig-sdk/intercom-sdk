...
(0, node_test_1.describe)('BrandEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(brand_ref01_data_dt0.id === brand_ref01_data.id);
    });
});
