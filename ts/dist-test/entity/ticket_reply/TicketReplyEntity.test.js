...
function basicSetup(extra) {
    ...
    let idmap = transform(['ticket_reply01', 'ticket_reply02', 'ticket_reply03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
