...
exports.AiContentEntity = void 0;
const IntercomEntityBase_1 = require("../IntercomEntityBase");
// TODO: needs Entity superclass
class AiContentEntity extends IntercomEntityBase_1.IntercomEntityBase {
    constructor(client, entopts) {
        super(client, entopts);
        this.name = 'ai_content';
        this.name_ = 'ai_content';
        this.Name = 'AiContent';
    }
    make() {
        return new AiContentEntity(this._client, this.entopts());
    }
    ...
    async remove(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<AiContentEntity> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.AiContentEntity = AiContentEntity;
//# sourceMappingURL=AiContentEntity.js.map