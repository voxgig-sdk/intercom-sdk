...
import type {
  ...
  DeletedCompanyObjectRemoveMatch,
} from '../IntercomTypes'

// TODO: needs Entity superclass
class DeletedCompanyObjectEntity extends IntercomEntityBase<DeletedCompanyObject> {

  constructor(client: IntercomSDK, entopts: any) {
    super(client, entopts)
    this.name = 'deleted_company_object'
    this.name_ = 'deleted_company_object'
    this.Name = 'DeletedCompanyObject'
  }


  make(this: DeletedCompanyObjectEntity) {
    return new DeletedCompanyObjectEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: DeletedCompanyObjectRemoveMatch, ctrl?: Control,
  ): Promise<DeletedCompanyObjectEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<DeletedCompanyObjectEntity> return stays clean under strict null checks.
