...
import type {
  DeletedObject,
  DeletedObjectRemoveMatch,
} from '../IntercomTypes'

// TODO: needs Entity superclass
class DeletedObjectEntity extends IntercomEntityBase<DeletedObject> {

  constructor(client: IntercomSDK, entopts: any) {
    super(client, entopts)
    this.name = 'deleted_object'
    this.name_ = 'deleted_object'
    this.Name = 'DeletedObject'
  }


  make(this: DeletedObjectEntity) {
    return new DeletedObjectEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: DeletedObjectRemoveMatch, ctrl?: Control,
  ): Promise<DeletedObjectEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<DeletedObjectEntity> return stays clean under strict null checks.
