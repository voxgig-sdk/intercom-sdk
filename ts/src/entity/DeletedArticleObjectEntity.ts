...
import type {
  ...
  DeletedArticleObjectRemoveMatch,
} from '../IntercomTypes'

// TODO: needs Entity superclass
class DeletedArticleObjectEntity extends IntercomEntityBase<DeletedArticleObject> {

  constructor(client: IntercomSDK, entopts: any) {
    super(client, entopts)
    this.name = 'deleted_article_object'
    this.name_ = 'deleted_article_object'
    this.Name = 'DeletedArticleObject'
  }


  make(this: DeletedArticleObjectEntity) {
    return new DeletedArticleObjectEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: DeletedArticleObjectRemoveMatch, ctrl?: Control,
  ): Promise<DeletedArticleObjectEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<DeletedArticleObjectEntity> return stays clean under strict null checks.
