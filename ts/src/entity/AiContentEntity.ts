...
import type {
  AiContent,
  AiContentRemoveMatch,
} from '../IntercomTypes'

// TODO: needs Entity superclass
class AiContentEntity extends IntercomEntityBase<AiContent> {
  ...
  async remove(
    this: any, reqmatch?: AiContentRemoveMatch, ctrl?: Control,
  ): Promise<AiContentEntity> {
