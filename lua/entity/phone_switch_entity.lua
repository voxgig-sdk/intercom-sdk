-- Intercom SDK PhoneSwitch entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local PhoneSwitchEntity = {}
PhoneSwitchEntity.__index = PhoneSwitchEntity


function PhoneSwitchEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PhoneSwitchEntity)
  self._name = "phone_switch"
  self._client = client
...
function PhoneSwitchEntity:get_name()
  return self._name
end


function PhoneSwitchEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PhoneSwitchEntity.new(self._client, opts)
end
...
function PhoneSwitchEntity:mark_deleted()
  self._deleted = true
end


function PhoneSwitchEntity:deleted()
  return true == self._deleted
end


function PhoneSwitchEntity:data_set(args)
  if args ~= nil then
...
function PhoneSwitchEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PhoneSwitchEntity:match_set(args)
  if args ~= nil then
...
function PhoneSwitchEntity:match_get()
...
function PhoneSwitchEntity:stream(action, args, callopts)
...
---@param reqdata PhoneSwitchCreateData
---@param ctrl? table
---@return PhoneSwitch
---@return string? err
function PhoneSwitchEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function PhoneSwitchEntity:_run_op(ctx, post_done)
  local utility = self._utility
