-- Intercom SDK TeamMetricList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local TeamMetricListEntity = {}
TeamMetricListEntity.__index = TeamMetricListEntity


function TeamMetricListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TeamMetricListEntity)
  self._name = "team_metric_list"
  self._client = client
...
function TeamMetricListEntity:get_name()
  return self._name
end


function TeamMetricListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TeamMetricListEntity.new(self._client, opts)
end
...
function TeamMetricListEntity:mark_deleted()
  self._deleted = true
end


function TeamMetricListEntity:deleted()
  return true == self._deleted
end


function TeamMetricListEntity:data_set(args)
  if args ~= nil then
...
function TeamMetricListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TeamMetricListEntity:match_set(args)
  if args ~= nil then
...
function TeamMetricListEntity:match_get()
...
function TeamMetricListEntity:stream(action, args, callopts)
...
---@param reqmatch TeamMetricListListMatch
---@param ctrl? table
---@return TeamMetricList[]
---@return string? err
function TeamMetricListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function TeamMetricListEntity:_run_op(ctx, post_done)
  local utility = self._utility
