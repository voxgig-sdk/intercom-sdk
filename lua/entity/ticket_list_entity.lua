-- Intercom SDK TicketList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local TicketListEntity = {}
TicketListEntity.__index = TicketListEntity


function TicketListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TicketListEntity)
  self._name = "ticket_list"
  self._client = client
...
function TicketListEntity:get_name()
  return self._name
end


function TicketListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TicketListEntity.new(self._client, opts)
end
...
function TicketListEntity:mark_deleted()
  self._deleted = true
end


function TicketListEntity:deleted()
  return true == self._deleted
end


function TicketListEntity:data_set(args)
  if args ~= nil then
...
function TicketListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TicketListEntity:match_set(args)
  if args ~= nil then
...
function TicketListEntity:match_get()
...
function TicketListEntity:stream(action, args, callopts)
...
---@param reqdata TicketListCreateData
---@param ctrl? table
---@return TicketList
---@return string? err
function TicketListEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function TicketListEntity:_run_op(ctx, post_done)
  local utility = self._utility
