...
local ContentSnippetEntity = {}
ContentSnippetEntity.__index = ContentSnippetEntity


function ContentSnippetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ContentSnippetEntity)
  self._name = "content_snippet"
  self._client = client
...
function ContentSnippetEntity:get_name()
  return self._name
end


function ContentSnippetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ContentSnippetEntity.new(self._client, opts)
end
...
function ContentSnippetEntity:mark_deleted()
  self._deleted = true
end


function ContentSnippetEntity:deleted()
  return true == self._deleted
end


function ContentSnippetEntity:data_set(args)
  if args ~= nil then
...
function ContentSnippetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ContentSnippetEntity:match_set(args)
  if args ~= nil then
...
function ContentSnippetEntity:match_get()
...
function ContentSnippetEntity:stream(action, args, callopts)
...
---@param reqmatch ContentSnippetLoadMatch
---@param ctrl? table
---@return ContentSnippet
---@return string? err
function ContentSnippetEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ContentSnippetListMatch
---@param ctrl? table
---@return ContentSnippet[]
---@return string? err
function ContentSnippetEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ContentSnippetCreateData
---@param ctrl? table
---@return ContentSnippet
---@return string? err
function ContentSnippetEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ContentSnippetUpdateData
---@param ctrl? table
---@return ContentSnippet
---@return string? err
function ContentSnippetEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ContentSnippetRemoveMatch
---@param ctrl? table
---@return ContentSnippet
---@return string? err
function ContentSnippetEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ContentSnippetEntity:_run_op(ctx, post_done)
  local utility = self._utility
