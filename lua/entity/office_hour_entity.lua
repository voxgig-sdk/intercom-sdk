...
local OfficeHourEntity = {}
OfficeHourEntity.__index = OfficeHourEntity


function OfficeHourEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OfficeHourEntity)
  self._name = "office_hour"
  self._client = client
...
function OfficeHourEntity:get_name()
  return self._name
end


function OfficeHourEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OfficeHourEntity.new(self._client, opts)
end
...
function OfficeHourEntity:mark_deleted()
  self._deleted = true
end


function OfficeHourEntity:deleted()
  return true == self._deleted
end


function OfficeHourEntity:data_set(args)
  if args ~= nil then
...
function OfficeHourEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OfficeHourEntity:match_set(args)
  if args ~= nil then
...
function OfficeHourEntity:match_get()
...
function OfficeHourEntity:stream(action, args, callopts)
...
---@param reqmatch OfficeHourListMatch
---@param ctrl? table
---@return OfficeHour[]
---@return string? err
function OfficeHourEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata OfficeHourCreateData
---@param ctrl? table
---@return OfficeHour
---@return string? err
function OfficeHourEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqmatch OfficeHourRemoveMatch
---@param ctrl? table
---@return OfficeHour
---@return string? err
function OfficeHourEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function OfficeHourEntity:_run_op(ctx, post_done)
  local utility = self._utility
