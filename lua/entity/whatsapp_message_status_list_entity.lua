-- Intercom SDK WhatsappMessageStatusList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local WhatsappMessageStatusListEntity = {}
WhatsappMessageStatusListEntity.__index = WhatsappMessageStatusListEntity


function WhatsappMessageStatusListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WhatsappMessageStatusListEntity)
  self._name = "whatsapp_message_status_list"
  self._client = client
...
function WhatsappMessageStatusListEntity:get_name()
  return self._name
end


function WhatsappMessageStatusListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WhatsappMessageStatusListEntity.new(self._client, opts)
end
...
function WhatsappMessageStatusListEntity:mark_deleted()
  self._deleted = true
end


function WhatsappMessageStatusListEntity:deleted()
  return true == self._deleted
end


function WhatsappMessageStatusListEntity:data_set(args)
  if args ~= nil then
...
function WhatsappMessageStatusListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WhatsappMessageStatusListEntity:match_set(args)
  if args ~= nil then
...
function WhatsappMessageStatusListEntity:match_get()
...
function WhatsappMessageStatusListEntity:stream(action, args, callopts)
...
---@param reqmatch WhatsappMessageStatusListListMatch
---@param ctrl? table
---@return WhatsappMessageStatusList[]
---@return string? err
function WhatsappMessageStatusListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function WhatsappMessageStatusListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return WhatsappMessageStatusListEntity
