-- Intercom SDK DeletedArticleObject entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local DeletedArticleObjectEntity = {}
DeletedArticleObjectEntity.__index = DeletedArticleObjectEntity


function DeletedArticleObjectEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeletedArticleObjectEntity)
  self._name = "deleted_article_object"
  self._client = client
...
function DeletedArticleObjectEntity:get_name()
  return self._name
end


function DeletedArticleObjectEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DeletedArticleObjectEntity.new(self._client, opts)
end
...
function DeletedArticleObjectEntity:mark_deleted()
  self._deleted = true
end


function DeletedArticleObjectEntity:deleted()
  return true == self._deleted
end


function DeletedArticleObjectEntity:data_set(args)
  if args ~= nil then
...
function DeletedArticleObjectEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeletedArticleObjectEntity:match_set(args)
  if args ~= nil then
...
function DeletedArticleObjectEntity:match_get()
...
function DeletedArticleObjectEntity:stream(action, args, callopts)
...
---@param reqmatch DeletedArticleObjectRemoveMatch
---@param ctrl? table
---@return DeletedArticleObject
---@return string? err
function DeletedArticleObjectEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function DeletedArticleObjectEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DeletedArticleObjectEntity
