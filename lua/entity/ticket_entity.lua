...
local TicketEntity = {}
TicketEntity.__index = TicketEntity


function TicketEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TicketEntity)
  self._name = "ticket"
  self._client = client
...
function TicketEntity:get_name()
  return self._name
end


function TicketEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TicketEntity.new(self._client, opts)
end
...
function TicketEntity:mark_deleted()
  self._deleted = true
end


function TicketEntity:deleted()
  return true == self._deleted
end


function TicketEntity:data_set(args)
  if args ~= nil then
...
function TicketEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TicketEntity:match_set(args)
  if args ~= nil then
...
function TicketEntity:match_get()
...
function TicketEntity:stream(action, args, callopts)
...
---@param reqmatch TicketLoadMatch
---@param ctrl? table
---@return Ticket
---@return string? err
function TicketEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata TicketCreateData
---@param ctrl? table
---@return Ticket
---@return string? err
function TicketEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata TicketUpdateData
---@param ctrl? table
---@return Ticket
---@return string? err
function TicketEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch TicketRemoveMatch
---@param ctrl? table
---@return Ticket
---@return string? err
function TicketEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function TicketEntity:_run_op(ctx, post_done)
  local utility = self._utility
