-- Intercom SDK DataConnectorExecutionResultList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local DataConnectorExecutionResultListEntity = {}
DataConnectorExecutionResultListEntity.__index = DataConnectorExecutionResultListEntity


function DataConnectorExecutionResultListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DataConnectorExecutionResultListEntity)
  self._name = "data_connector_execution_result_list"
  self._client = client
...
function DataConnectorExecutionResultListEntity:get_name()
  return self._name
end


function DataConnectorExecutionResultListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DataConnectorExecutionResultListEntity.new(self._client, opts)
end
...
function DataConnectorExecutionResultListEntity:mark_deleted()
  self._deleted = true
end


function DataConnectorExecutionResultListEntity:deleted()
  return true == self._deleted
end


function DataConnectorExecutionResultListEntity:data_set(args)
  if args ~= nil then
...
function DataConnectorExecutionResultListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DataConnectorExecutionResultListEntity:match_set(args)
  if args ~= nil then
...
function DataConnectorExecutionResultListEntity:match_get()
...
function DataConnectorExecutionResultListEntity:stream(action, args, callopts)
...
---@param reqmatch DataConnectorExecutionResultListListMatch
---@param ctrl? table
---@return DataConnectorExecutionResultList[]
---@return string? err
function DataConnectorExecutionResultListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function DataConnectorExecutionResultListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DataConnectorExecutionResultListEntity
