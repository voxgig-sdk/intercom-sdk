...
local DataConnectorEntity = {}
DataConnectorEntity.__index = DataConnectorEntity


function DataConnectorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DataConnectorEntity)
  self._name = "data_connector"
  self._client = client
...
function DataConnectorEntity:get_name()
  return self._name
end


function DataConnectorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DataConnectorEntity.new(self._client, opts)
end
...
function DataConnectorEntity:mark_deleted()
  self._deleted = true
end


function DataConnectorEntity:deleted()
  return true == self._deleted
end


function DataConnectorEntity:data_set(args)
  if args ~= nil then
...
function DataConnectorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DataConnectorEntity:match_set(args)
  if args ~= nil then
...
function DataConnectorEntity:match_get()
...
function DataConnectorEntity:stream(action, args, callopts)
...
---@param reqmatch DataConnectorLoadMatch
---@param ctrl? table
---@return DataConnector
---@return string? err
function DataConnectorEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch DataConnectorListMatch
---@param ctrl? table
---@return DataConnector[]
---@return string? err
function DataConnectorEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata DataConnectorCreateData
---@param ctrl? table
---@return DataConnector
---@return string? err
function DataConnectorEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata DataConnectorUpdateData
---@param ctrl? table
---@return DataConnector
---@return string? err
function DataConnectorEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function DataConnectorEntity:_run_op(ctx, post_done)
  local utility = self._utility
