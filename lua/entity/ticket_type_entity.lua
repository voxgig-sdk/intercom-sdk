...
local TicketTypeEntity = {}
TicketTypeEntity.__index = TicketTypeEntity


function TicketTypeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TicketTypeEntity)
  self._name = "ticket_type"
  self._client = client
...
function TicketTypeEntity:get_name()
  return self._name
end


function TicketTypeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TicketTypeEntity.new(self._client, opts)
end
...
function TicketTypeEntity:mark_deleted()
  self._deleted = true
end


function TicketTypeEntity:deleted()
  return true == self._deleted
end


function TicketTypeEntity:data_set(args)
  if args ~= nil then
...
function TicketTypeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TicketTypeEntity:match_set(args)
  if args ~= nil then
...
function TicketTypeEntity:match_get()
...
function TicketTypeEntity:stream(action, args, callopts)
...
---@param reqmatch TicketTypeLoadMatch
---@param ctrl? table
---@return TicketType
---@return string? err
function TicketTypeEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch TicketTypeListMatch
---@param ctrl? table
---@return TicketType[]
---@return string? err
function TicketTypeEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata TicketTypeCreateData
---@param ctrl? table
---@return TicketType
---@return string? err
function TicketTypeEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata TicketTypeUpdateData
---@param ctrl? table
---@return TicketType
---@return string? err
function TicketTypeEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function TicketTypeEntity:_run_op(ctx, post_done)
  local utility = self._utility
