-- Intercom SDK OfficeHoursSchedule entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OfficeHoursScheduleEntity = {}
OfficeHoursScheduleEntity.__index = OfficeHoursScheduleEntity


function OfficeHoursScheduleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OfficeHoursScheduleEntity)
  self._name = "office_hours_schedule"
  self._client = client
...
function OfficeHoursScheduleEntity:get_name()
  return self._name
end


function OfficeHoursScheduleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OfficeHoursScheduleEntity.new(self._client, opts)
end
...
function OfficeHoursScheduleEntity:mark_deleted()
  self._deleted = true
end


function OfficeHoursScheduleEntity:deleted()
  return true == self._deleted
end


function OfficeHoursScheduleEntity:data_set(args)
  if args ~= nil then
...
function OfficeHoursScheduleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OfficeHoursScheduleEntity:match_set(args)
  if args ~= nil then
...
function OfficeHoursScheduleEntity:match_get()
...
function OfficeHoursScheduleEntity:stream(action, args, callopts)
...
---@param reqmatch OfficeHoursScheduleLoadMatch
---@param ctrl? table
---@return OfficeHoursSchedule
---@return string? err
function OfficeHoursScheduleEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata OfficeHoursScheduleUpdateData
---@param ctrl? table
---@return OfficeHoursSchedule
---@return string? err
function OfficeHoursScheduleEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function OfficeHoursScheduleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OfficeHoursScheduleEntity
