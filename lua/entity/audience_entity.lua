...
local AudienceEntity = {}
AudienceEntity.__index = AudienceEntity


function AudienceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AudienceEntity)
  self._name = "audience"
  self._client = client
...
function AudienceEntity:get_name()
  return self._name
end


function AudienceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AudienceEntity.new(self._client, opts)
end
...
function AudienceEntity:mark_deleted()
  self._deleted = true
end


function AudienceEntity:deleted()
  return true == self._deleted
end


function AudienceEntity:data_set(args)
  if args ~= nil then
...
function AudienceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AudienceEntity:match_set(args)
  if args ~= nil then
...
function AudienceEntity:match_get()
...
function AudienceEntity:stream(action, args, callopts)
...
---@param reqmatch AudienceLoadMatch
---@param ctrl? table
---@return Audience
---@return string? err
function AudienceEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch AudienceListMatch
---@param ctrl? table
---@return Audience[]
---@return string? err
function AudienceEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata AudienceCreateData
---@param ctrl? table
---@return Audience
---@return string? err
function AudienceEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata AudienceUpdateData
---@param ctrl? table
---@return Audience
---@return string? err
function AudienceEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch AudienceRemoveMatch
---@param ctrl? table
---@return Audience
---@return string? err
function AudienceEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function AudienceEntity:_run_op(ctx, post_done)
  local utility = self._utility
