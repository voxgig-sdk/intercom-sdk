-- Intercom SDK DeletedCompanyObject entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local DeletedCompanyObjectEntity = {}
DeletedCompanyObjectEntity.__index = DeletedCompanyObjectEntity


function DeletedCompanyObjectEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeletedCompanyObjectEntity)
  self._name = "deleted_company_object"
  self._client = client
...
function DeletedCompanyObjectEntity:get_name()
  return self._name
end


function DeletedCompanyObjectEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DeletedCompanyObjectEntity.new(self._client, opts)
end
...
function DeletedCompanyObjectEntity:mark_deleted()
  self._deleted = true
end


function DeletedCompanyObjectEntity:deleted()
  return true == self._deleted
end


function DeletedCompanyObjectEntity:data_set(args)
  if args ~= nil then
...
function DeletedCompanyObjectEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeletedCompanyObjectEntity:match_set(args)
  if args ~= nil then
...
function DeletedCompanyObjectEntity:match_get()
...
function DeletedCompanyObjectEntity:stream(action, args, callopts)
...
---@param reqmatch DeletedCompanyObjectRemoveMatch
---@param ctrl? table
---@return DeletedCompanyObject
---@return string? err
function DeletedCompanyObjectEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function DeletedCompanyObjectEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DeletedCompanyObjectEntity
