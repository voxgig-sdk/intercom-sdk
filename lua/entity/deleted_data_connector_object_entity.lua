-- Intercom SDK DeletedDataConnectorObject entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local DeletedDataConnectorObjectEntity = {}
DeletedDataConnectorObjectEntity.__index = DeletedDataConnectorObjectEntity


function DeletedDataConnectorObjectEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeletedDataConnectorObjectEntity)
  self._name = "deleted_data_connector_object"
  self._client = client
...
function DeletedDataConnectorObjectEntity:get_name()
  return self._name
end


function DeletedDataConnectorObjectEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DeletedDataConnectorObjectEntity.new(self._client, opts)
end
...
function DeletedDataConnectorObjectEntity:mark_deleted()
  self._deleted = true
end


function DeletedDataConnectorObjectEntity:deleted()
  return true == self._deleted
end


function DeletedDataConnectorObjectEntity:data_set(args)
  if args ~= nil then
...
function DeletedDataConnectorObjectEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeletedDataConnectorObjectEntity:match_set(args)
  if args ~= nil then
...
function DeletedDataConnectorObjectEntity:match_get()
...
function DeletedDataConnectorObjectEntity:stream(action, args, callopts)
...
---@param reqmatch DeletedDataConnectorObjectRemoveMatch
---@param ctrl? table
---@return DeletedDataConnectorObject
---@return string? err
function DeletedDataConnectorObjectEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function DeletedDataConnectorObjectEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DeletedDataConnectorObjectEntity
