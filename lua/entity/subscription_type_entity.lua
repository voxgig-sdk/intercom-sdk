-- Intercom SDK SubscriptionType entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local SubscriptionTypeEntity = {}
SubscriptionTypeEntity.__index = SubscriptionTypeEntity


function SubscriptionTypeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionTypeEntity)
  self._name = "subscription_type"
  self._client = client
...
function SubscriptionTypeEntity:get_name()
  return self._name
end


function SubscriptionTypeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionTypeEntity.new(self._client, opts)
end
...
function SubscriptionTypeEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionTypeEntity:deleted()
  return true == self._deleted
end


function SubscriptionTypeEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionTypeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionTypeEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionTypeEntity:match_get()
...
function SubscriptionTypeEntity:stream(action, args, callopts)
...
---@param reqmatch SubscriptionTypeListMatch
---@param ctrl? table
---@return SubscriptionType[]
---@return string? err
function SubscriptionTypeEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function SubscriptionTypeEntity:_run_op(ctx, post_done)
  local utility = self._utility
