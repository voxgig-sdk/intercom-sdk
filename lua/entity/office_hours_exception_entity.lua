...
local OfficeHoursExceptionEntity = {}
OfficeHoursExceptionEntity.__index = OfficeHoursExceptionEntity


function OfficeHoursExceptionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OfficeHoursExceptionEntity)
  self._name = "office_hours_exception"
  self._client = client
...
function OfficeHoursExceptionEntity:get_name()
  return self._name
end


function OfficeHoursExceptionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OfficeHoursExceptionEntity.new(self._client, opts)
end
...
function OfficeHoursExceptionEntity:mark_deleted()
  self._deleted = true
end


function OfficeHoursExceptionEntity:deleted()
  return true == self._deleted
end


function OfficeHoursExceptionEntity:data_set(args)
  if args ~= nil then
...
function OfficeHoursExceptionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OfficeHoursExceptionEntity:match_set(args)
  if args ~= nil then
...
function OfficeHoursExceptionEntity:match_get()
...
function OfficeHoursExceptionEntity:stream(action, args, callopts)
...
---@param reqmatch OfficeHoursExceptionLoadMatch
---@param ctrl? table
---@return OfficeHoursException
---@return string? err
function OfficeHoursExceptionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch OfficeHoursExceptionListMatch
---@param ctrl? table
---@return OfficeHoursException[]
---@return string? err
function OfficeHoursExceptionEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata OfficeHoursExceptionCreateData
---@param ctrl? table
---@return OfficeHoursException
---@return string? err
function OfficeHoursExceptionEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata OfficeHoursExceptionUpdateData
---@param ctrl? table
---@return OfficeHoursException
---@return string? err
function OfficeHoursExceptionEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function OfficeHoursExceptionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return OfficeHoursExceptionEntity
