...
local HelpCenterEntity = {}
HelpCenterEntity.__index = HelpCenterEntity


function HelpCenterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, HelpCenterEntity)
  self._name = "help_center"
  self._client = client
...
function HelpCenterEntity:get_name()
  return self._name
end


function HelpCenterEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return HelpCenterEntity.new(self._client, opts)
end
...
function HelpCenterEntity:mark_deleted()
  self._deleted = true
end


function HelpCenterEntity:deleted()
  return true == self._deleted
end


function HelpCenterEntity:data_set(args)
  if args ~= nil then
...
function HelpCenterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function HelpCenterEntity:match_set(args)
  if args ~= nil then
...
function HelpCenterEntity:match_get()
...
function HelpCenterEntity:stream(action, args, callopts)
...
---@param reqmatch HelpCenterLoadMatch
---@param ctrl? table
---@return HelpCenter
---@return string? err
function HelpCenterEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch HelpCenterListMatch
---@param ctrl? table
---@return HelpCenter[]
---@return string? err
function HelpCenterEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata HelpCenterCreateData
---@param ctrl? table
---@return HelpCenter
---@return string? err
function HelpCenterEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata HelpCenterUpdateData
---@param ctrl? table
---@return HelpCenter
---@return string? err
function HelpCenterEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch HelpCenterRemoveMatch
---@param ctrl? table
---@return HelpCenter
---@return string? err
function HelpCenterEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function HelpCenterEntity:_run_op(ctx, post_done)
  local utility = self._utility
