...
local DeletedInternalArticleObjectEntity = {}
DeletedInternalArticleObjectEntity.__index = DeletedInternalArticleObjectEntity


function DeletedInternalArticleObjectEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeletedInternalArticleObjectEntity)
  self._name = "deleted_internal_article_object"
  self._client = client
...
function DeletedInternalArticleObjectEntity:get_name()
  return self._name
end


function DeletedInternalArticleObjectEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DeletedInternalArticleObjectEntity.new(self._client, opts)
end
...
function DeletedInternalArticleObjectEntity:mark_deleted()
  self._deleted = true
end


function DeletedInternalArticleObjectEntity:deleted()
  return true == self._deleted
end


function DeletedInternalArticleObjectEntity:data_set(args)
  if args ~= nil then
...
function DeletedInternalArticleObjectEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeletedInternalArticleObjectEntity:match_set(args)
  if args ~= nil then
...
function DeletedInternalArticleObjectEntity:match_get()
...
function DeletedInternalArticleObjectEntity:stream(action, args, callopts)
...
---@param reqmatch DeletedInternalArticleObjectListMatch
---@param ctrl? table
---@return DeletedInternalArticleObject[]
---@return string? err
function DeletedInternalArticleObjectEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata DeletedInternalArticleObjectCreateData
---@param ctrl? table
---@return DeletedInternalArticleObject
---@return string? err
function DeletedInternalArticleObjectEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqmatch DeletedInternalArticleObjectRemoveMatch
---@param ctrl? table
---@return DeletedInternalArticleObject
---@return string? err
function DeletedInternalArticleObjectEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function DeletedInternalArticleObjectEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DeletedInternalArticleObjectEntity
