-- Intercom SDK BannerDismiss entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local BannerDismissEntity = {}
BannerDismissEntity.__index = BannerDismissEntity


function BannerDismissEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BannerDismissEntity)
  self._name = "banner_dismiss"
  self._client = client
...
function BannerDismissEntity:get_name()
  return self._name
end


function BannerDismissEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BannerDismissEntity.new(self._client, opts)
end
...
function BannerDismissEntity:mark_deleted()
  self._deleted = true
end


function BannerDismissEntity:deleted()
  return true == self._deleted
end


function BannerDismissEntity:data_set(args)
  if args ~= nil then
...
function BannerDismissEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BannerDismissEntity:match_set(args)
  if args ~= nil then
...
function BannerDismissEntity:match_get()
...
function BannerDismissEntity:stream(action, args, callopts)
...
---@param reqdata BannerDismissCreateData
---@param ctrl? table
---@return BannerDismiss
---@return string? err
function BannerDismissEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function BannerDismissEntity:_run_op(ctx, post_done)
  local utility = self._utility
