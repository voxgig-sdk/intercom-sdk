-- Intercom SDK TicketTypeAttribute entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local TicketTypeAttributeEntity = {}
TicketTypeAttributeEntity.__index = TicketTypeAttributeEntity


function TicketTypeAttributeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TicketTypeAttributeEntity)
  self._name = "ticket_type_attribute"
  self._client = client
...
function TicketTypeAttributeEntity:get_name()
  return self._name
end


function TicketTypeAttributeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TicketTypeAttributeEntity.new(self._client, opts)
end
...
function TicketTypeAttributeEntity:mark_deleted()
  self._deleted = true
end


function TicketTypeAttributeEntity:deleted()
  return true == self._deleted
end


function TicketTypeAttributeEntity:data_set(args)
  if args ~= nil then
...
function TicketTypeAttributeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TicketTypeAttributeEntity:match_set(args)
  if args ~= nil then
...
function TicketTypeAttributeEntity:match_get()
...
function TicketTypeAttributeEntity:stream(action, args, callopts)
...
---@param reqdata TicketTypeAttributeCreateData
---@param ctrl? table
---@return TicketTypeAttribute
---@return string? err
function TicketTypeAttributeEntity:create(reqdata, ctrl)
  local utility = self._utility
...
---@param reqdata TicketTypeAttributeUpdateData
---@param ctrl? table
---@return TicketTypeAttribute
---@return string? err
function TicketTypeAttributeEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function TicketTypeAttributeEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return TicketTypeAttributeEntity
