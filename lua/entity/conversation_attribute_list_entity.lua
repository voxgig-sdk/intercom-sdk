-- Intercom SDK ConversationAttributeList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationAttributeListEntity = {}
ConversationAttributeListEntity.__index = ConversationAttributeListEntity


function ConversationAttributeListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationAttributeListEntity)
  self._name = "conversation_attribute_list"
  self._client = client
...
function ConversationAttributeListEntity:get_name()
  return self._name
end


function ConversationAttributeListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationAttributeListEntity.new(self._client, opts)
end
...
function ConversationAttributeListEntity:mark_deleted()
  self._deleted = true
end


function ConversationAttributeListEntity:deleted()
  return true == self._deleted
end


function ConversationAttributeListEntity:data_set(args)
  if args ~= nil then
...
function ConversationAttributeListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationAttributeListEntity:match_set(args)
  if args ~= nil then
...
function ConversationAttributeListEntity:match_get()
...
function ConversationAttributeListEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationAttributeListListMatch
---@param ctrl? table
---@return ConversationAttributeList[]
---@return string? err
function ConversationAttributeListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationAttributeListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationAttributeListEntity
