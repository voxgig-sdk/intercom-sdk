-- Intercom SDK DataConnectorExecutionResult entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local DataConnectorExecutionResultEntity = {}
DataConnectorExecutionResultEntity.__index = DataConnectorExecutionResultEntity


function DataConnectorExecutionResultEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DataConnectorExecutionResultEntity)
  self._name = "data_connector_execution_result"
  self._client = client
...
function DataConnectorExecutionResultEntity:get_name()
  return self._name
end


function DataConnectorExecutionResultEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DataConnectorExecutionResultEntity.new(self._client, opts)
end
...
function DataConnectorExecutionResultEntity:mark_deleted()
  self._deleted = true
end


function DataConnectorExecutionResultEntity:deleted()
  return true == self._deleted
end


function DataConnectorExecutionResultEntity:data_set(args)
  if args ~= nil then
...
function DataConnectorExecutionResultEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DataConnectorExecutionResultEntity:match_set(args)
  if args ~= nil then
...
function DataConnectorExecutionResultEntity:match_get()
...
function DataConnectorExecutionResultEntity:stream(action, args, callopts)
...
---@param reqmatch DataConnectorExecutionResultLoadMatch
---@param ctrl? table
---@return DataConnectorExecutionResult
---@return string? err
function DataConnectorExecutionResultEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function DataConnectorExecutionResultEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DataConnectorExecutionResultEntity
