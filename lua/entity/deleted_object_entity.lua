-- Intercom SDK DeletedObject entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local DeletedObjectEntity = {}
DeletedObjectEntity.__index = DeletedObjectEntity


function DeletedObjectEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DeletedObjectEntity)
  self._name = "deleted_object"
  self._client = client
...
function DeletedObjectEntity:get_name()
  return self._name
end


function DeletedObjectEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DeletedObjectEntity.new(self._client, opts)
end
...
function DeletedObjectEntity:mark_deleted()
  self._deleted = true
end


function DeletedObjectEntity:deleted()
  return true == self._deleted
end


function DeletedObjectEntity:data_set(args)
  if args ~= nil then
...
function DeletedObjectEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DeletedObjectEntity:match_set(args)
  if args ~= nil then
...
function DeletedObjectEntity:match_get()
...
function DeletedObjectEntity:stream(action, args, callopts)
...
---@param reqmatch DeletedObjectRemoveMatch
---@param ctrl? table
---@return DeletedObject
---@return string? err
function DeletedObjectEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function DeletedObjectEntity:_run_op(ctx, post_done)
  local utility = self._utility
