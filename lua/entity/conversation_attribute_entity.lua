...
local ConversationAttributeEntity = {}
ConversationAttributeEntity.__index = ConversationAttributeEntity


function ConversationAttributeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationAttributeEntity)
  self._name = "conversation_attribute"
  self._client = client
...
function ConversationAttributeEntity:get_name()
  return self._name
end


function ConversationAttributeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationAttributeEntity.new(self._client, opts)
end
...
function ConversationAttributeEntity:mark_deleted()
  self._deleted = true
end


function ConversationAttributeEntity:deleted()
  return true == self._deleted
end


function ConversationAttributeEntity:data_set(args)
  if args ~= nil then
...
function ConversationAttributeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationAttributeEntity:match_set(args)
  if args ~= nil then
...
function ConversationAttributeEntity:match_get()
...
function ConversationAttributeEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationAttributeLoadMatch
---@param ctrl? table
---@return ConversationAttribute
---@return string? err
function ConversationAttributeEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ConversationAttributeCreateData
---@param ctrl? table
---@return ConversationAttribute
---@return string? err
function ConversationAttributeEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ConversationAttributeUpdateData
---@param ctrl? table
---@return ConversationAttribute
---@return string? err
function ConversationAttributeEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ConversationAttributeRemoveMatch
---@param ctrl? table
---@return ConversationAttribute
---@return string? err
function ConversationAttributeEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ConversationAttributeEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationAttributeEntity
