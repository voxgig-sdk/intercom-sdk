...
local IpAllowlistEntity = {}
IpAllowlistEntity.__index = IpAllowlistEntity


function IpAllowlistEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IpAllowlistEntity)
  self._name = "ip_allowlist"
  self._client = client
...
function IpAllowlistEntity:get_name()
  return self._name
end


function IpAllowlistEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return IpAllowlistEntity.new(self._client, opts)
end
...
function IpAllowlistEntity:mark_deleted()
  self._deleted = true
end


function IpAllowlistEntity:deleted()
  return true == self._deleted
end


function IpAllowlistEntity:data_set(args)
  if args ~= nil then
...
function IpAllowlistEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IpAllowlistEntity:match_set(args)
  if args ~= nil then
...
function IpAllowlistEntity:match_get()
...
function IpAllowlistEntity:stream(action, args, callopts)
...
---@param reqmatch IpAllowlistListMatch
---@param ctrl? table
---@return IpAllowlist[]
---@return string? err
function IpAllowlistEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata IpAllowlistUpdateData
---@param ctrl? table
---@return IpAllowlist
---@return string? err
function IpAllowlistEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function IpAllowlistEntity:_run_op(ctx, post_done)
  local utility = self._utility
