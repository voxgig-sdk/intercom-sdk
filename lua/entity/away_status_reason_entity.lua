-- Intercom SDK AwayStatusReason entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local AwayStatusReasonEntity = {}
AwayStatusReasonEntity.__index = AwayStatusReasonEntity


function AwayStatusReasonEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AwayStatusReasonEntity)
  self._name = "away_status_reason"
  self._client = client
...
function AwayStatusReasonEntity:get_name()
  return self._name
end


function AwayStatusReasonEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AwayStatusReasonEntity.new(self._client, opts)
end
...
function AwayStatusReasonEntity:mark_deleted()
  self._deleted = true
end


function AwayStatusReasonEntity:deleted()
  return true == self._deleted
end


function AwayStatusReasonEntity:data_set(args)
  if args ~= nil then
...
function AwayStatusReasonEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AwayStatusReasonEntity:match_set(args)
  if args ~= nil then
...
function AwayStatusReasonEntity:match_get()
...
function AwayStatusReasonEntity:stream(action, args, callopts)
...
---@param reqmatch AwayStatusReasonListMatch
---@param ctrl? table
---@return AwayStatusReason[]
---@return string? err
function AwayStatusReasonEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function AwayStatusReasonEntity:_run_op(ctx, post_done)
  local utility = self._utility
