...
local ContentImportSourceEntity = {}
ContentImportSourceEntity.__index = ContentImportSourceEntity


function ContentImportSourceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ContentImportSourceEntity)
  self._name = "content_import_source"
  self._client = client
...
function ContentImportSourceEntity:get_name()
  return self._name
end


function ContentImportSourceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ContentImportSourceEntity.new(self._client, opts)
end
...
function ContentImportSourceEntity:mark_deleted()
  self._deleted = true
end


function ContentImportSourceEntity:deleted()
  return true == self._deleted
end


function ContentImportSourceEntity:data_set(args)
  if args ~= nil then
...
function ContentImportSourceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ContentImportSourceEntity:match_set(args)
  if args ~= nil then
...
function ContentImportSourceEntity:match_get()
...
function ContentImportSourceEntity:stream(action, args, callopts)
...
---@param reqmatch ContentImportSourceLoadMatch
---@param ctrl? table
---@return ContentImportSource
---@return string? err
function ContentImportSourceEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ContentImportSourceListMatch
---@param ctrl? table
---@return ContentImportSource[]
---@return string? err
function ContentImportSourceEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ContentImportSourceCreateData
---@param ctrl? table
---@return ContentImportSource
---@return string? err
function ContentImportSourceEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ContentImportSourceUpdateData
---@param ctrl? table
---@return ContentImportSource
---@return string? err
function ContentImportSourceEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ContentImportSourceEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ContentImportSourceEntity
