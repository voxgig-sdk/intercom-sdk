-- Intercom SDK ContactAttachedCompany entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ContactAttachedCompanyEntity = {}
ContactAttachedCompanyEntity.__index = ContactAttachedCompanyEntity


function ContactAttachedCompanyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ContactAttachedCompanyEntity)
  self._name = "contact_attached_company"
  self._client = client
...
function ContactAttachedCompanyEntity:get_name()
  return self._name
end


function ContactAttachedCompanyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ContactAttachedCompanyEntity.new(self._client, opts)
end
...
function ContactAttachedCompanyEntity:mark_deleted()
  self._deleted = true
end


function ContactAttachedCompanyEntity:deleted()
  return true == self._deleted
end


function ContactAttachedCompanyEntity:data_set(args)
  if args ~= nil then
...
function ContactAttachedCompanyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ContactAttachedCompanyEntity:match_set(args)
  if args ~= nil then
...
function ContactAttachedCompanyEntity:match_get()
...
function ContactAttachedCompanyEntity:stream(action, args, callopts)
...
---@param reqmatch ContactAttachedCompanyListMatch
---@param ctrl? table
---@return ContactAttachedCompany[]
---@return string? err
function ContactAttachedCompanyEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ContactAttachedCompanyEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ContactAttachedCompanyEntity
