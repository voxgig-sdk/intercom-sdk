-- OfficeHoursSchedule direct test
...
describe("OfficeHoursScheduleDirect", function()
  it("should direct-load-office_hours_schedule", function()
    local setup = office_hours_schedule_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-office_hours_schedule", setup.live and "live" or "unit")
...
function office_hours_schedule_direct_setup(mockres)
