...
describe("BannerDirect", function()
  it("should direct-list-banner", function()
    local setup = banner_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-banner", setup.live and "live" or "unit")
