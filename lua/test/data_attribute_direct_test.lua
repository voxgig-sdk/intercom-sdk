...
describe("DataAttributeDirect", function()
  it("should direct-list-data_attribute", function()
    local setup = data_attribute_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-data_attribute", setup.live and "live" or "unit")
...
function data_attribute_direct_setup(mockres)
