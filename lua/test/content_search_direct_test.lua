...
describe("ContentSearchDirect", function()
  it("should direct-list-content_search", function()
    local setup = content_search_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-content_search", setup.live and "live" or "unit")
...
function content_search_direct_setup(mockres)
