...
describe("VisitorDirect", function()
  it("should direct-load-visitor", function()
    local setup = visitor_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-visitor", setup.live and "live" or "unit")
...
function visitor_direct_setup(mockres)
