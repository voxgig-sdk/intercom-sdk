...
describe("ArticleSearchDirect", function()
  it("should direct-load-article_search", function()
    local setup = article_search_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-article_search", setup.live and "live" or "unit")
...
function article_search_direct_setup(mockres)
