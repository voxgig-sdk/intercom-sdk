...
describe("HandlingEventDirect", function()
  it("should direct-list-handling_event", function()
    local setup = handling_event_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-handling_event", setup.live and "live" or "unit")
...
function handling_event_direct_setup(mockres)
