-- WhatsappMessageStatus direct test
...
describe("WhatsappMessageStatusDirect", function()
  it("should direct-load-whatsapp_message_status", function()
    local setup = whatsapp_message_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-whatsapp_message_status", setup.live and "live" or "unit")
...
function whatsapp_message_status_direct_setup(mockres)
