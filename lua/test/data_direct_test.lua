...
describe("DataDirect", function()
  it("should direct-load-data", function()
    local setup = data_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-data", setup.live and "live" or "unit")
...
function data_direct_setup(mockres)
