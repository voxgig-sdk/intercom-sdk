...
describe("InternalArticleDirect", function()
  it("should direct-load-internal_article", function()
    local setup = internal_article_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-internal_article", setup.live and "live" or "unit")
...
function internal_article_direct_setup(mockres)
