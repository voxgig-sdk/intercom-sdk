-- ReportingDataExport direct test
...
describe("ReportingDataExportDirect", function()
  it("should direct-list-reporting_data_export", function()
    local setup = reporting_data_export_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-reporting_data_export", setup.live and "live" or "unit")
...
function reporting_data_export_direct_setup(mockres)
