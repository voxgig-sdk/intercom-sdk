...
describe("NewsfeedDirect", function()
  it("should direct-load-newsfeed", function()
    local setup = newsfeed_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-newsfeed", setup.live and "live" or "unit")
...
function newsfeed_direct_setup(mockres)
