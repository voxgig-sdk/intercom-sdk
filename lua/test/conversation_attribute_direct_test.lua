-- ConversationAttribute direct test
...
describe("ConversationAttributeDirect", function()
  it("should direct-load-conversation_attribute", function()
    local setup = conversation_attribute_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-conversation_attribute", setup.live and "live" or "unit")
...
function conversation_attribute_direct_setup(mockres)
