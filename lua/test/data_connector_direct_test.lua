...
describe("DataConnectorDirect", function()
  it("should direct-list-data_connector", function()
    local setup = data_connector_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-data_connector", setup.live and "live" or "unit")
  ...
  it("should direct-load-data_connector", function()
    local setup = data_connector_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-data_connector", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function data_connector_direct_setup(mockres)
