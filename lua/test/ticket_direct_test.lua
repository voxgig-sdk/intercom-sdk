...
describe("TicketDirect", function()
  it("should direct-load-ticket", function()
    local setup = ticket_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ticket", setup.live and "live" or "unit")
...
function ticket_direct_setup(mockres)
