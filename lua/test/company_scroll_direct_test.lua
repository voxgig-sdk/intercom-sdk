...
describe("CompanyScrollDirect", function()
  it("should direct-list-company_scroll", function()
    local setup = company_scroll_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-company_scroll", setup.live and "live" or "unit")
...
function company_scroll_direct_setup(mockres)
