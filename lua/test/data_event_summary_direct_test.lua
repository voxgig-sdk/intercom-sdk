...
describe("DataEventSummaryDirect", function()
  it("should direct-list-data_event_summary", function()
    local setup = data_event_summary_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-data_event_summary", setup.live and "live" or "unit")
...
function data_event_summary_direct_setup(mockres)
