-- WhatsappMessageStatusList direct test
...
describe("WhatsappMessageStatusListDirect", function()
  it("should direct-list-whatsapp_message_status_list", function()
    local setup = whatsapp_message_status_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-whatsapp_message_status_list", setup.live and "live" or "unit")
...
function whatsapp_message_status_list_direct_setup(mockres)
