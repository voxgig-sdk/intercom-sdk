-- ActivityLogEventType direct test
...
describe("ActivityLogEventTypeDirect", function()
  it("should direct-list-activity_log_event_type", function()
    local setup = activity_log_event_type_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-activity_log_event_type", setup.live and "live" or "unit")
...
function activity_log_event_type_direct_setup(mockres)
