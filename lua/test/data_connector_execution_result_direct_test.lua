-- DataConnectorExecutionResult direct test
...
describe("DataConnectorExecutionResultDirect", function()
  it("should direct-load-data_connector_execution_result", function()
    local setup = data_connector_execution_result_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-data_connector_execution_result", setup.live and "live" or "unit")
...
function data_connector_execution_result_direct_setup(mockres)
