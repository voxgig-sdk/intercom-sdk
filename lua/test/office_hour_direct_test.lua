...
describe("OfficeHourDirect", function()
  it("should direct-list-office_hour", function()
    local setup = office_hour_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-office_hour", setup.live and "live" or "unit")
...
function office_hour_direct_setup(mockres)
