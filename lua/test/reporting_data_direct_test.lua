...
describe("ReportingDataDirect", function()
  it("should direct-load-reporting_data", function()
    local setup = reporting_data_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-reporting_data", setup.live and "live" or "unit")
...
function reporting_data_direct_setup(mockres)
