-- InternalArticleSearch direct test
...
describe("InternalArticleSearchDirect", function()
  it("should direct-load-internal_article_search", function()
    local setup = internal_article_search_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-internal_article_search", setup.live and "live" or "unit")
...
function internal_article_search_direct_setup(mockres)
