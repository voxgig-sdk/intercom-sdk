...
describe("AdminWithAppDirect", function()
  it("should direct-list-admin_with_app", function()
    local setup = admin_with_app_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-admin_with_app", setup.live and "live" or "unit")
...
function admin_with_app_direct_setup(mockres)
