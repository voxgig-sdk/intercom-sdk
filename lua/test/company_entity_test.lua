...
describe("CompanyEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set INTERCOM_TEST_COMPANY_ENTID JSON to run live")
      return
    end
    ...
    local company_ref01_markdef_up0_name = "app_id"
...
function company_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("INTERCOM_TEST_COMPANY_ENTID")
