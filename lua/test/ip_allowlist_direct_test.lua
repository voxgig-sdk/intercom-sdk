...
describe("IpAllowlistDirect", function()
  it("should direct-list-ip_allowlist", function()
    local setup = ip_allowlist_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-ip_allowlist", setup.live and "live" or "unit")
...
function ip_allowlist_direct_setup(mockres)
