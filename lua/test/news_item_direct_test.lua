...
describe("NewsItemDirect", function()
  it("should direct-load-news_item", function()
    local setup = news_item_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-news_item", setup.live and "live" or "unit")
...
function news_item_direct_setup(mockres)
