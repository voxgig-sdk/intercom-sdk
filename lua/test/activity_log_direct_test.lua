...
describe("ActivityLogDirect", function()
  it("should direct-list-activity_log", function()
    local setup = activity_log_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-activity_log", setup.live and "live" or "unit")
...
function activity_log_direct_setup(mockres)
