...
describe("JobEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set INTERCOM_TEST_JOB_ENTID JSON to run live")
      return
    end
...
function job_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("INTERCOM_TEST_JOB_ENTID")
