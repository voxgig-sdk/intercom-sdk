...
describe("AwayStatusReasonDirect", function()
  it("should direct-list-away_status_reason", function()
    local setup = away_status_reason_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-away_status_reason", setup.live and "live" or "unit")
...
function away_status_reason_direct_setup(mockres)
