...
describe("SubscriptionTypeDirect", function()
  it("should direct-list-subscription_type", function()
    local setup = subscription_type_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-subscription_type", setup.live and "live" or "unit")
...
function subscription_type_direct_setup(mockres)
