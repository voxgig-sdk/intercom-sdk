...
describe("ArticleVersionDirect", function()
  it("should direct-load-article_version", function()
    local setup = article_version_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-article_version", setup.live and "live" or "unit")
...
function article_version_direct_setup(mockres)
