-- DeletedInternalArticleObject direct test
...
describe("DeletedInternalArticleObjectDirect", function()
  it("should direct-list-deleted_internal_article_object", function()
    local setup = deleted_internal_article_object_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-deleted_internal_article_object", setup.live and "live" or "unit")
...
function deleted_internal_article_object_direct_setup(mockres)
