...
describe("TicketStateDirect", function()
  it("should direct-list-ticket_state", function()
    local setup = ticket_state_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-ticket_state", setup.live and "live" or "unit")
...
function ticket_state_direct_setup(mockres)
