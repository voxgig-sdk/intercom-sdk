...
describe("WorkflowDirect", function()
  it("should direct-load-workflow", function()
    local setup = workflow_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-workflow", setup.live and "live" or "unit")
...
function workflow_direct_setup(mockres)
