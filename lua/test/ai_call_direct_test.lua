...
describe("AiCallDirect", function()
  it("should direct-load-ai_call", function()
    local setup = ai_call_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ai_call", setup.live and "live" or "unit")
...
function ai_call_direct_setup(mockres)
