...
describe("DeletedDirect", function()
  it("should direct-list-deleted", function()
    local setup = deleted_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-deleted", setup.live and "live" or "unit")
...
function deleted_direct_setup(mockres)
