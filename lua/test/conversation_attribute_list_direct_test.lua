-- ConversationAttributeList direct test
...
describe("ConversationAttributeListDirect", function()
  it("should direct-list-conversation_attribute_list", function()
    local setup = conversation_attribute_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-conversation_attribute_list", setup.live and "live" or "unit")
...
function conversation_attribute_list_direct_setup(mockres)
