...
describe("MergeHistoryDirect", function()
  it("should direct-list-merge_history", function()
    local setup = merge_history_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-merge_history", setup.live and "live" or "unit")
