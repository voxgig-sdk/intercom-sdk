-- CustomObjectInstance direct test
...
describe("CustomObjectInstanceDirect", function()
  it("should direct-load-custom_object_instance", function()
    local setup = custom_object_instance_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-custom_object_instance", setup.live and "live" or "unit")
...
function custom_object_instance_direct_setup(mockres)
