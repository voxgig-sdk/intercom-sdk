...
const testSeed = `map[string]any{"entity": map[string]any{"activity_log": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "activity_log_event_type": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "activity_log_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "admin": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "admin_with_app": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ai_call": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ai_content": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "article": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "article_search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "article_version": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "article_version_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "audience": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "away_status_reason": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "banner": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "banner_dismiss": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "brand": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "call": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "company": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "company_attached_contact": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "company_attached_segment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "company_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "company_scroll": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "contact": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "contact_attached_company": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "contact_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "contact_segment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "content": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "content_import_source": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "content_search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "content_snippet": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversation_attribute": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversation_attribute_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversation_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversation_participant": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom_object_instance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data_attribute": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data_connector": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data_connector_execution_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data_connector_execution_result_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data_event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data_event_summary": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "data_export": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deleted": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deleted_article_object": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deleted_company_object": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deleted_data_connector_object": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deleted_internal_article_object": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deleted_object": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "external_page": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "fin_agent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "handling_event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "help_center": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "internal_article": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "internal_article_search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ip_allowlist": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "job": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "macro": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "merge_history": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "news_item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "newsfeed": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "note": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "office_hour": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "office_hours_exception": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "office_hours_schedule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "paginated": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "phone_switch": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reporting_data": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reporting_data_export": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "segment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "side_conversation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscription": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscription_type": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tag": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "team": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "team_metric_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ticket": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ticket_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ticket_reply": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ticket_state": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ticket_type": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ticket_type_attribute": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "visitor": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whatsapp_message_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "whatsapp_message_status_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "workflow": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
