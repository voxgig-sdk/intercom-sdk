...
func NewContactListEntity(client *core.IntercomSDK, entopts map[string]any) *ContactListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContactListEntity) GetName() string { return e.name }
...
func (e *ContactListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ContactListEntity) Deleted() bool {
	return e.deleted
}


func (e *ContactListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewContactListEntity(e.client, opts)
}

func (e *ContactListEntity) Data(args ...any) any {
...
func (e *ContactListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ContactList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ContactListEntity) DataTyped(data ...ContactList) ContactList {
	if len(data) > 0 {
		return typedFrom[ContactList](e.Data(asMap(data[0])))
	}
	return typedFrom[ContactList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ContactList (all fields
// optional at the wire level).
func (e *ContactListEntity) MatchTyped(match ...ContactList) ContactList {
	if len(match) > 0 {
		return typedFrom[ContactList](e.Match(asMap(match[0])))
	}
	return typedFrom[ContactList](e.Match())
}
...
func (e *ContactListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ContactListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ContactListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ContactListEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ContactListCreateData and returns an ContactList. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ContactListEntity) CreateTyped(reqdata ContactListCreateData, ctrl map[string]any) (ContactList, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ContactList{}, err
	}
	return typedFrom[ContactList](res), nil
}



func (e *ContactListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ContactListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ContactListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
