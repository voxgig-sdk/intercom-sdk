...
func NewOfficeHourEntity(client *core.IntercomSDK, entopts map[string]any) *OfficeHourEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OfficeHourEntity) GetName() string { return e.name }
...
func (e *OfficeHourEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OfficeHourEntity) Deleted() bool {
	return e.deleted
}


func (e *OfficeHourEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOfficeHourEntity(e.client, opts)
}

func (e *OfficeHourEntity) Data(args ...any) any {
...
func (e *OfficeHourEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OfficeHour; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OfficeHourEntity) DataTyped(data ...OfficeHour) OfficeHour {
	if len(data) > 0 {
		return typedFrom[OfficeHour](e.Data(asMap(data[0])))
	}
	return typedFrom[OfficeHour](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OfficeHour (all fields
// optional at the wire level).
func (e *OfficeHourEntity) MatchTyped(match ...OfficeHour) OfficeHour {
	if len(match) > 0 {
		return typedFrom[OfficeHour](e.Match(asMap(match[0])))
	}
	return typedFrom[OfficeHour](e.Match())
}
...
func (e *OfficeHourEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OfficeHourEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *OfficeHourEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OfficeHourListMatch and returns []OfficeHour. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *OfficeHourEntity) ListTyped(reqmatch OfficeHourListMatch, ctrl map[string]any) ([]OfficeHour, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[OfficeHour](res), nil
}




func (e *OfficeHourEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// OfficeHourCreateData and returns an OfficeHour. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OfficeHourEntity) CreateTyped(reqdata OfficeHourCreateData, ctrl map[string]any) (OfficeHour, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return OfficeHour{}, err
	}
	return typedFrom[OfficeHour](res), nil
}



func (e *OfficeHourEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *OfficeHourEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// OfficeHourRemoveMatch and returns an OfficeHour. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *OfficeHourEntity) RemoveTyped(reqmatch OfficeHourRemoveMatch, ctrl map[string]any) (OfficeHour, error) {
...
func (e *OfficeHourEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
