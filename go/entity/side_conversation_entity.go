...
type SideConversationEntity struct {
	name    string
...
func NewSideConversationEntity(client *core.IntercomSDK, entopts map[string]any) *SideConversationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SideConversationEntity) GetName() string { return e.name }
...
func (e *SideConversationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SideConversationEntity) Deleted() bool {
	return e.deleted
}


func (e *SideConversationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSideConversationEntity(e.client, opts)
}

func (e *SideConversationEntity) Data(args ...any) any {
...
func (e *SideConversationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SideConversation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SideConversationEntity) DataTyped(data ...SideConversation) SideConversation {
	if len(data) > 0 {
		return typedFrom[SideConversation](e.Data(asMap(data[0])))
	}
	return typedFrom[SideConversation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SideConversation (all fields
// optional at the wire level).
func (e *SideConversationEntity) MatchTyped(match ...SideConversation) SideConversation {
	if len(match) > 0 {
		return typedFrom[SideConversation](e.Match(asMap(match[0])))
	}
	return typedFrom[SideConversation](e.Match())
}
...
func (e *SideConversationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SideConversationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SideConversationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SideConversationListMatch and returns []SideConversation. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SideConversationEntity) ListTyped(reqmatch SideConversationListMatch, ctrl map[string]any) ([]SideConversation, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[SideConversation](res), nil
}



func (e *SideConversationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SideConversationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SideConversationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SideConversationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
