...
func NewContentEntity(client *core.IntercomSDK, entopts map[string]any) *ContentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContentEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ContentCreateData and returns an Content. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ContentEntity) CreateTyped(reqdata ContentCreateData, ctrl map[string]any) (Content, error) {
