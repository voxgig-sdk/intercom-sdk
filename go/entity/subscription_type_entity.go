...
type SubscriptionTypeEntity struct {
	name    string
...
func NewSubscriptionTypeEntity(client *core.IntercomSDK, entopts map[string]any) *SubscriptionTypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SubscriptionTypeEntity) GetName() string { return e.name }
...
func (e *SubscriptionTypeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SubscriptionTypeEntity) Deleted() bool {
	return e.deleted
}


func (e *SubscriptionTypeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSubscriptionTypeEntity(e.client, opts)
}

func (e *SubscriptionTypeEntity) Data(args ...any) any {
...
func (e *SubscriptionTypeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an SubscriptionType; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SubscriptionTypeEntity) DataTyped(data ...SubscriptionType) SubscriptionType {
	if len(data) > 0 {
		return typedFrom[SubscriptionType](e.Data(asMap(data[0])))
	}
	return typedFrom[SubscriptionType](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through SubscriptionType (all fields
// optional at the wire level).
func (e *SubscriptionTypeEntity) MatchTyped(match ...SubscriptionType) SubscriptionType {
	if len(match) > 0 {
		return typedFrom[SubscriptionType](e.Match(asMap(match[0])))
	}
	return typedFrom[SubscriptionType](e.Match())
}
...
func (e *SubscriptionTypeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SubscriptionTypeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *SubscriptionTypeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SubscriptionTypeListMatch and returns []SubscriptionType. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SubscriptionTypeEntity) ListTyped(reqmatch SubscriptionTypeListMatch, ctrl map[string]any) ([]SubscriptionType, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[SubscriptionType](res), nil
}



func (e *SubscriptionTypeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SubscriptionTypeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SubscriptionTypeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SubscriptionTypeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
