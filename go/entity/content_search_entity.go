...
type ContentSearchEntity struct {
	name    string
...
func NewContentSearchEntity(client *core.IntercomSDK, entopts map[string]any) *ContentSearchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContentSearchEntity) GetName() string { return e.name }
...
func (e *ContentSearchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ContentSearchEntity) Deleted() bool {
	return e.deleted
}


func (e *ContentSearchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewContentSearchEntity(e.client, opts)
}

func (e *ContentSearchEntity) Data(args ...any) any {
...
func (e *ContentSearchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ContentSearch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ContentSearchEntity) DataTyped(data ...ContentSearch) ContentSearch {
	if len(data) > 0 {
		return typedFrom[ContentSearch](e.Data(asMap(data[0])))
	}
	return typedFrom[ContentSearch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ContentSearch (all fields
// optional at the wire level).
func (e *ContentSearchEntity) MatchTyped(match ...ContentSearch) ContentSearch {
	if len(match) > 0 {
		return typedFrom[ContentSearch](e.Match(asMap(match[0])))
	}
	return typedFrom[ContentSearch](e.Match())
}
...
func (e *ContentSearchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ContentSearchEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ContentSearchEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ContentSearchListMatch and returns []ContentSearch. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ContentSearchEntity) ListTyped(reqmatch ContentSearchListMatch, ctrl map[string]any) ([]ContentSearch, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ContentSearch](res), nil
}



func (e *ContentSearchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ContentSearchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ContentSearchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ContentSearchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
