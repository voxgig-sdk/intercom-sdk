...
func NewAiContentEntity(client *core.IntercomSDK, entopts map[string]any) *AiContentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AiContentEntity) GetName() string { return e.name }
...
func (e *AiContentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AiContentEntity) Deleted() bool {
	return e.deleted
}


func (e *AiContentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAiContentEntity(e.client, opts)
}

func (e *AiContentEntity) Data(args ...any) any {
...
func (e *AiContentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AiContent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AiContentEntity) DataTyped(data ...AiContent) AiContent {
	if len(data) > 0 {
		return typedFrom[AiContent](e.Data(asMap(data[0])))
	}
	return typedFrom[AiContent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AiContent (all fields
// optional at the wire level).
func (e *AiContentEntity) MatchTyped(match ...AiContent) AiContent {
	if len(match) > 0 {
		return typedFrom[AiContent](e.Match(asMap(match[0])))
	}
	return typedFrom[AiContent](e.Match())
}
...
func (e *AiContentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AiContentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AiContentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AiContentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AiContentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *AiContentEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AiContentRemoveMatch and returns an AiContent. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *AiContentEntity) RemoveTyped(reqmatch AiContentRemoveMatch, ctrl map[string]any) (AiContent, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return AiContent{}, err
	}
	return typedFrom[AiContent](res), nil
}



func (e *AiContentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
