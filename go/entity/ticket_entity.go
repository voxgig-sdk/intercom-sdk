...
func NewTicketEntity(client *core.IntercomSDK, entopts map[string]any) *TicketEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TicketEntity) GetName() string { return e.name }
...
func (e *TicketEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TicketEntity) Deleted() bool {
	return e.deleted
}


func (e *TicketEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTicketEntity(e.client, opts)
}

func (e *TicketEntity) Data(args ...any) any {
...
func (e *TicketEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Ticket; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TicketEntity) DataTyped(data ...Ticket) Ticket {
	if len(data) > 0 {
		return typedFrom[Ticket](e.Data(asMap(data[0])))
	}
	return typedFrom[Ticket](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Ticket (all fields
// optional at the wire level).
func (e *TicketEntity) MatchTyped(match ...Ticket) Ticket {
	if len(match) > 0 {
		return typedFrom[Ticket](e.Match(asMap(match[0])))
	}
	return typedFrom[Ticket](e.Match())
}
...
func (e *TicketEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TicketEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TicketLoadMatch and returns an Ticket. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TicketEntity) LoadTyped(reqmatch TicketLoadMatch, ctrl map[string]any) (Ticket, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Ticket{}, err
	}
	return typedFrom[Ticket](res), nil
}



func (e *TicketEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TicketEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// TicketCreateData and returns an Ticket. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TicketEntity) CreateTyped(reqdata TicketCreateData, ctrl map[string]any) (Ticket, error) {
...
func (e *TicketEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// TicketUpdateData and returns an Ticket. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *TicketEntity) UpdateTyped(reqdata TicketUpdateData, ctrl map[string]any) (Ticket, error) {
...
func (e *TicketEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// TicketRemoveMatch and returns an Ticket. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *TicketEntity) RemoveTyped(reqmatch TicketRemoveMatch, ctrl map[string]any) (Ticket, error) {
...
func (e *TicketEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
