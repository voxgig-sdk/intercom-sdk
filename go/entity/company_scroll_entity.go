...
type CompanyScrollEntity struct {
	name    string
...
func NewCompanyScrollEntity(client *core.IntercomSDK, entopts map[string]any) *CompanyScrollEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CompanyScrollEntity) GetName() string { return e.name }
...
func (e *CompanyScrollEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CompanyScrollEntity) Deleted() bool {
	return e.deleted
}


func (e *CompanyScrollEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCompanyScrollEntity(e.client, opts)
}

func (e *CompanyScrollEntity) Data(args ...any) any {
...
func (e *CompanyScrollEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CompanyScroll; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CompanyScrollEntity) DataTyped(data ...CompanyScroll) CompanyScroll {
	if len(data) > 0 {
		return typedFrom[CompanyScroll](e.Data(asMap(data[0])))
	}
	return typedFrom[CompanyScroll](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CompanyScroll (all fields
// optional at the wire level).
func (e *CompanyScrollEntity) MatchTyped(match ...CompanyScroll) CompanyScroll {
	if len(match) > 0 {
		return typedFrom[CompanyScroll](e.Match(asMap(match[0])))
	}
	return typedFrom[CompanyScroll](e.Match())
}
...
func (e *CompanyScrollEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CompanyScrollEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CompanyScrollEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CompanyScrollListMatch and returns []CompanyScroll. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CompanyScrollEntity) ListTyped(reqmatch CompanyScrollListMatch, ctrl map[string]any) ([]CompanyScroll, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CompanyScroll](res), nil
}



func (e *CompanyScrollEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CompanyScrollEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CompanyScrollEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CompanyScrollEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
