...
func NewPhoneSwitchEntity(client *core.IntercomSDK, entopts map[string]any) *PhoneSwitchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PhoneSwitchEntity) GetName() string { return e.name }
...
func (e *PhoneSwitchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PhoneSwitchEntity) Deleted() bool {
	return e.deleted
}


func (e *PhoneSwitchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPhoneSwitchEntity(e.client, opts)
}

func (e *PhoneSwitchEntity) Data(args ...any) any {
...
func (e *PhoneSwitchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PhoneSwitch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PhoneSwitchEntity) DataTyped(data ...PhoneSwitch) PhoneSwitch {
	if len(data) > 0 {
		return typedFrom[PhoneSwitch](e.Data(asMap(data[0])))
	}
	return typedFrom[PhoneSwitch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PhoneSwitch (all fields
// optional at the wire level).
func (e *PhoneSwitchEntity) MatchTyped(match ...PhoneSwitch) PhoneSwitch {
	if len(match) > 0 {
		return typedFrom[PhoneSwitch](e.Match(asMap(match[0])))
	}
	return typedFrom[PhoneSwitch](e.Match())
}
...
func (e *PhoneSwitchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PhoneSwitchEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PhoneSwitchEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *PhoneSwitchEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PhoneSwitchCreateData and returns an PhoneSwitch. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *PhoneSwitchEntity) CreateTyped(reqdata PhoneSwitchCreateData, ctrl map[string]any) (PhoneSwitch, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return PhoneSwitch{}, err
	}
	return typedFrom[PhoneSwitch](res), nil
}



func (e *PhoneSwitchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PhoneSwitchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PhoneSwitchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
