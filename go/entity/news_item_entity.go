...
func NewNewsItemEntity(client *core.IntercomSDK, entopts map[string]any) *NewsItemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NewsItemEntity) GetName() string { return e.name }
...
func (e *NewsItemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NewsItemEntity) Deleted() bool {
	return e.deleted
}


func (e *NewsItemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNewsItemEntity(e.client, opts)
}

func (e *NewsItemEntity) Data(args ...any) any {
...
func (e *NewsItemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an NewsItem; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NewsItemEntity) DataTyped(data ...NewsItem) NewsItem {
	if len(data) > 0 {
		return typedFrom[NewsItem](e.Data(asMap(data[0])))
	}
	return typedFrom[NewsItem](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through NewsItem (all fields
// optional at the wire level).
func (e *NewsItemEntity) MatchTyped(match ...NewsItem) NewsItem {
	if len(match) > 0 {
		return typedFrom[NewsItem](e.Match(asMap(match[0])))
	}
	return typedFrom[NewsItem](e.Match())
}
...
func (e *NewsItemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NewsItemEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NewsItemLoadMatch and returns an NewsItem. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NewsItemEntity) LoadTyped(reqmatch NewsItemLoadMatch, ctrl map[string]any) (NewsItem, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return NewsItem{}, err
	}
	return typedFrom[NewsItem](res), nil
}



func (e *NewsItemEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *NewsItemEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// NewsItemCreateData and returns an NewsItem. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *NewsItemEntity) CreateTyped(reqdata NewsItemCreateData, ctrl map[string]any) (NewsItem, error) {
...
func (e *NewsItemEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// NewsItemUpdateData and returns an NewsItem. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *NewsItemEntity) UpdateTyped(reqdata NewsItemUpdateData, ctrl map[string]any) (NewsItem, error) {
...
func (e *NewsItemEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NewsItemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
