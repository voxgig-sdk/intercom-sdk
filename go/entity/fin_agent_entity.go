...
func NewFinAgentEntity(client *core.IntercomSDK, entopts map[string]any) *FinAgentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FinAgentEntity) GetName() string { return e.name }
...
func (e *FinAgentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FinAgentEntity) Deleted() bool {
	return e.deleted
}


func (e *FinAgentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFinAgentEntity(e.client, opts)
}

func (e *FinAgentEntity) Data(args ...any) any {
...
func (e *FinAgentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FinAgent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FinAgentEntity) DataTyped(data ...FinAgent) FinAgent {
	if len(data) > 0 {
		return typedFrom[FinAgent](e.Data(asMap(data[0])))
	}
	return typedFrom[FinAgent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FinAgent (all fields
// optional at the wire level).
func (e *FinAgentEntity) MatchTyped(match ...FinAgent) FinAgent {
	if len(match) > 0 {
		return typedFrom[FinAgent](e.Match(asMap(match[0])))
	}
	return typedFrom[FinAgent](e.Match())
}
...
func (e *FinAgentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FinAgentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *FinAgentEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *FinAgentEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FinAgentCreateData and returns an FinAgent. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *FinAgentEntity) CreateTyped(reqdata FinAgentCreateData, ctrl map[string]any) (FinAgent, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return FinAgent{}, err
	}
	return typedFrom[FinAgent](res), nil
}



func (e *FinAgentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FinAgentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FinAgentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
