...
func NewVisitorEntity(client *core.IntercomSDK, entopts map[string]any) *VisitorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VisitorEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VisitorLoadMatch and returns an Visitor. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *VisitorEntity) LoadTyped(reqmatch VisitorLoadMatch, ctrl map[string]any) (Visitor, error) {
...
func (e *VisitorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *VisitorEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// VisitorUpdateData and returns an Visitor. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *VisitorEntity) UpdateTyped(reqdata VisitorUpdateData, ctrl map[string]any) (Visitor, error) {
