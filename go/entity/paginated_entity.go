...
func NewPaginatedEntity(client *core.IntercomSDK, entopts map[string]any) *PaginatedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PaginatedEntity) GetName() string { return e.name }
...
func (e *PaginatedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PaginatedEntity) Deleted() bool {
	return e.deleted
}


func (e *PaginatedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPaginatedEntity(e.client, opts)
}

func (e *PaginatedEntity) Data(args ...any) any {
...
func (e *PaginatedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Paginated; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PaginatedEntity) DataTyped(data ...Paginated) Paginated {
	if len(data) > 0 {
		return typedFrom[Paginated](e.Data(asMap(data[0])))
	}
	return typedFrom[Paginated](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Paginated (all fields
// optional at the wire level).
func (e *PaginatedEntity) MatchTyped(match ...Paginated) Paginated {
	if len(match) > 0 {
		return typedFrom[Paginated](e.Match(asMap(match[0])))
	}
	return typedFrom[Paginated](e.Match())
}
...
func (e *PaginatedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PaginatedEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PaginatedEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PaginatedListMatch and returns []Paginated. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PaginatedEntity) ListTyped(reqmatch PaginatedListMatch, ctrl map[string]any) ([]Paginated, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Paginated](res), nil
}



func (e *PaginatedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PaginatedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PaginatedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PaginatedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
