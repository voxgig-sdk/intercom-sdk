...
type DataEventSummaryEntity struct {
	name    string
...
func NewDataEventSummaryEntity(client *core.IntercomSDK, entopts map[string]any) *DataEventSummaryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DataEventSummaryEntity) GetName() string { return e.name }
...
func (e *DataEventSummaryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DataEventSummaryEntity) Deleted() bool {
	return e.deleted
}


func (e *DataEventSummaryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDataEventSummaryEntity(e.client, opts)
}

func (e *DataEventSummaryEntity) Data(args ...any) any {
...
func (e *DataEventSummaryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DataEventSummary; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DataEventSummaryEntity) DataTyped(data ...DataEventSummary) DataEventSummary {
	if len(data) > 0 {
		return typedFrom[DataEventSummary](e.Data(asMap(data[0])))
	}
	return typedFrom[DataEventSummary](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DataEventSummary (all fields
// optional at the wire level).
func (e *DataEventSummaryEntity) MatchTyped(match ...DataEventSummary) DataEventSummary {
	if len(match) > 0 {
		return typedFrom[DataEventSummary](e.Match(asMap(match[0])))
	}
	return typedFrom[DataEventSummary](e.Match())
}
...
func (e *DataEventSummaryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DataEventSummaryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DataEventSummaryEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DataEventSummaryListMatch and returns []DataEventSummary. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DataEventSummaryEntity) ListTyped(reqmatch DataEventSummaryListMatch, ctrl map[string]any) ([]DataEventSummary, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[DataEventSummary](res), nil
}



func (e *DataEventSummaryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DataEventSummaryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DataEventSummaryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DataEventSummaryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
