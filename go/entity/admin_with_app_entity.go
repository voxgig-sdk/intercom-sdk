...
type AdminWithAppEntity struct {
	name    string
...
func NewAdminWithAppEntity(client *core.IntercomSDK, entopts map[string]any) *AdminWithAppEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdminWithAppEntity) GetName() string { return e.name }
...
func (e *AdminWithAppEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdminWithAppEntity) Deleted() bool {
	return e.deleted
}


func (e *AdminWithAppEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdminWithAppEntity(e.client, opts)
}

func (e *AdminWithAppEntity) Data(args ...any) any {
...
func (e *AdminWithAppEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AdminWithApp; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AdminWithAppEntity) DataTyped(data ...AdminWithApp) AdminWithApp {
	if len(data) > 0 {
		return typedFrom[AdminWithApp](e.Data(asMap(data[0])))
	}
	return typedFrom[AdminWithApp](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AdminWithApp (all fields
// optional at the wire level).
func (e *AdminWithAppEntity) MatchTyped(match ...AdminWithApp) AdminWithApp {
	if len(match) > 0 {
		return typedFrom[AdminWithApp](e.Match(asMap(match[0])))
	}
	return typedFrom[AdminWithApp](e.Match())
}
...
func (e *AdminWithAppEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdminWithAppEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AdminWithAppEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AdminWithAppListMatch and returns []AdminWithApp. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AdminWithAppEntity) ListTyped(reqmatch AdminWithAppListMatch, ctrl map[string]any) ([]AdminWithApp, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AdminWithApp](res), nil
}



func (e *AdminWithAppEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AdminWithAppEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AdminWithAppEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdminWithAppEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
