...
func NewAiCallEntity(client *core.IntercomSDK, entopts map[string]any) *AiCallEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AiCallEntity) GetName() string { return e.name }
...
func (e *AiCallEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AiCallEntity) Deleted() bool {
	return e.deleted
}


func (e *AiCallEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAiCallEntity(e.client, opts)
}

func (e *AiCallEntity) Data(args ...any) any {
...
func (e *AiCallEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AiCall; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AiCallEntity) DataTyped(data ...AiCall) AiCall {
	if len(data) > 0 {
		return typedFrom[AiCall](e.Data(asMap(data[0])))
	}
	return typedFrom[AiCall](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AiCall (all fields
// optional at the wire level).
func (e *AiCallEntity) MatchTyped(match ...AiCall) AiCall {
	if len(match) > 0 {
		return typedFrom[AiCall](e.Match(asMap(match[0])))
	}
	return typedFrom[AiCall](e.Match())
}
...
func (e *AiCallEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AiCallEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AiCallLoadMatch and returns an AiCall. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AiCallEntity) LoadTyped(reqmatch AiCallLoadMatch, ctrl map[string]any) (AiCall, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return AiCall{}, err
	}
	return typedFrom[AiCall](res), nil
}



func (e *AiCallEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AiCallEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AiCallCreateData and returns an AiCall. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AiCallEntity) CreateTyped(reqdata AiCallCreateData, ctrl map[string]any) (AiCall, error) {
...
func (e *AiCallEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AiCallEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AiCallEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
