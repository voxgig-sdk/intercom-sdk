...
type ContactSegmentEntity struct {
	name    string
...
func NewContactSegmentEntity(client *core.IntercomSDK, entopts map[string]any) *ContactSegmentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContactSegmentEntity) GetName() string { return e.name }
...
func (e *ContactSegmentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ContactSegmentEntity) Deleted() bool {
	return e.deleted
}


func (e *ContactSegmentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewContactSegmentEntity(e.client, opts)
}

func (e *ContactSegmentEntity) Data(args ...any) any {
...
func (e *ContactSegmentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ContactSegment; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ContactSegmentEntity) DataTyped(data ...ContactSegment) ContactSegment {
	if len(data) > 0 {
		return typedFrom[ContactSegment](e.Data(asMap(data[0])))
	}
	return typedFrom[ContactSegment](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ContactSegment (all fields
// optional at the wire level).
func (e *ContactSegmentEntity) MatchTyped(match ...ContactSegment) ContactSegment {
	if len(match) > 0 {
		return typedFrom[ContactSegment](e.Match(asMap(match[0])))
	}
	return typedFrom[ContactSegment](e.Match())
}
...
func (e *ContactSegmentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ContactSegmentEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ContactSegmentEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ContactSegmentListMatch and returns []ContactSegment. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ContactSegmentEntity) ListTyped(reqmatch ContactSegmentListMatch, ctrl map[string]any) ([]ContactSegment, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ContactSegment](res), nil
}



func (e *ContactSegmentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ContactSegmentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ContactSegmentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ContactSegmentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
