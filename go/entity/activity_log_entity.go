...
func NewActivityLogEntity(client *core.IntercomSDK, entopts map[string]any) *ActivityLogEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ActivityLogEntity) GetName() string { return e.name }
...
func (e *ActivityLogEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ActivityLogEntity) Deleted() bool {
	return e.deleted
}


func (e *ActivityLogEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewActivityLogEntity(e.client, opts)
}

func (e *ActivityLogEntity) Data(args ...any) any {
...
func (e *ActivityLogEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ActivityLog; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ActivityLogEntity) DataTyped(data ...ActivityLog) ActivityLog {
	if len(data) > 0 {
		return typedFrom[ActivityLog](e.Data(asMap(data[0])))
	}
	return typedFrom[ActivityLog](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ActivityLog (all fields
// optional at the wire level).
func (e *ActivityLogEntity) MatchTyped(match ...ActivityLog) ActivityLog {
	if len(match) > 0 {
		return typedFrom[ActivityLog](e.Match(asMap(match[0])))
	}
	return typedFrom[ActivityLog](e.Match())
}
...
func (e *ActivityLogEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ActivityLogEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ActivityLogEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ActivityLogListMatch and returns []ActivityLog. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ActivityLogEntity) ListTyped(reqmatch ActivityLogListMatch, ctrl map[string]any) ([]ActivityLog, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ActivityLog](res), nil
}



func (e *ActivityLogEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ActivityLogEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ActivityLogEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ActivityLogEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
