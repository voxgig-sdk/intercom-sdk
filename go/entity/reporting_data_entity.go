...
type ReportingDataEntity struct {
	name    string
...
func NewReportingDataEntity(client *core.IntercomSDK, entopts map[string]any) *ReportingDataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReportingDataEntity) GetName() string { return e.name }
...
func (e *ReportingDataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReportingDataEntity) Deleted() bool {
	return e.deleted
}


func (e *ReportingDataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReportingDataEntity(e.client, opts)
}

func (e *ReportingDataEntity) Data(args ...any) any {
...
func (e *ReportingDataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ReportingData; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReportingDataEntity) DataTyped(data ...ReportingData) ReportingData {
	if len(data) > 0 {
		return typedFrom[ReportingData](e.Data(asMap(data[0])))
	}
	return typedFrom[ReportingData](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ReportingData (all fields
// optional at the wire level).
func (e *ReportingDataEntity) MatchTyped(match ...ReportingData) ReportingData {
	if len(match) > 0 {
		return typedFrom[ReportingData](e.Match(asMap(match[0])))
	}
	return typedFrom[ReportingData](e.Match())
}
...
func (e *ReportingDataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReportingDataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReportingDataLoadMatch and returns an ReportingData. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReportingDataEntity) LoadTyped(reqmatch ReportingDataLoadMatch, ctrl map[string]any) (ReportingData, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ReportingData{}, err
	}
	return typedFrom[ReportingData](res), nil
}



func (e *ReportingDataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReportingDataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReportingDataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReportingDataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReportingDataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
