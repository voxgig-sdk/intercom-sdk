...
func NewAdminEntity(client *core.IntercomSDK, entopts map[string]any) *AdminEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AdminEntity) GetName() string { return e.name }
...
func (e *AdminEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AdminEntity) Deleted() bool {
	return e.deleted
}


func (e *AdminEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAdminEntity(e.client, opts)
}

func (e *AdminEntity) Data(args ...any) any {
...
func (e *AdminEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Admin; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AdminEntity) DataTyped(data ...Admin) Admin {
	if len(data) > 0 {
		return typedFrom[Admin](e.Data(asMap(data[0])))
	}
	return typedFrom[Admin](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Admin (all fields
// optional at the wire level).
func (e *AdminEntity) MatchTyped(match ...Admin) Admin {
	if len(match) > 0 {
		return typedFrom[Admin](e.Match(asMap(match[0])))
	}
	return typedFrom[Admin](e.Match())
}
...
func (e *AdminEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AdminEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AdminLoadMatch and returns an Admin. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AdminEntity) LoadTyped(reqmatch AdminLoadMatch, ctrl map[string]any) (Admin, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Admin{}, err
	}
	return typedFrom[Admin](res), nil
}




func (e *AdminEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AdminListMatch and returns []Admin. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AdminEntity) ListTyped(reqmatch AdminListMatch, ctrl map[string]any) ([]Admin, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Admin](res), nil
}



func (e *AdminEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *AdminEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// AdminUpdateData and returns an Admin. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *AdminEntity) UpdateTyped(reqdata AdminUpdateData, ctrl map[string]any) (Admin, error) {
...
func (e *AdminEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AdminEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
