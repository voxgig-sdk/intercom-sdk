...
func NewTagEntity(client *core.IntercomSDK, entopts map[string]any) *TagEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TagEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// TagListMatch and returns []Tag. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TagEntity) ListTyped(reqmatch TagListMatch, ctrl map[string]any) ([]Tag, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Tag](res), nil
}
