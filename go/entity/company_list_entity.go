...
func NewCompanyListEntity(client *core.IntercomSDK, entopts map[string]any) *CompanyListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CompanyListEntity) GetName() string { return e.name }
...
func (e *CompanyListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CompanyListEntity) Deleted() bool {
	return e.deleted
}


func (e *CompanyListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCompanyListEntity(e.client, opts)
}

func (e *CompanyListEntity) Data(args ...any) any {
...
func (e *CompanyListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CompanyList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CompanyListEntity) DataTyped(data ...CompanyList) CompanyList {
	if len(data) > 0 {
		return typedFrom[CompanyList](e.Data(asMap(data[0])))
	}
	return typedFrom[CompanyList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CompanyList (all fields
// optional at the wire level).
func (e *CompanyListEntity) MatchTyped(match ...CompanyList) CompanyList {
	if len(match) > 0 {
		return typedFrom[CompanyList](e.Match(asMap(match[0])))
	}
	return typedFrom[CompanyList](e.Match())
}
...
func (e *CompanyListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CompanyListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *CompanyListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *CompanyListEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CompanyListCreateData and returns an CompanyList. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CompanyListEntity) CreateTyped(reqdata CompanyListCreateData, ctrl map[string]any) (CompanyList, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return CompanyList{}, err
	}
	return typedFrom[CompanyList](res), nil
}



func (e *CompanyListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CompanyListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CompanyListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
