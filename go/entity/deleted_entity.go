...
func NewDeletedEntity(client *core.IntercomSDK, entopts map[string]any) *DeletedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeletedEntity) GetName() string { return e.name }
...
func (e *DeletedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeletedEntity) Deleted() bool {
	return e.deleted
}


func (e *DeletedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeletedEntity(e.client, opts)
}

func (e *DeletedEntity) Data(args ...any) any {
...
func (e *DeletedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Deleted; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeletedEntity) DataTyped(data ...Deleted) Deleted {
	if len(data) > 0 {
		return typedFrom[Deleted](e.Data(asMap(data[0])))
	}
	return typedFrom[Deleted](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Deleted (all fields
// optional at the wire level).
func (e *DeletedEntity) MatchTyped(match ...Deleted) Deleted {
	if len(match) > 0 {
		return typedFrom[Deleted](e.Match(asMap(match[0])))
	}
	return typedFrom[Deleted](e.Match())
}
...
func (e *DeletedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeletedEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DeletedEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeletedListMatch and returns []Deleted. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DeletedEntity) ListTyped(reqmatch DeletedListMatch, ctrl map[string]any) ([]Deleted, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Deleted](res), nil
}



func (e *DeletedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeletedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DeletedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DeletedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
