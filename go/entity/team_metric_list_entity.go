...
type TeamMetricListEntity struct {
	name    string
...
func NewTeamMetricListEntity(client *core.IntercomSDK, entopts map[string]any) *TeamMetricListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TeamMetricListEntity) GetName() string { return e.name }
...
func (e *TeamMetricListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TeamMetricListEntity) Deleted() bool {
	return e.deleted
}


func (e *TeamMetricListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTeamMetricListEntity(e.client, opts)
}

func (e *TeamMetricListEntity) Data(args ...any) any {
...
func (e *TeamMetricListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TeamMetricList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TeamMetricListEntity) DataTyped(data ...TeamMetricList) TeamMetricList {
	if len(data) > 0 {
		return typedFrom[TeamMetricList](e.Data(asMap(data[0])))
	}
	return typedFrom[TeamMetricList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TeamMetricList (all fields
// optional at the wire level).
func (e *TeamMetricListEntity) MatchTyped(match ...TeamMetricList) TeamMetricList {
	if len(match) > 0 {
		return typedFrom[TeamMetricList](e.Match(asMap(match[0])))
	}
	return typedFrom[TeamMetricList](e.Match())
}
...
func (e *TeamMetricListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TeamMetricListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TeamMetricListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TeamMetricListListMatch and returns []TeamMetricList. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TeamMetricListEntity) ListTyped(reqmatch TeamMetricListListMatch, ctrl map[string]any) ([]TeamMetricList, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TeamMetricList](res), nil
}



func (e *TeamMetricListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TeamMetricListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TeamMetricListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TeamMetricListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
