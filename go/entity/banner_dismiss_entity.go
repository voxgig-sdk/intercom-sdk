...
type BannerDismissEntity struct {
	name    string
...
func NewBannerDismissEntity(client *core.IntercomSDK, entopts map[string]any) *BannerDismissEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BannerDismissEntity) GetName() string { return e.name }
...
func (e *BannerDismissEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BannerDismissEntity) Deleted() bool {
	return e.deleted
}


func (e *BannerDismissEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBannerDismissEntity(e.client, opts)
}

func (e *BannerDismissEntity) Data(args ...any) any {
...
func (e *BannerDismissEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BannerDismiss; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BannerDismissEntity) DataTyped(data ...BannerDismiss) BannerDismiss {
	if len(data) > 0 {
		return typedFrom[BannerDismiss](e.Data(asMap(data[0])))
	}
	return typedFrom[BannerDismiss](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BannerDismiss (all fields
// optional at the wire level).
func (e *BannerDismissEntity) MatchTyped(match ...BannerDismiss) BannerDismiss {
	if len(match) > 0 {
		return typedFrom[BannerDismiss](e.Match(asMap(match[0])))
	}
	return typedFrom[BannerDismiss](e.Match())
}
...
func (e *BannerDismissEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BannerDismissEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *BannerDismissEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *BannerDismissEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BannerDismissCreateData and returns an BannerDismiss. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *BannerDismissEntity) CreateTyped(reqdata BannerDismissCreateData, ctrl map[string]any) (BannerDismiss, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return BannerDismiss{}, err
	}
	return typedFrom[BannerDismiss](res), nil
}



func (e *BannerDismissEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BannerDismissEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BannerDismissEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
