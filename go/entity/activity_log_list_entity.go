...
type ActivityLogListEntity struct {
	name    string
...
func NewActivityLogListEntity(client *core.IntercomSDK, entopts map[string]any) *ActivityLogListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ActivityLogListEntity) GetName() string { return e.name }
...
func (e *ActivityLogListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ActivityLogListEntity) Deleted() bool {
	return e.deleted
}


func (e *ActivityLogListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewActivityLogListEntity(e.client, opts)
}

func (e *ActivityLogListEntity) Data(args ...any) any {
...
func (e *ActivityLogListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ActivityLogList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ActivityLogListEntity) DataTyped(data ...ActivityLogList) ActivityLogList {
	if len(data) > 0 {
		return typedFrom[ActivityLogList](e.Data(asMap(data[0])))
	}
	return typedFrom[ActivityLogList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ActivityLogList (all fields
// optional at the wire level).
func (e *ActivityLogListEntity) MatchTyped(match ...ActivityLogList) ActivityLogList {
	if len(match) > 0 {
		return typedFrom[ActivityLogList](e.Match(asMap(match[0])))
	}
	return typedFrom[ActivityLogList](e.Match())
}
...
func (e *ActivityLogListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ActivityLogListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ActivityLogListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ActivityLogListEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ActivityLogListCreateData and returns an ActivityLogList. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ActivityLogListEntity) CreateTyped(reqdata ActivityLogListCreateData, ctrl map[string]any) (ActivityLogList, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ActivityLogList{}, err
	}
	return typedFrom[ActivityLogList](res), nil
}



func (e *ActivityLogListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ActivityLogListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ActivityLogListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
