...
type DeletedArticleObjectEntity struct {
	name    string
...
func NewDeletedArticleObjectEntity(client *core.IntercomSDK, entopts map[string]any) *DeletedArticleObjectEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeletedArticleObjectEntity) GetName() string { return e.name }
...
func (e *DeletedArticleObjectEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeletedArticleObjectEntity) Deleted() bool {
	return e.deleted
}


func (e *DeletedArticleObjectEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeletedArticleObjectEntity(e.client, opts)
}

func (e *DeletedArticleObjectEntity) Data(args ...any) any {
...
func (e *DeletedArticleObjectEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DeletedArticleObject; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeletedArticleObjectEntity) DataTyped(data ...DeletedArticleObject) DeletedArticleObject {
	if len(data) > 0 {
		return typedFrom[DeletedArticleObject](e.Data(asMap(data[0])))
	}
	return typedFrom[DeletedArticleObject](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DeletedArticleObject (all fields
// optional at the wire level).
func (e *DeletedArticleObjectEntity) MatchTyped(match ...DeletedArticleObject) DeletedArticleObject {
	if len(match) > 0 {
		return typedFrom[DeletedArticleObject](e.Match(asMap(match[0])))
	}
	return typedFrom[DeletedArticleObject](e.Match())
}
...
func (e *DeletedArticleObjectEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeletedArticleObjectEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DeletedArticleObjectEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DeletedArticleObjectEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeletedArticleObjectEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *DeletedArticleObjectEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeletedArticleObjectRemoveMatch and returns an DeletedArticleObject. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *DeletedArticleObjectEntity) RemoveTyped(reqmatch DeletedArticleObjectRemoveMatch, ctrl map[string]any) (DeletedArticleObject, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return DeletedArticleObject{}, err
	}
	return typedFrom[DeletedArticleObject](res), nil
}



func (e *DeletedArticleObjectEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
