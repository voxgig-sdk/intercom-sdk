...
func NewNoteEntity(client *core.IntercomSDK, entopts map[string]any) *NoteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NoteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NoteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
