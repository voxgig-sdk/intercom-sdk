...
func NewDataEventEntity(client *core.IntercomSDK, entopts map[string]any) *DataEventEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DataEventEntity) GetName() string { return e.name }
...
func (e *DataEventEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DataEventEntity) Deleted() bool {
	return e.deleted
}


func (e *DataEventEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDataEventEntity(e.client, opts)
}

func (e *DataEventEntity) Data(args ...any) any {
...
func (e *DataEventEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DataEvent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DataEventEntity) DataTyped(data ...DataEvent) DataEvent {
	if len(data) > 0 {
		return typedFrom[DataEvent](e.Data(asMap(data[0])))
	}
	return typedFrom[DataEvent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DataEvent (all fields
// optional at the wire level).
func (e *DataEventEntity) MatchTyped(match ...DataEvent) DataEvent {
	if len(match) > 0 {
		return typedFrom[DataEvent](e.Match(asMap(match[0])))
	}
	return typedFrom[DataEvent](e.Match())
}
...
func (e *DataEventEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DataEventEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DataEventEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DataEventEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DataEventCreateData and returns an DataEvent. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DataEventEntity) CreateTyped(reqdata DataEventCreateData, ctrl map[string]any) (DataEvent, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return DataEvent{}, err
	}
	return typedFrom[DataEvent](res), nil
}



func (e *DataEventEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DataEventEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DataEventEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
