...
func NewTicketListEntity(client *core.IntercomSDK, entopts map[string]any) *TicketListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TicketListEntity) GetName() string { return e.name }
...
func (e *TicketListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TicketListEntity) Deleted() bool {
	return e.deleted
}


func (e *TicketListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTicketListEntity(e.client, opts)
}

func (e *TicketListEntity) Data(args ...any) any {
...
func (e *TicketListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TicketList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TicketListEntity) DataTyped(data ...TicketList) TicketList {
	if len(data) > 0 {
		return typedFrom[TicketList](e.Data(asMap(data[0])))
	}
	return typedFrom[TicketList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TicketList (all fields
// optional at the wire level).
func (e *TicketListEntity) MatchTyped(match ...TicketList) TicketList {
	if len(match) > 0 {
		return typedFrom[TicketList](e.Match(asMap(match[0])))
	}
	return typedFrom[TicketList](e.Match())
}
...
func (e *TicketListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TicketListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *TicketListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *TicketListEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TicketListCreateData and returns an TicketList. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *TicketListEntity) CreateTyped(reqdata TicketListCreateData, ctrl map[string]any) (TicketList, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return TicketList{}, err
	}
	return typedFrom[TicketList](res), nil
}



func (e *TicketListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TicketListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TicketListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
