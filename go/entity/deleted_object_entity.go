...
type DeletedObjectEntity struct {
	name    string
...
func NewDeletedObjectEntity(client *core.IntercomSDK, entopts map[string]any) *DeletedObjectEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeletedObjectEntity) GetName() string { return e.name }
...
func (e *DeletedObjectEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeletedObjectEntity) Deleted() bool {
	return e.deleted
}


func (e *DeletedObjectEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeletedObjectEntity(e.client, opts)
}

func (e *DeletedObjectEntity) Data(args ...any) any {
...
func (e *DeletedObjectEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DeletedObject; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeletedObjectEntity) DataTyped(data ...DeletedObject) DeletedObject {
	if len(data) > 0 {
		return typedFrom[DeletedObject](e.Data(asMap(data[0])))
	}
	return typedFrom[DeletedObject](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DeletedObject (all fields
// optional at the wire level).
func (e *DeletedObjectEntity) MatchTyped(match ...DeletedObject) DeletedObject {
	if len(match) > 0 {
		return typedFrom[DeletedObject](e.Match(asMap(match[0])))
	}
	return typedFrom[DeletedObject](e.Match())
}
...
func (e *DeletedObjectEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeletedObjectEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DeletedObjectEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DeletedObjectEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeletedObjectEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *DeletedObjectEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeletedObjectRemoveMatch and returns an DeletedObject. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *DeletedObjectEntity) RemoveTyped(reqmatch DeletedObjectRemoveMatch, ctrl map[string]any) (DeletedObject, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return DeletedObject{}, err
	}
	return typedFrom[DeletedObject](res), nil
}



func (e *DeletedObjectEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
