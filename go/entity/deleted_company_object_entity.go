...
type DeletedCompanyObjectEntity struct {
	name    string
...
func NewDeletedCompanyObjectEntity(client *core.IntercomSDK, entopts map[string]any) *DeletedCompanyObjectEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DeletedCompanyObjectEntity) GetName() string { return e.name }
...
func (e *DeletedCompanyObjectEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DeletedCompanyObjectEntity) Deleted() bool {
	return e.deleted
}


func (e *DeletedCompanyObjectEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDeletedCompanyObjectEntity(e.client, opts)
}

func (e *DeletedCompanyObjectEntity) Data(args ...any) any {
...
func (e *DeletedCompanyObjectEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DeletedCompanyObject; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DeletedCompanyObjectEntity) DataTyped(data ...DeletedCompanyObject) DeletedCompanyObject {
	if len(data) > 0 {
		return typedFrom[DeletedCompanyObject](e.Data(asMap(data[0])))
	}
	return typedFrom[DeletedCompanyObject](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DeletedCompanyObject (all fields
// optional at the wire level).
func (e *DeletedCompanyObjectEntity) MatchTyped(match ...DeletedCompanyObject) DeletedCompanyObject {
	if len(match) > 0 {
		return typedFrom[DeletedCompanyObject](e.Match(asMap(match[0])))
	}
	return typedFrom[DeletedCompanyObject](e.Match())
}
...
func (e *DeletedCompanyObjectEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DeletedCompanyObjectEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DeletedCompanyObjectEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DeletedCompanyObjectEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DeletedCompanyObjectEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *DeletedCompanyObjectEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DeletedCompanyObjectRemoveMatch and returns an DeletedCompanyObject. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *DeletedCompanyObjectEntity) RemoveTyped(reqmatch DeletedCompanyObjectRemoveMatch, ctrl map[string]any) (DeletedCompanyObject, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return DeletedCompanyObject{}, err
	}
	return typedFrom[DeletedCompanyObject](res), nil
}



func (e *DeletedCompanyObjectEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
