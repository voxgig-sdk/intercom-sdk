...
type ArticleVersionEntity struct {
	name    string
...
func NewArticleVersionEntity(client *core.IntercomSDK, entopts map[string]any) *ArticleVersionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArticleVersionEntity) GetName() string { return e.name }
...
func (e *ArticleVersionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ArticleVersionEntity) Deleted() bool {
	return e.deleted
}


func (e *ArticleVersionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewArticleVersionEntity(e.client, opts)
}

func (e *ArticleVersionEntity) Data(args ...any) any {
...
func (e *ArticleVersionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ArticleVersion; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ArticleVersionEntity) DataTyped(data ...ArticleVersion) ArticleVersion {
	if len(data) > 0 {
		return typedFrom[ArticleVersion](e.Data(asMap(data[0])))
	}
	return typedFrom[ArticleVersion](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ArticleVersion (all fields
// optional at the wire level).
func (e *ArticleVersionEntity) MatchTyped(match ...ArticleVersion) ArticleVersion {
	if len(match) > 0 {
		return typedFrom[ArticleVersion](e.Match(asMap(match[0])))
	}
	return typedFrom[ArticleVersion](e.Match())
}
...
func (e *ArticleVersionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ArticleVersionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ArticleVersionLoadMatch and returns an ArticleVersion. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ArticleVersionEntity) LoadTyped(reqmatch ArticleVersionLoadMatch, ctrl map[string]any) (ArticleVersion, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ArticleVersion{}, err
	}
	return typedFrom[ArticleVersion](res), nil
}



func (e *ArticleVersionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ArticleVersionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ArticleVersionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ArticleVersionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ArticleVersionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
