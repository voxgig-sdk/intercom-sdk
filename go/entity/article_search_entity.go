...
type ArticleSearchEntity struct {
	name    string
...
func NewArticleSearchEntity(client *core.IntercomSDK, entopts map[string]any) *ArticleSearchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArticleSearchEntity) GetName() string { return e.name }
...
func (e *ArticleSearchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ArticleSearchEntity) Deleted() bool {
	return e.deleted
}


func (e *ArticleSearchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewArticleSearchEntity(e.client, opts)
}

func (e *ArticleSearchEntity) Data(args ...any) any {
...
func (e *ArticleSearchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ArticleSearch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ArticleSearchEntity) DataTyped(data ...ArticleSearch) ArticleSearch {
	if len(data) > 0 {
		return typedFrom[ArticleSearch](e.Data(asMap(data[0])))
	}
	return typedFrom[ArticleSearch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ArticleSearch (all fields
// optional at the wire level).
func (e *ArticleSearchEntity) MatchTyped(match ...ArticleSearch) ArticleSearch {
	if len(match) > 0 {
		return typedFrom[ArticleSearch](e.Match(asMap(match[0])))
	}
	return typedFrom[ArticleSearch](e.Match())
}
...
func (e *ArticleSearchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ArticleSearchEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ArticleSearchLoadMatch and returns an ArticleSearch. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ArticleSearchEntity) LoadTyped(reqmatch ArticleSearchLoadMatch, ctrl map[string]any) (ArticleSearch, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ArticleSearch{}, err
	}
	return typedFrom[ArticleSearch](res), nil
}



func (e *ArticleSearchEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ArticleSearchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ArticleSearchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ArticleSearchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ArticleSearchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
