...
func NewMacroEntity(client *core.IntercomSDK, entopts map[string]any) *MacroEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MacroEntity) GetName() string { return e.name }
...
func (e *MacroEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MacroEntity) Deleted() bool {
	return e.deleted
}


func (e *MacroEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMacroEntity(e.client, opts)
}

func (e *MacroEntity) Data(args ...any) any {
...
func (e *MacroEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Macro; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MacroEntity) DataTyped(data ...Macro) Macro {
	if len(data) > 0 {
		return typedFrom[Macro](e.Data(asMap(data[0])))
	}
	return typedFrom[Macro](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Macro (all fields
// optional at the wire level).
func (e *MacroEntity) MatchTyped(match ...Macro) Macro {
	if len(match) > 0 {
		return typedFrom[Macro](e.Match(asMap(match[0])))
	}
	return typedFrom[Macro](e.Match())
}
...
func (e *MacroEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MacroEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MacroLoadMatch and returns an Macro. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MacroEntity) LoadTyped(reqmatch MacroLoadMatch, ctrl map[string]any) (Macro, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Macro{}, err
	}
	return typedFrom[Macro](res), nil
}




func (e *MacroEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// MacroListMatch and returns []Macro. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MacroEntity) ListTyped(reqmatch MacroListMatch, ctrl map[string]any) ([]Macro, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Macro](res), nil
}



func (e *MacroEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MacroEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MacroEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MacroEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
