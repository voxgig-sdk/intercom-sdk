...
type ConversationListEntity struct {
	name    string
...
func NewConversationListEntity(client *core.IntercomSDK, entopts map[string]any) *ConversationListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ConversationListEntity) GetName() string { return e.name }
...
func (e *ConversationListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ConversationListEntity) Deleted() bool {
	return e.deleted
}


func (e *ConversationListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewConversationListEntity(e.client, opts)
}

func (e *ConversationListEntity) Data(args ...any) any {
...
func (e *ConversationListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ConversationList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ConversationListEntity) DataTyped(data ...ConversationList) ConversationList {
	if len(data) > 0 {
		return typedFrom[ConversationList](e.Data(asMap(data[0])))
	}
	return typedFrom[ConversationList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ConversationList (all fields
// optional at the wire level).
func (e *ConversationListEntity) MatchTyped(match ...ConversationList) ConversationList {
	if len(match) > 0 {
		return typedFrom[ConversationList](e.Match(asMap(match[0])))
	}
	return typedFrom[ConversationList](e.Match())
}
...
func (e *ConversationListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ConversationListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ConversationListEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ConversationListEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ConversationListCreateData and returns an ConversationList. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ConversationListEntity) CreateTyped(reqdata ConversationListCreateData, ctrl map[string]any) (ConversationList, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return ConversationList{}, err
	}
	return typedFrom[ConversationList](res), nil
}



func (e *ConversationListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ConversationListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ConversationListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
