...
type MergeHistoryEntity struct {
	name    string
...
func NewMergeHistoryEntity(client *core.IntercomSDK, entopts map[string]any) *MergeHistoryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MergeHistoryEntity) GetName() string { return e.name }
...
func (e *MergeHistoryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MergeHistoryEntity) Deleted() bool {
	return e.deleted
}


func (e *MergeHistoryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMergeHistoryEntity(e.client, opts)
}

func (e *MergeHistoryEntity) Data(args ...any) any {
...
func (e *MergeHistoryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MergeHistory; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MergeHistoryEntity) DataTyped(data ...MergeHistory) MergeHistory {
	if len(data) > 0 {
		return typedFrom[MergeHistory](e.Data(asMap(data[0])))
	}
	return typedFrom[MergeHistory](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MergeHistory (all fields
// optional at the wire level).
func (e *MergeHistoryEntity) MatchTyped(match ...MergeHistory) MergeHistory {
	if len(match) > 0 {
		return typedFrom[MergeHistory](e.Match(asMap(match[0])))
	}
	return typedFrom[MergeHistory](e.Match())
}
...
func (e *MergeHistoryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MergeHistoryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *MergeHistoryEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MergeHistoryListMatch and returns []MergeHistory. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MergeHistoryEntity) ListTyped(reqmatch MergeHistoryListMatch, ctrl map[string]any) ([]MergeHistory, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[MergeHistory](res), nil
}



func (e *MergeHistoryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MergeHistoryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MergeHistoryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MergeHistoryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
