...
func NewDataExportEntity(client *core.IntercomSDK, entopts map[string]any) *DataExportEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DataExportEntity) GetName() string { return e.name }
...
func (e *DataExportEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DataExportEntity) Deleted() bool {
	return e.deleted
}


func (e *DataExportEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDataExportEntity(e.client, opts)
}

func (e *DataExportEntity) Data(args ...any) any {
...
func (e *DataExportEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DataExport; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DataExportEntity) DataTyped(data ...DataExport) DataExport {
	if len(data) > 0 {
		return typedFrom[DataExport](e.Data(asMap(data[0])))
	}
	return typedFrom[DataExport](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DataExport (all fields
// optional at the wire level).
func (e *DataExportEntity) MatchTyped(match ...DataExport) DataExport {
	if len(match) > 0 {
		return typedFrom[DataExport](e.Match(asMap(match[0])))
	}
	return typedFrom[DataExport](e.Match())
}
...
func (e *DataExportEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DataExportEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *DataExportEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DataExportEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DataExportCreateData and returns an DataExport. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DataExportEntity) CreateTyped(reqdata DataExportCreateData, ctrl map[string]any) (DataExport, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return DataExport{}, err
	}
	return typedFrom[DataExport](res), nil
}



func (e *DataExportEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DataExportEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DataExportEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
