...
func NewIpAllowlistEntity(client *core.IntercomSDK, entopts map[string]any) *IpAllowlistEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IpAllowlistEntity) GetName() string { return e.name }
...
func (e *IpAllowlistEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IpAllowlistEntity) Deleted() bool {
	return e.deleted
}


func (e *IpAllowlistEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIpAllowlistEntity(e.client, opts)
}

func (e *IpAllowlistEntity) Data(args ...any) any {
...
func (e *IpAllowlistEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IpAllowlist; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IpAllowlistEntity) DataTyped(data ...IpAllowlist) IpAllowlist {
	if len(data) > 0 {
		return typedFrom[IpAllowlist](e.Data(asMap(data[0])))
	}
	return typedFrom[IpAllowlist](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IpAllowlist (all fields
// optional at the wire level).
func (e *IpAllowlistEntity) MatchTyped(match ...IpAllowlist) IpAllowlist {
	if len(match) > 0 {
		return typedFrom[IpAllowlist](e.Match(asMap(match[0])))
	}
	return typedFrom[IpAllowlist](e.Match())
}
...
func (e *IpAllowlistEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IpAllowlistEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *IpAllowlistEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IpAllowlistListMatch and returns []IpAllowlist. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *IpAllowlistEntity) ListTyped(reqmatch IpAllowlistListMatch, ctrl map[string]any) ([]IpAllowlist, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[IpAllowlist](res), nil
}



func (e *IpAllowlistEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *IpAllowlistEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// IpAllowlistUpdateData and returns an IpAllowlist. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *IpAllowlistEntity) UpdateTyped(reqdata IpAllowlistUpdateData, ctrl map[string]any) (IpAllowlist, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return IpAllowlist{}, err
	}
	return typedFrom[IpAllowlist](res), nil
}



func (e *IpAllowlistEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IpAllowlistEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
