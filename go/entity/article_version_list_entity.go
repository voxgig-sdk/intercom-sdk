...
type ArticleVersionListEntity struct {
	name    string
...
func NewArticleVersionListEntity(client *core.IntercomSDK, entopts map[string]any) *ArticleVersionListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArticleVersionListEntity) GetName() string { return e.name }
...
func (e *ArticleVersionListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ArticleVersionListEntity) Deleted() bool {
	return e.deleted
}


func (e *ArticleVersionListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewArticleVersionListEntity(e.client, opts)
}

func (e *ArticleVersionListEntity) Data(args ...any) any {
...
func (e *ArticleVersionListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ArticleVersionList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ArticleVersionListEntity) DataTyped(data ...ArticleVersionList) ArticleVersionList {
	if len(data) > 0 {
		return typedFrom[ArticleVersionList](e.Data(asMap(data[0])))
	}
	return typedFrom[ArticleVersionList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ArticleVersionList (all fields
// optional at the wire level).
func (e *ArticleVersionListEntity) MatchTyped(match ...ArticleVersionList) ArticleVersionList {
	if len(match) > 0 {
		return typedFrom[ArticleVersionList](e.Match(asMap(match[0])))
	}
	return typedFrom[ArticleVersionList](e.Match())
}
...
func (e *ArticleVersionListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ArticleVersionListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ArticleVersionListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ArticleVersionListListMatch and returns []ArticleVersionList. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ArticleVersionListEntity) ListTyped(reqmatch ArticleVersionListListMatch, ctrl map[string]any) ([]ArticleVersionList, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ArticleVersionList](res), nil
}



func (e *ArticleVersionListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ArticleVersionListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ArticleVersionListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ArticleVersionListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
