...
type AwayStatusReasonEntity struct {
	name    string
...
func NewAwayStatusReasonEntity(client *core.IntercomSDK, entopts map[string]any) *AwayStatusReasonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AwayStatusReasonEntity) GetName() string { return e.name }
...
func (e *AwayStatusReasonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AwayStatusReasonEntity) Deleted() bool {
	return e.deleted
}


func (e *AwayStatusReasonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAwayStatusReasonEntity(e.client, opts)
}

func (e *AwayStatusReasonEntity) Data(args ...any) any {
...
func (e *AwayStatusReasonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AwayStatusReason; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AwayStatusReasonEntity) DataTyped(data ...AwayStatusReason) AwayStatusReason {
	if len(data) > 0 {
		return typedFrom[AwayStatusReason](e.Data(asMap(data[0])))
	}
	return typedFrom[AwayStatusReason](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AwayStatusReason (all fields
// optional at the wire level).
func (e *AwayStatusReasonEntity) MatchTyped(match ...AwayStatusReason) AwayStatusReason {
	if len(match) > 0 {
		return typedFrom[AwayStatusReason](e.Match(asMap(match[0])))
	}
	return typedFrom[AwayStatusReason](e.Match())
}
...
func (e *AwayStatusReasonEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AwayStatusReasonEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AwayStatusReasonEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AwayStatusReasonListMatch and returns []AwayStatusReason. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AwayStatusReasonEntity) ListTyped(reqmatch AwayStatusReasonListMatch, ctrl map[string]any) ([]AwayStatusReason, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AwayStatusReason](res), nil
}



func (e *AwayStatusReasonEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AwayStatusReasonEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AwayStatusReasonEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AwayStatusReasonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
