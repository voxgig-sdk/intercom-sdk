...
func NewSubscriptionEntity(client *core.IntercomSDK, entopts map[string]any) *SubscriptionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SubscriptionEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
