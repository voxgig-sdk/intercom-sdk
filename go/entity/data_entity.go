...
func NewDataEntity(client *core.IntercomSDK, entopts map[string]any) *DataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DataEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DataLoadMatch and returns an Data. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DataEntity) LoadTyped(reqmatch DataLoadMatch, ctrl map[string]any) (Data, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Data{}, err
	}
	return typedFrom[Data](res), nil
}



func (e *DataEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DataEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// DataCreateData and returns an Data. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DataEntity) CreateTyped(reqdata DataCreateData, ctrl map[string]any) (Data, error) {
