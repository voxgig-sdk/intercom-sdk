...
type HandlingEventEntity struct {
	name    string
...
func NewHandlingEventEntity(client *core.IntercomSDK, entopts map[string]any) *HandlingEventEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HandlingEventEntity) GetName() string { return e.name }
...
func (e *HandlingEventEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HandlingEventEntity) Deleted() bool {
	return e.deleted
}


func (e *HandlingEventEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHandlingEventEntity(e.client, opts)
}

func (e *HandlingEventEntity) Data(args ...any) any {
...
func (e *HandlingEventEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an HandlingEvent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HandlingEventEntity) DataTyped(data ...HandlingEvent) HandlingEvent {
	if len(data) > 0 {
		return typedFrom[HandlingEvent](e.Data(asMap(data[0])))
	}
	return typedFrom[HandlingEvent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through HandlingEvent (all fields
// optional at the wire level).
func (e *HandlingEventEntity) MatchTyped(match ...HandlingEvent) HandlingEvent {
	if len(match) > 0 {
		return typedFrom[HandlingEvent](e.Match(asMap(match[0])))
	}
	return typedFrom[HandlingEvent](e.Match())
}
...
func (e *HandlingEventEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HandlingEventEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *HandlingEventEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HandlingEventListMatch and returns []HandlingEvent. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *HandlingEventEntity) ListTyped(reqmatch HandlingEventListMatch, ctrl map[string]any) ([]HandlingEvent, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[HandlingEvent](res), nil
}



func (e *HandlingEventEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HandlingEventEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HandlingEventEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HandlingEventEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
