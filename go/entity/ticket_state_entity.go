...
func NewTicketStateEntity(client *core.IntercomSDK, entopts map[string]any) *TicketStateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TicketStateEntity) GetName() string { return e.name }
...
func (e *TicketStateEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TicketStateEntity) Deleted() bool {
	return e.deleted
}


func (e *TicketStateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTicketStateEntity(e.client, opts)
}

func (e *TicketStateEntity) Data(args ...any) any {
...
func (e *TicketStateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TicketState; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TicketStateEntity) DataTyped(data ...TicketState) TicketState {
	if len(data) > 0 {
		return typedFrom[TicketState](e.Data(asMap(data[0])))
	}
	return typedFrom[TicketState](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TicketState (all fields
// optional at the wire level).
func (e *TicketStateEntity) MatchTyped(match ...TicketState) TicketState {
	if len(match) > 0 {
		return typedFrom[TicketState](e.Match(asMap(match[0])))
	}
	return typedFrom[TicketState](e.Match())
}
...
func (e *TicketStateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TicketStateEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TicketStateEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TicketStateListMatch and returns []TicketState. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TicketStateEntity) ListTyped(reqmatch TicketStateListMatch, ctrl map[string]any) ([]TicketState, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TicketState](res), nil
}



func (e *TicketStateEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TicketStateEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TicketStateEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TicketStateEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
