...
func NewNewsfeedEntity(client *core.IntercomSDK, entopts map[string]any) *NewsfeedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NewsfeedEntity) GetName() string { return e.name }
...
func (e *NewsfeedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NewsfeedEntity) Deleted() bool {
	return e.deleted
}


func (e *NewsfeedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNewsfeedEntity(e.client, opts)
}

func (e *NewsfeedEntity) Data(args ...any) any {
...
func (e *NewsfeedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Newsfeed; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NewsfeedEntity) DataTyped(data ...Newsfeed) Newsfeed {
	if len(data) > 0 {
		return typedFrom[Newsfeed](e.Data(asMap(data[0])))
	}
	return typedFrom[Newsfeed](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Newsfeed (all fields
// optional at the wire level).
func (e *NewsfeedEntity) MatchTyped(match ...Newsfeed) Newsfeed {
	if len(match) > 0 {
		return typedFrom[Newsfeed](e.Match(asMap(match[0])))
	}
	return typedFrom[Newsfeed](e.Match())
}
...
func (e *NewsfeedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NewsfeedEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NewsfeedLoadMatch and returns an Newsfeed. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NewsfeedEntity) LoadTyped(reqmatch NewsfeedLoadMatch, ctrl map[string]any) (Newsfeed, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Newsfeed{}, err
	}
	return typedFrom[Newsfeed](res), nil
}



func (e *NewsfeedEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NewsfeedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NewsfeedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NewsfeedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NewsfeedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
