...
func NewBannerEntity(client *core.IntercomSDK, entopts map[string]any) *BannerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BannerEntity) GetName() string { return e.name }
...
func (e *BannerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BannerEntity) Deleted() bool {
	return e.deleted
}


func (e *BannerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBannerEntity(e.client, opts)
}

func (e *BannerEntity) Data(args ...any) any {
...
func (e *BannerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Banner; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BannerEntity) DataTyped(data ...Banner) Banner {
	if len(data) > 0 {
		return typedFrom[Banner](e.Data(asMap(data[0])))
	}
	return typedFrom[Banner](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Banner (all fields
// optional at the wire level).
func (e *BannerEntity) MatchTyped(match ...Banner) Banner {
	if len(match) > 0 {
		return typedFrom[Banner](e.Match(asMap(match[0])))
	}
	return typedFrom[Banner](e.Match())
}
...
func (e *BannerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BannerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *BannerEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BannerListMatch and returns []Banner. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BannerEntity) ListTyped(reqmatch BannerListMatch, ctrl map[string]any) ([]Banner, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Banner](res), nil
}



func (e *BannerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BannerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BannerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BannerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
