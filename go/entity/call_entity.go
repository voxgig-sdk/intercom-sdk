...
func NewCallEntity(client *core.IntercomSDK, entopts map[string]any) *CallEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CallEntity) GetName() string { return e.name }
...
func (e *CallEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CallEntity) Deleted() bool {
	return e.deleted
}


func (e *CallEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCallEntity(e.client, opts)
}

func (e *CallEntity) Data(args ...any) any {
...
func (e *CallEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Call; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CallEntity) DataTyped(data ...Call) Call {
	if len(data) > 0 {
		return typedFrom[Call](e.Data(asMap(data[0])))
	}
	return typedFrom[Call](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Call (all fields
// optional at the wire level).
func (e *CallEntity) MatchTyped(match ...Call) Call {
	if len(match) > 0 {
		return typedFrom[Call](e.Match(asMap(match[0])))
	}
	return typedFrom[Call](e.Match())
}
...
func (e *CallEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CallEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CallLoadMatch and returns an Call. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CallEntity) LoadTyped(reqmatch CallLoadMatch, ctrl map[string]any) (Call, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Call{}, err
	}
	return typedFrom[Call](res), nil
}




func (e *CallEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CallListMatch and returns []Call. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CallEntity) ListTyped(reqmatch CallListMatch, ctrl map[string]any) ([]Call, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Call](res), nil
}




func (e *CallEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CallCreateData and returns an Call. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CallEntity) CreateTyped(reqdata CallCreateData, ctrl map[string]any) (Call, error) {
...
func (e *CallEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CallEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CallEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
