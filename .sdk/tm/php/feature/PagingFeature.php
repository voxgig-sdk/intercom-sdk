...
class IntercomPagingFeature extends IntercomBaseFeature
{
    ...
    private function _graphql_pre_request(IntercomContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(IntercomContext $ctx): bool
    {
