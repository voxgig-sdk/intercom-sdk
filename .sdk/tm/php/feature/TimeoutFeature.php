...
class IntercomTimeoutFeature extends IntercomBaseFeature
{
    ...
    private function _with_timeout(IntercomContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(IntercomContext $_ctx, float $ms): void
    {
        $client = $this->client;
