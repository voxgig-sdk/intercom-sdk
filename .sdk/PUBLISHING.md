...
|---|---|---|
| `js/` | @voxgig-sdk/intercom-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/intercom | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/intercom-js \
      --repository voxgig-sdk/intercom-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/intercom-js` shows it, and
`npm trust revoke @voxgig-sdk/intercom-js --id=<id>` removes it.
