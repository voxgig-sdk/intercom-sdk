...
class ContactListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ContactListEntity(self._client, opts)
    ...
    def match_get(self) -> ContactList:
    ...
    def create(self, reqdata: ContactListCreateData, ctrl=None) -> ContactList:
        utility = self._utility
