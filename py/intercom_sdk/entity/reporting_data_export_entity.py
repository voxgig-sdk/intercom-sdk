...
class ReportingDataExportEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ReportingDataExportEntity(self._client, opts)
    ...
    def data_get(self) -> ReportingDataExport:
    ...
    def match_get(self) -> ReportingDataExport:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ReportingDataExport]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ReportingDataExport().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ReportingDataExportCreateData, ctrl=None) -> ReportingDataExport:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
