...
class DataExportEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DataExportEntity(self._client, opts)
    ...
    def create(self, reqdata: DataExportCreateData, ctrl=None) -> DataExport:
        utility = self._utility
