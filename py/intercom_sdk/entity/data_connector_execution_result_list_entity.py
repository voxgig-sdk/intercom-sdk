...
class DataConnectorExecutionResultListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DataConnectorExecutionResultListEntity(self._client, opts)
    ...
    def data_get(self) -> DataConnectorExecutionResultList:
    ...
    def match_get(self) -> DataConnectorExecutionResultList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[DataConnectorExecutionResultList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.DataConnectorExecutionResultList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
