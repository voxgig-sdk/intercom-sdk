...
class WhatsappMessageStatusListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WhatsappMessageStatusListEntity(self._client, opts)
    ...
    def data_get(self) -> WhatsappMessageStatusList:
    ...
    def match_get(self) -> WhatsappMessageStatusList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[WhatsappMessageStatusList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.WhatsappMessageStatusList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
