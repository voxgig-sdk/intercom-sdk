...
class ContactSegmentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ContactSegmentEntity(self._client, opts)
    ...
    def data_get(self) -> ContactSegment:
    ...
    def match_get(self) -> ContactSegment:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ContactSegment]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ContactSegment().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
