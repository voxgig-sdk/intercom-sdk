...
class DataEventEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DataEventEntity(self._client, opts)
    ...
    def create(self, reqdata: DataEventCreateData, ctrl=None) -> DataEvent:
        utility = self._utility
