...
class AdminWithAppEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AdminWithAppEntity(self._client, opts)
    ...
    def data_get(self) -> AdminWithApp:
    ...
    def match_get(self) -> AdminWithApp:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AdminWithApp]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AdminWithApp().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
