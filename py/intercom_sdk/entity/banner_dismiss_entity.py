...
class BannerDismissEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BannerDismissEntity(self._client, opts)
    ...
    def data_get(self) -> BannerDismiss:
    ...
    def match_get(self) -> BannerDismiss:
    ...
    def create(self, reqdata: BannerDismissCreateData, ctrl=None) -> BannerDismiss:
        utility = self._utility
