...
class CompanyAttachedContactEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CompanyAttachedContactEntity(self._client, opts)
    ...
    def data_get(self) -> CompanyAttachedContact:
    ...
    def match_get(self) -> CompanyAttachedContact:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CompanyAttachedContact]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CompanyAttachedContact().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
