...
class HandlingEventEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return HandlingEventEntity(self._client, opts)
    ...
    def data_get(self) -> HandlingEvent:
    ...
    def match_get(self) -> HandlingEvent:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[HandlingEvent]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.HandlingEvent().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
