...
class TicketListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TicketListEntity(self._client, opts)
    ...
    def create(self, reqdata: TicketListCreateData, ctrl=None) -> TicketList:
        utility = self._utility
