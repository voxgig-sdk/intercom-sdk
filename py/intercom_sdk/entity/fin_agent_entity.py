...
class FinAgentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FinAgentEntity(self._client, opts)
    ...
    def create(self, reqdata: FinAgentCreateData, ctrl=None) -> FinAgent:
        utility = self._utility
