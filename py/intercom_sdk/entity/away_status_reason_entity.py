...
class AwayStatusReasonEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AwayStatusReasonEntity(self._client, opts)
    ...
    def data_get(self) -> AwayStatusReason:
    ...
    def match_get(self) -> AwayStatusReason:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AwayStatusReason]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AwayStatusReason().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
