...
class DataAttributeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DataAttributeEntity(self._client, opts)
    ...
    def data_get(self) -> DataAttribute:
    ...
    def match_get(self) -> DataAttribute:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[DataAttribute]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.DataAttribute().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: DataAttributeCreateData, ctrl=None) -> DataAttribute:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: DataAttributeUpdateData, ctrl=None) -> DataAttribute:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
