...
class ContentSearchEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ContentSearchEntity(self._client, opts)
    ...
    def data_get(self) -> ContentSearch:
    ...
    def match_get(self) -> ContentSearch:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ContentSearch]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ContentSearch().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
