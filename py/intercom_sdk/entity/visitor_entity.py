...
class VisitorEntity:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Visitor:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Visitor().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: VisitorUpdateData, ctrl=None) -> Visitor:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
