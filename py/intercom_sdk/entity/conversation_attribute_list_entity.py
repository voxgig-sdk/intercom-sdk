...
class ConversationAttributeListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationAttributeListEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationAttributeList:
    ...
    def match_get(self) -> ConversationAttributeList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConversationAttributeList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConversationAttributeList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
