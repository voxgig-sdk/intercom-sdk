...
class ActivityLogEventTypeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActivityLogEventTypeEntity(self._client, opts)
    ...
    def data_get(self) -> ActivityLogEventType:
    ...
    def match_get(self) -> ActivityLogEventType:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ActivityLogEventType]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ActivityLogEventType().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
