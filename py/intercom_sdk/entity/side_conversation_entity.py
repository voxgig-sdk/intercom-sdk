...
class SideConversationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SideConversationEntity(self._client, opts)
    ...
    def data_get(self) -> SideConversation:
    ...
    def match_get(self) -> SideConversation:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SideConversation]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SideConversation().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
