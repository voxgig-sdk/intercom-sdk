...
class MergeHistoryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MergeHistoryEntity(self._client, opts)
    ...
    def data_get(self) -> MergeHistory:
    ...
    def match_get(self) -> MergeHistory:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MergeHistory]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MergeHistory().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
