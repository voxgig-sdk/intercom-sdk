...
class ConversationListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationListEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationList:
    ...
    def match_get(self) -> ConversationList:
    ...
    def create(self, reqdata: ConversationListCreateData, ctrl=None) -> ConversationList:
        utility = self._utility
