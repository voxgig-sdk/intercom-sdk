...
class ArticleVersionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ArticleVersionEntity(self._client, opts)
    ...
    def data_get(self) -> ArticleVersion:
    ...
    def match_get(self) -> ArticleVersion:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ArticleVersion:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ArticleVersion().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
