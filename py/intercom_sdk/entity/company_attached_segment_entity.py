...
class CompanyAttachedSegmentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CompanyAttachedSegmentEntity(self._client, opts)
    ...
    def data_get(self) -> CompanyAttachedSegment:
    ...
    def match_get(self) -> CompanyAttachedSegment:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CompanyAttachedSegment]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CompanyAttachedSegment().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
