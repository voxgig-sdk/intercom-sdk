...
class TicketReplyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TicketReplyEntity(self._client, opts)
    ...
    def match_get(self) -> TicketReply:
    ...
    def create(self, reqdata: TicketReplyCreateData, ctrl=None) -> TicketReply:
        utility = self._utility
