...
class ActivityLogListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ActivityLogListEntity(self._client, opts)
    ...
    def data_get(self) -> ActivityLogList:
    ...
    def match_get(self) -> ActivityLogList:
    ...
    def create(self, reqdata: ActivityLogListCreateData, ctrl=None) -> ActivityLogList:
        utility = self._utility
