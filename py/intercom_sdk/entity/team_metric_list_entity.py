...
class TeamMetricListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TeamMetricListEntity(self._client, opts)
    ...
    def data_get(self) -> TeamMetricList:
    ...
    def match_get(self) -> TeamMetricList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TeamMetricList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TeamMetricList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
