...
class OfficeHoursScheduleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OfficeHoursScheduleEntity(self._client, opts)
    ...
    def data_get(self) -> OfficeHoursSchedule:
    ...
    def match_get(self) -> OfficeHoursSchedule:
    ...
    def load(self, reqmatch=None, ctrl=None) -> OfficeHoursSchedule:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.OfficeHoursSchedule().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: OfficeHoursScheduleUpdateData, ctrl=None) -> OfficeHoursSchedule:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
