...
class TicketTypeAttributeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TicketTypeAttributeEntity(self._client, opts)
    ...
    def data_get(self) -> TicketTypeAttribute:
    ...
    def match_get(self) -> TicketTypeAttribute:
    ...
    def create(self, reqdata: TicketTypeAttributeCreateData, ctrl=None) -> TicketTypeAttribute:
        utility = self._utility
    ...
    def update(self, reqdata: TicketTypeAttributeUpdateData, ctrl=None) -> TicketTypeAttribute:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
