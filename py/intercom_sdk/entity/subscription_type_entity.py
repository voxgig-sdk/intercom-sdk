...
class SubscriptionTypeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SubscriptionTypeEntity(self._client, opts)
    ...
    def data_get(self) -> SubscriptionType:
    ...
    def match_get(self) -> SubscriptionType:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[SubscriptionType]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.SubscriptionType().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
