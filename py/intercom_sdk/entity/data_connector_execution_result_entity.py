...
class DataConnectorExecutionResultEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DataConnectorExecutionResultEntity(self._client, opts)
    ...
    def data_get(self) -> DataConnectorExecutionResult:
    ...
    def match_get(self) -> DataConnectorExecutionResult:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DataConnectorExecutionResult:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DataConnectorExecutionResult().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
