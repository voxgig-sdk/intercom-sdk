...
class CompanyListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CompanyListEntity(self._client, opts)
    ...
    def match_get(self) -> CompanyList:
    ...
    def create(self, reqdata: CompanyListCreateData, ctrl=None) -> CompanyList:
        utility = self._utility
