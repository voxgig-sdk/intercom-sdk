...
class WhatsappMessageStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WhatsappMessageStatusEntity(self._client, opts)
    ...
    def data_get(self) -> WhatsappMessageStatus:
    ...
    def match_get(self) -> WhatsappMessageStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> WhatsappMessageStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.WhatsappMessageStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
