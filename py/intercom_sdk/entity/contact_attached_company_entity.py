...
class ContactAttachedCompanyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ContactAttachedCompanyEntity(self._client, opts)
    ...
    def data_get(self) -> ContactAttachedCompany:
    ...
    def match_get(self) -> ContactAttachedCompany:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ContactAttachedCompany]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ContactAttachedCompany().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
