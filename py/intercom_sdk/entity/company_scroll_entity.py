...
class CompanyScrollEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CompanyScrollEntity(self._client, opts)
    ...
    def data_get(self) -> CompanyScroll:
    ...
    def match_get(self) -> CompanyScroll:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CompanyScroll]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CompanyScroll().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
