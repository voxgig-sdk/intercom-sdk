...
class PhoneSwitchEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PhoneSwitchEntity(self._client, opts)
    ...
    def match_get(self) -> PhoneSwitch:
    ...
    def create(self, reqdata: PhoneSwitchCreateData, ctrl=None) -> PhoneSwitch:
        utility = self._utility
