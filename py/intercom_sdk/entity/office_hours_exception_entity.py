...
from intercom_sdk.intercom_types import (
    ...
    OfficeHoursExceptionLoadMatch,
    OfficeHoursExceptionListMatch,
    OfficeHoursExceptionCreateData,
    OfficeHoursExceptionUpdateData,
)
...
class OfficeHoursExceptionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OfficeHoursExceptionEntity(self._client, opts)
    ...
    def data_get(self) -> OfficeHoursException:
    ...
    def match_get(self) -> OfficeHoursException:
    ...
    def load(self, reqmatch=None, ctrl=None) -> OfficeHoursException:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.OfficeHoursException().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[OfficeHoursException]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.OfficeHoursException().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: OfficeHoursExceptionCreateData, ctrl=None) -> OfficeHoursException:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: OfficeHoursExceptionUpdateData, ctrl=None) -> OfficeHoursException:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
