...
class ContentImportSourceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ContentImportSourceEntity(self._client, opts)
    ...
    def data_get(self) -> ContentImportSource:
    ...
    def match_get(self) -> ContentImportSource:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ContentImportSource:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ContentImportSource().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ContentImportSource]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ContentImportSource().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: ContentImportSourceCreateData, ctrl=None) -> ContentImportSource:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ContentImportSourceUpdateData, ctrl=None) -> ContentImportSource:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
