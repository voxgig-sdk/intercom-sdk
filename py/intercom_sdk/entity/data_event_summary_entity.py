...
class DataEventSummaryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DataEventSummaryEntity(self._client, opts)
    ...
    def data_get(self) -> DataEventSummary:
    ...
    def match_get(self) -> DataEventSummary:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[DataEventSummary]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.DataEventSummary().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
