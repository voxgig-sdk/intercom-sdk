...
class InternalArticleSearchEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return InternalArticleSearchEntity(self._client, opts)
    ...
    def data_get(self) -> InternalArticleSearch:
    ...
    def match_get(self) -> InternalArticleSearch:
    ...
    def load(self, reqmatch=None, ctrl=None) -> InternalArticleSearch:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.InternalArticleSearch().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
