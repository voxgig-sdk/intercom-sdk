...
class ArticleSearchEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ArticleSearchEntity(self._client, opts)
    ...
    def data_get(self) -> ArticleSearch:
    ...
    def match_get(self) -> ArticleSearch:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ArticleSearch:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ArticleSearch().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
