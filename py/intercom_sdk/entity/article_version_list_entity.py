...
class ArticleVersionListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ArticleVersionListEntity(self._client, opts)
    ...
    def data_get(self) -> ArticleVersionList:
    ...
    def match_get(self) -> ArticleVersionList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ArticleVersionList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ArticleVersionList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
