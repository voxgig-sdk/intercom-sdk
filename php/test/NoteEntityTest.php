...
class NoteEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set INTERCOM_TEST_NOTE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function note_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["note01", "note02", "note03", "company01", "company02", "company03", "contact01", "contact02", "contact03"] as $k) {
    ...
    $entid_env_raw = getenv("INTERCOM_TEST_NOTE_ENTID");
