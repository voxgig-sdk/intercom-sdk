...
class ReadmeExamplesTest extends TestCase
{
    ...
    private const ENTITIES = [
        ...
        "ActivityLogEventType" => "activity_log_event_type",
        ...
        "ArticleVersionList" => "article_version_list",
        "Audience" => "audience",
        "AwayStatusReason" => "away_status_reason",
        "Banner" => "banner",
        "BannerDismiss" => "banner_dismiss",
        "Brand" => "brand",
        "Call" => "call",
        "Company" => "company",
        "CompanyAttachedContact" => "company_attached_contact",
        "CompanyAttachedSegment" => "company_attached_segment",
        "CompanyList" => "company_list",
        "CompanyScroll" => "company_scroll",
        "Contact" => "contact",
        "ContactAttachedCompany" => "contact_attached_company",
        ...
        "ConversationAttributeList" => "conversation_attribute_list",
        "ConversationList" => "conversation_list",
        "ConversationParticipant" => "conversation_participant",
        "CustomObjectInstance" => "custom_object_instance",
        "Data" => "data",
        "DataAttribute" => "data_attribute",
        "DataConnector" => "data_connector",
        "DataConnectorExecutionResult" => "data_connector_execution_result",
        "DataConnectorExecutionResultList" => "data_connector_execution_result_list",
        ...
        "DeletedDataConnectorObject" => "deleted_data_connector_object",
        ...
        "InternalArticleSearch" => "internal_article_search",
        ...
        "OfficeHoursException" => "office_hours_exception",
        "OfficeHoursSchedule" => "office_hours_schedule",
        "Paginated" => "paginated",
        "PhoneSwitch" => "phone_switch",
        "ReportingData" => "reporting_data",
        "ReportingDataExport" => "reporting_data_export",
        "Segment" => "segment",
        ...
        "Tag" => "tag",
        "Team" => "team",
        "TeamMetricList" => "team_metric_list",
        "Ticket" => "ticket",
        ...
        "Visitor" => "visitor",
        "WhatsappMessageStatus" => "whatsapp_message_status",
