...
class CallEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set INTERCOM_TEST_CALL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function call_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("INTERCOM_TEST_CALL_ENTID");
