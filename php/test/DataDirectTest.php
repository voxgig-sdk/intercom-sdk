...
class DataDirectTest extends TestCase
{
    public function test_direct_load_data(): void
    {
        $setup = data_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-data", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
