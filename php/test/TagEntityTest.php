...
class TagEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set INTERCOM_TEST_TAG_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function tag_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["tag01", "tag02", "tag03", "article01", "article02", "article03", "contact01", "contact02", "contact03", "content_snippet01", "content_snippet02", "content_snippet03", "conversation01", "conversation02", "conversation03", "internal_article01", "internal_article02", "internal_article03", "ticket01", "ticket02", "ticket03"] as $k) {
    ...
    $entid_env_raw = getenv("INTERCOM_TEST_TAG_ENTID");
