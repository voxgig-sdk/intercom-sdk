...
class MessageEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set INTERCOM_TEST_MESSAGE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function message_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("INTERCOM_TEST_MESSAGE_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["INTERCOM_TEST_MESSAGE_ENTID"]);
