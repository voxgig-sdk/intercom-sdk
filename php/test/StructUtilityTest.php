...
// Intercom SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = IntercomOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(IntercomOmni::structfix($now, Struct::undef()))
                        !== json_encode(IntercomOmni::structfix($val, Struct::undef()))) {
