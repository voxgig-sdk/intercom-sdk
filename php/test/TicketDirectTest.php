...
class TicketDirectTest extends TestCase
{
    public function test_direct_load_ticket(): void
    {
        $setup = ticket_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-ticket", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
