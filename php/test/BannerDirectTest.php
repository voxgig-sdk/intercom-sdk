...
class BannerDirectTest extends TestCase
{
    public function test_direct_list_banner(): void
    {
        $setup = banner_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-banner", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function banner_direct_setup($mockres)
{
