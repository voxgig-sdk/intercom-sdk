...
// Intercom SDK ratelimit feature
...
class IntercomRatelimitFeature extends IntercomBaseFeature
{
    ...
    private function _acquire(IntercomContext $ctx): void
    {
    ...
    private function _track(IntercomContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
