...
class CompanyListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CompanyListEntity($this->_client, $opts);
    }

    /**
     * @param CompanyList|array $args CompanyList data (assoc-array) to store.
     */
    ...
    /**
     * @return CompanyList|array The current CompanyList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CompanyList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CompanyList fields).
     */
    ...
    /**
     * Create a new CompanyList.
     *
     * @param CompanyListCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CompanyListCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CompanyList|array The created CompanyList as an assoc-array at the
