...
class VisitorEntity
{
    ...
    /**
     * Load a single Visitor.
     *
     * @param VisitorLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed VisitorLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Visitor|array The loaded Visitor as an assoc-array at the
     ...
     *
     * @param VisitorUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed VisitorUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Visitor|array The updated Visitor as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
