...
class DeletedEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeletedEntity($this->_client, $opts);
    }

    /**
     * @param Deleted|array $args Deleted data (assoc-array) to store.
     */
    ...
    /**
     * @return Deleted|array The current Deleted data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Deleted fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Deleted fields).
     */
    ...
    /**
     * List Deleted items matching the given filter.
     *
     * @param DeletedListMatch|array|null $reqmatch Match filter (any subset
     *   of Deleted fields) as an assoc-array; DeletedListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Deleted[]|array A list of Deleted items as assoc-arrays at
