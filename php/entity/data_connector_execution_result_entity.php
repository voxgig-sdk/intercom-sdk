...
class DataConnectorExecutionResultEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "data_connector_execution_result";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DataConnectorExecutionResultEntity($this->_client, $opts);
    }

    /**
     * @param DataConnectorExecutionResult|array $args DataConnectorExecutionResult data (assoc-array) to store.
     */
    ...
    /**
     * @return DataConnectorExecutionResult|array The current DataConnectorExecutionResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DataConnectorExecutionResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DataConnectorExecutionResult fields).
     */
    ...
    /**
     * Load a single DataConnectorExecutionResult.
     *
     * @param DataConnectorExecutionResultLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DataConnectorExecutionResultLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DataConnectorExecutionResult|array The loaded DataConnectorExecutionResult as an assoc-array at the
