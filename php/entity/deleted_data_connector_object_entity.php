...
class DeletedDataConnectorObjectEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "deleted_data_connector_object";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DeletedDataConnectorObjectEntity($this->_client, $opts);
    }

    /**
     * @param DeletedDataConnectorObject|array $args DeletedDataConnectorObject data (assoc-array) to store.
     */
    ...
    /**
     * @return DeletedDataConnectorObject|array The current DeletedDataConnectorObject data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeletedDataConnectorObject fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeletedDataConnectorObject fields).
     */
    ...
    /**
     * Remove an DeletedDataConnectorObject matching the given criteria.
     *
     * @param DeletedDataConnectorObjectRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DeletedDataConnectorObjectRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeletedDataConnectorObject|array The removed DeletedDataConnectorObject as an assoc-array at the
