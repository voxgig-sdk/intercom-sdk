...
class WhatsappMessageStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "whatsapp_message_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new WhatsappMessageStatusEntity($this->_client, $opts);
    }

    /**
     * @param WhatsappMessageStatus|array $args WhatsappMessageStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return WhatsappMessageStatus|array The current WhatsappMessageStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WhatsappMessageStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WhatsappMessageStatus fields).
     */
    ...
    /**
     * Load a single WhatsappMessageStatus.
     *
     * @param WhatsappMessageStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WhatsappMessageStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WhatsappMessageStatus|array The loaded WhatsappMessageStatus as an assoc-array at the
