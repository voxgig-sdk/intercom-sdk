...
class DataEventEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DataEventEntity($this->_client, $opts);
    }

    /**
     * @param DataEvent|array $args DataEvent data (assoc-array) to store.
     */
    ...
    /**
     * @return DataEvent|array The current DataEvent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DataEvent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DataEvent fields).
     */
     ...
     *
     * @param DataEventCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DataEventCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DataEvent|array The created DataEvent as an assoc-array at the
