...
class TicketStateEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TicketStateEntity($this->_client, $opts);
    }

    /**
     * @param TicketState|array $args TicketState data (assoc-array) to store.
     */
    ...
    /**
     * @return TicketState|array The current TicketState data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TicketState fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TicketState fields).
     */
    ...
    /**
     * List TicketState items matching the given filter.
     *
     * @param TicketStateListMatch|array|null $reqmatch Match filter (any subset
     *   of TicketState fields) as an assoc-array; TicketStateListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TicketState[]|array A list of TicketState items as assoc-arrays at
