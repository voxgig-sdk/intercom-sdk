...
class CompanyAttachedContactEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "company_attached_contact";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CompanyAttachedContactEntity($this->_client, $opts);
    }

    /**
     * @param CompanyAttachedContact|array $args CompanyAttachedContact data (assoc-array) to store.
     */
    ...
    /**
     * @return CompanyAttachedContact|array The current CompanyAttachedContact data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CompanyAttachedContact fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CompanyAttachedContact fields).
     */
    ...
    /**
     * List CompanyAttachedContact items matching the given filter.
     *
     * @param CompanyAttachedContactListMatch|array|null $reqmatch Match filter (any subset
     *   of CompanyAttachedContact fields) as an assoc-array; CompanyAttachedContactListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CompanyAttachedContact[]|array A list of CompanyAttachedContact items as assoc-arrays at
