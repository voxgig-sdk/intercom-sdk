...
class TicketTypeAttributeEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "ticket_type_attribute";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new TicketTypeAttributeEntity($this->_client, $opts);
    }

    /**
     * @param TicketTypeAttribute|array $args TicketTypeAttribute data (assoc-array) to store.
     */
    ...
    /**
     * @return TicketTypeAttribute|array The current TicketTypeAttribute data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TicketTypeAttribute fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TicketTypeAttribute fields).
     */
    ...
    /**
     * Create a new TicketTypeAttribute.
     *
     * @param TicketTypeAttributeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TicketTypeAttributeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TicketTypeAttribute|array The created TicketTypeAttribute as an assoc-array at the
    ...
    /**
     * Update an existing TicketTypeAttribute.
     *
     * @param TicketTypeAttributeUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TicketTypeAttributeUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TicketTypeAttribute|array The updated TicketTypeAttribute as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
