...
class OfficeHoursScheduleEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "office_hours_schedule";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OfficeHoursScheduleEntity($this->_client, $opts);
    }

    /**
     * @param OfficeHoursSchedule|array $args OfficeHoursSchedule data (assoc-array) to store.
     */
    ...
    /**
     * @return OfficeHoursSchedule|array The current OfficeHoursSchedule data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OfficeHoursSchedule fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OfficeHoursSchedule fields).
     */
    ...
    /**
     * Load a single OfficeHoursSchedule.
     *
     * @param OfficeHoursScheduleLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OfficeHoursScheduleLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OfficeHoursSchedule|array The loaded OfficeHoursSchedule as an assoc-array at the
    ...
    /**
     * Update an existing OfficeHoursSchedule.
     *
     * @param OfficeHoursScheduleUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OfficeHoursScheduleUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OfficeHoursSchedule|array The updated OfficeHoursSchedule as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
