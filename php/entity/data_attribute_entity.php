...
// Intercom SDK DataAttribute entity
...
class DataAttributeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DataAttributeEntity($this->_client, $opts);
    }

    /**
     * @param DataAttribute|array $args DataAttribute data (assoc-array) to store.
     */
    ...
    /**
     * @return DataAttribute|array The current DataAttribute data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DataAttribute fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DataAttribute fields).
     */
    ...
    /**
     * List DataAttribute items matching the given filter.
     *
     * @param DataAttributeListMatch|array|null $reqmatch Match filter (any subset
     *   of DataAttribute fields) as an assoc-array; DataAttributeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DataAttribute[]|array A list of DataAttribute items as assoc-arrays at
     ...
     *
     * @param DataAttributeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DataAttributeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DataAttribute|array The created DataAttribute as an assoc-array at the
    ...
    /**
     * Update an existing DataAttribute.
     *
     * @param DataAttributeUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DataAttributeUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DataAttribute|array The updated DataAttribute as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
