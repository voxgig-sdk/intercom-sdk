...
// Intercom SDK HelpCenter entity
...
class HelpCenterEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HelpCenterEntity($this->_client, $opts);
    }

    /**
     * @param HelpCenter|array $args HelpCenter data (assoc-array) to store.
     */
    ...
    /**
     * @return HelpCenter|array The current HelpCenter data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of HelpCenter fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of HelpCenter fields).
     */
    ...
    /**
     * Load a single HelpCenter.
     *
     * @param HelpCenterLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed HelpCenterLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return HelpCenter|array The loaded HelpCenter as an assoc-array at the
    ...
    /**
     * List HelpCenter items matching the given filter.
     *
     * @param HelpCenterListMatch|array|null $reqmatch Match filter (any subset
     *   of HelpCenter fields) as an assoc-array; HelpCenterListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return HelpCenter[]|array A list of HelpCenter items as assoc-arrays at
     ...
     *
     * @param HelpCenterCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed HelpCenterCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return HelpCenter|array The created HelpCenter as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
     ...
     *
     * @param HelpCenterUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed HelpCenterUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return HelpCenter|array The updated HelpCenter as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an HelpCenter matching the given criteria.
     *
     * @param HelpCenterRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; HelpCenterRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return HelpCenter|array The removed HelpCenter as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
