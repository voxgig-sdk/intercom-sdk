...
class ArticleEntity
{
     ...
     *
     * @param ArticleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ArticleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Article|array The created Article as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
     ...
     *
     * @param ArticleUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ArticleUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Article|array The updated Article as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
