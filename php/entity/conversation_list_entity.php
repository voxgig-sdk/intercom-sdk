...
class ConversationListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ConversationListEntity($this->_client, $opts);
    }

    /**
     * @param ConversationList|array $args ConversationList data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationList|array The current ConversationList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationList fields).
     */
    ...
    /**
     * Create a new ConversationList.
     *
     * @param ConversationListCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConversationListCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationList|array The created ConversationList as an assoc-array at the
