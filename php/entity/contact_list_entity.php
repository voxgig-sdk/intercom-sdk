...
class ContactListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ContactListEntity($this->_client, $opts);
    }

    /**
     * @param ContactList|array $args ContactList data (assoc-array) to store.
     */
    ...
    /**
     * @return ContactList|array The current ContactList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ContactList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ContactList fields).
     */
     ...
     *
     * @param ContactListCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ContactListCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContactList|array The created ContactList as an assoc-array at the
