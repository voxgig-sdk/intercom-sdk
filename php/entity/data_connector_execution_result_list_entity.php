...
class DataConnectorExecutionResultListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "data_connector_execution_result_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DataConnectorExecutionResultListEntity($this->_client, $opts);
    }

    /**
     * @param DataConnectorExecutionResultList|array $args DataConnectorExecutionResultList data (assoc-array) to store.
     */
    ...
    /**
     * @return DataConnectorExecutionResultList|array The current DataConnectorExecutionResultList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DataConnectorExecutionResultList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DataConnectorExecutionResultList fields).
     */
    ...
    /**
     * List DataConnectorExecutionResultList items matching the given filter.
     *
     * @param DataConnectorExecutionResultListListMatch|array|null $reqmatch Match filter (any subset
     *   of DataConnectorExecutionResultList fields) as an assoc-array; DataConnectorExecutionResultListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DataConnectorExecutionResultList[]|array A list of DataConnectorExecutionResultList items as assoc-arrays at
