...
class ReportingDataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ReportingDataEntity($this->_client, $opts);
    }

    /**
     * @param ReportingData|array $args ReportingData data (assoc-array) to store.
     */
    ...
    /**
     * @return ReportingData|array The current ReportingData data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReportingData fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReportingData fields).
     */
    ...
    /**
     * Load a single ReportingData.
     *
     * @param ReportingDataLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ReportingDataLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReportingData|array The loaded ReportingData as an assoc-array at the
