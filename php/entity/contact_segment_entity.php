...
class ContactSegmentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ContactSegmentEntity($this->_client, $opts);
    }

    /**
     * @param ContactSegment|array $args ContactSegment data (assoc-array) to store.
     */
    ...
    /**
     * @return ContactSegment|array The current ContactSegment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ContactSegment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ContactSegment fields).
     */
    ...
    /**
     * List ContactSegment items matching the given filter.
     *
     * @param ContactSegmentListMatch|array|null $reqmatch Match filter (any subset
     *   of ContactSegment fields) as an assoc-array; ContactSegmentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContactSegment[]|array A list of ContactSegment items as assoc-arrays at
