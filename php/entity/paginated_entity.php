...
class PaginatedEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PaginatedEntity($this->_client, $opts);
    }

    /**
     * @param Paginated|array $args Paginated data (assoc-array) to store.
     */
    ...
    /**
     * @return Paginated|array The current Paginated data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Paginated fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Paginated fields).
     */
    ...
    /**
     * List Paginated items matching the given filter.
     *
     * @param PaginatedListMatch|array|null $reqmatch Match filter (any subset
     *   of Paginated fields) as an assoc-array; PaginatedListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Paginated[]|array A list of Paginated items as assoc-arrays at
