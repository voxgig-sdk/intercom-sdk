...
class MacroEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MacroEntity($this->_client, $opts);
    }

    /**
     * @param Macro|array $args Macro data (assoc-array) to store.
     */
    ...
    /**
     * @return Macro|array The current Macro data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Macro fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Macro fields).
     */
     ...
     * Load a single Macro.
     *
     * @param MacroLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MacroLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Macro|array The loaded Macro as an assoc-array at the
    ...
    /**
     * List Macro items matching the given filter.
     *
     * @param MacroListMatch|array|null $reqmatch Match filter (any subset
     *   of Macro fields) as an assoc-array; MacroListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Macro[]|array A list of Macro items as assoc-arrays at
