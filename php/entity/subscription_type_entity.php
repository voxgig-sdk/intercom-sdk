...
class SubscriptionTypeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionTypeEntity($this->_client, $opts);
    }

    /**
     * @param SubscriptionType|array $args SubscriptionType data (assoc-array) to store.
     */
    ...
    /**
     * @return SubscriptionType|array The current SubscriptionType data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SubscriptionType fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SubscriptionType fields).
     */
    ...
    /**
     * List SubscriptionType items matching the given filter.
     *
     * @param SubscriptionTypeListMatch|array|null $reqmatch Match filter (any subset
     *   of SubscriptionType fields) as an assoc-array; SubscriptionTypeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SubscriptionType[]|array A list of SubscriptionType items as assoc-arrays at
