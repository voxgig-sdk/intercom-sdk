...
class AwayStatusReasonEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AwayStatusReasonEntity($this->_client, $opts);
    }

    /**
     * @param AwayStatusReason|array $args AwayStatusReason data (assoc-array) to store.
     */
    ...
    /**
     * @return AwayStatusReason|array The current AwayStatusReason data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AwayStatusReason fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AwayStatusReason fields).
     */
    ...
    /**
     * List AwayStatusReason items matching the given filter.
     *
     * @param AwayStatusReasonListMatch|array|null $reqmatch Match filter (any subset
     *   of AwayStatusReason fields) as an assoc-array; AwayStatusReasonListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AwayStatusReason[]|array A list of AwayStatusReason items as assoc-arrays at
