...
class AudienceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AudienceEntity($this->_client, $opts);
    }

    /**
     * @param Audience|array $args Audience data (assoc-array) to store.
     */
    ...
    /**
     * @return Audience|array The current Audience data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Audience fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Audience fields).
     */
    ...
    /**
     * Load a single Audience.
     *
     * @param AudienceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AudienceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Audience|array The loaded Audience as an assoc-array at the
    ...
    /**
     * List Audience items matching the given filter.
     *
     * @param AudienceListMatch|array|null $reqmatch Match filter (any subset
     *   of Audience fields) as an assoc-array; AudienceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Audience[]|array A list of Audience items as assoc-arrays at
     ...
     *
     * @param AudienceCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AudienceCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Audience|array The created Audience as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
     ...
     *
     * @param AudienceUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AudienceUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Audience|array The updated Audience as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Audience matching the given criteria.
     *
     * @param AudienceRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AudienceRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Audience|array The removed Audience as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
