...
// Intercom SDK DeletedInternalArticleObject entity
...
class DeletedInternalArticleObjectEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "deleted_internal_article_object";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DeletedInternalArticleObjectEntity($this->_client, $opts);
    }

    /**
     * @param DeletedInternalArticleObject|array $args DeletedInternalArticleObject data (assoc-array) to store.
     */
    ...
    /**
     * @return DeletedInternalArticleObject|array The current DeletedInternalArticleObject data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeletedInternalArticleObject fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeletedInternalArticleObject fields).
     */
    ...
    /**
     * List DeletedInternalArticleObject items matching the given filter.
     *
     * @param DeletedInternalArticleObjectListMatch|array|null $reqmatch Match filter (any subset
     *   of DeletedInternalArticleObject fields) as an assoc-array; DeletedInternalArticleObjectListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeletedInternalArticleObject[]|array A list of DeletedInternalArticleObject items as assoc-arrays at
    ...
    /**
     * Create a new DeletedInternalArticleObject.
     *
     * @param DeletedInternalArticleObjectCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeletedInternalArticleObjectCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeletedInternalArticleObject|array The created DeletedInternalArticleObject as an assoc-array at the
    ...
    /**
     * Remove an DeletedInternalArticleObject matching the given criteria.
     *
     * @param DeletedInternalArticleObjectRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DeletedInternalArticleObjectRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeletedInternalArticleObject|array The removed DeletedInternalArticleObject as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
