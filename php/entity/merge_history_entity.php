...
class MergeHistoryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MergeHistoryEntity($this->_client, $opts);
    }

    /**
     * @param MergeHistory|array $args MergeHistory data (assoc-array) to store.
     */
    ...
    /**
     * @return MergeHistory|array The current MergeHistory data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of MergeHistory fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of MergeHistory fields).
     */
    ...
    /**
     * List MergeHistory items matching the given filter.
     *
     * @param MergeHistoryListMatch|array|null $reqmatch Match filter (any subset
     *   of MergeHistory fields) as an assoc-array; MergeHistoryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return MergeHistory[]|array A list of MergeHistory items as assoc-arrays at
