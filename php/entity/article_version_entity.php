...
class ArticleVersionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ArticleVersionEntity($this->_client, $opts);
    }

    /**
     * @param ArticleVersion|array $args ArticleVersion data (assoc-array) to store.
     */
    ...
    /**
     * @return ArticleVersion|array The current ArticleVersion data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ArticleVersion fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ArticleVersion fields).
     */
    ...
    /**
     * Load a single ArticleVersion.
     *
     * @param ArticleVersionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ArticleVersionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ArticleVersion|array The loaded ArticleVersion as an assoc-array at the
