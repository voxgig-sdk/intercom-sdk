...
class FinAgentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FinAgentEntity($this->_client, $opts);
    }

    /**
     * @param FinAgent|array $args FinAgent data (assoc-array) to store.
     */
    ...
    /**
     * @return FinAgent|array The current FinAgent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FinAgent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FinAgent fields).
     */
    ...
    /**
     * Create a new FinAgent.
     *
     * @param FinAgentCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FinAgentCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FinAgent|array The created FinAgent as an assoc-array at the
