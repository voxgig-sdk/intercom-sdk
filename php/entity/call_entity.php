...
class CallEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CallEntity($this->_client, $opts);
    }

    /**
     * @param Call|array $args Call data (assoc-array) to store.
     */
    ...
    /**
     * @return Call|array The current Call data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Call fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Call fields).
     */
     ...
     * Load a single Call.
     *
     * @param CallLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CallLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Call|array The loaded Call as an assoc-array at the
    ...
    /**
     * List Call items matching the given filter.
     *
     * @param CallListMatch|array|null $reqmatch Match filter (any subset
     *   of Call fields) as an assoc-array; CallListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Call[]|array A list of Call items as assoc-arrays at
     ...
     * Create a new Call.
     *
     * @param CallCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CallCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Call|array The created Call as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
