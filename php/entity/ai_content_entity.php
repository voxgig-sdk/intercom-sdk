...
class AiContentEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AiContentEntity($this->_client, $opts);
    }

    /**
     * @param AiContent|array $args AiContent data (assoc-array) to store.
     */
    ...
    /**
     * @return AiContent|array The current AiContent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AiContent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AiContent fields).
     */
    ...
    /**
     * Remove an AiContent matching the given criteria.
     *
     * @param AiContentRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AiContentRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiContent|array The removed AiContent as an assoc-array at the
