...
class WhatsappMessageStatusListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "whatsapp_message_status_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new WhatsappMessageStatusListEntity($this->_client, $opts);
    }

    /**
     * @param WhatsappMessageStatusList|array $args WhatsappMessageStatusList data (assoc-array) to store.
     */
    ...
    /**
     * @return WhatsappMessageStatusList|array The current WhatsappMessageStatusList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WhatsappMessageStatusList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WhatsappMessageStatusList fields).
     */
    ...
    /**
     * List WhatsappMessageStatusList items matching the given filter.
     *
     * @param WhatsappMessageStatusListListMatch|array|null $reqmatch Match filter (any subset
     *   of WhatsappMessageStatusList fields) as an assoc-array; WhatsappMessageStatusListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WhatsappMessageStatusList[]|array A list of WhatsappMessageStatusList items as assoc-arrays at
