...
class DataEventSummaryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DataEventSummaryEntity($this->_client, $opts);
    }

    /**
     * @param DataEventSummary|array $args DataEventSummary data (assoc-array) to store.
     */
    ...
    /**
     * @return DataEventSummary|array The current DataEventSummary data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DataEventSummary fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DataEventSummary fields).
     */
    ...
    /**
     * List DataEventSummary items matching the given filter.
     *
     * @param DataEventSummaryListMatch|array|null $reqmatch Match filter (any subset
     *   of DataEventSummary fields) as an assoc-array; DataEventSummaryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DataEventSummary[]|array A list of DataEventSummary items as assoc-arrays at
