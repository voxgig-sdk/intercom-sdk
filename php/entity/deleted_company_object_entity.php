...
class DeletedCompanyObjectEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "deleted_company_object";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DeletedCompanyObjectEntity($this->_client, $opts);
    }

    /**
     * @param DeletedCompanyObject|array $args DeletedCompanyObject data (assoc-array) to store.
     */
    ...
    /**
     * @return DeletedCompanyObject|array The current DeletedCompanyObject data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeletedCompanyObject fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeletedCompanyObject fields).
     */
    ...
    /**
     * Remove an DeletedCompanyObject matching the given criteria.
     *
     * @param DeletedCompanyObjectRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DeletedCompanyObjectRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeletedCompanyObject|array The removed DeletedCompanyObject as an assoc-array at the
