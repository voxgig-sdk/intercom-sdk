...
// Intercom SDK Conversation entity
...
class ConversationEntity
{
    ...
    /**
     * Remove an Conversation matching the given criteria.
     *
     * @param ConversationRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ConversationRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Conversation|array The removed Conversation as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
