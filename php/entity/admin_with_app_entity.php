...
class AdminWithAppEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdminWithAppEntity($this->_client, $opts);
    }

    /**
     * @param AdminWithApp|array $args AdminWithApp data (assoc-array) to store.
     */
    ...
    /**
     * @return AdminWithApp|array The current AdminWithApp data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AdminWithApp fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AdminWithApp fields).
     */
    ...
    /**
     * List AdminWithApp items matching the given filter.
     *
     * @param AdminWithAppListMatch|array|null $reqmatch Match filter (any subset
     *   of AdminWithApp fields) as an assoc-array; AdminWithAppListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AdminWithApp[]|array A list of AdminWithApp items as assoc-arrays at
