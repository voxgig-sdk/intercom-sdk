...
class BannerDismissEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BannerDismissEntity($this->_client, $opts);
    }

    /**
     * @param BannerDismiss|array $args BannerDismiss data (assoc-array) to store.
     */
    ...
    /**
     * @return BannerDismiss|array The current BannerDismiss data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BannerDismiss fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BannerDismiss fields).
     */
    ...
    /**
     * Create a new BannerDismiss.
     *
     * @param BannerDismissCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BannerDismissCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BannerDismiss|array The created BannerDismiss as an assoc-array at the
