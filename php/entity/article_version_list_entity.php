...
class ArticleVersionListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "article_version_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ArticleVersionListEntity($this->_client, $opts);
    }

    /**
     * @param ArticleVersionList|array $args ArticleVersionList data (assoc-array) to store.
     */
    ...
    /**
     * @return ArticleVersionList|array The current ArticleVersionList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ArticleVersionList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ArticleVersionList fields).
     */
    ...
    /**
     * List ArticleVersionList items matching the given filter.
     *
     * @param ArticleVersionListListMatch|array|null $reqmatch Match filter (any subset
     *   of ArticleVersionList fields) as an assoc-array; ArticleVersionListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ArticleVersionList[]|array A list of ArticleVersionList items as assoc-arrays at
