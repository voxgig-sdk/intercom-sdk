...
class CompanyAttachedSegmentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "company_attached_segment";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CompanyAttachedSegmentEntity($this->_client, $opts);
    }

    /**
     * @param CompanyAttachedSegment|array $args CompanyAttachedSegment data (assoc-array) to store.
     */
    ...
    /**
     * @return CompanyAttachedSegment|array The current CompanyAttachedSegment data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CompanyAttachedSegment fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CompanyAttachedSegment fields).
     */
    ...
    /**
     * List CompanyAttachedSegment items matching the given filter.
     *
     * @param CompanyAttachedSegmentListMatch|array|null $reqmatch Match filter (any subset
     *   of CompanyAttachedSegment fields) as an assoc-array; CompanyAttachedSegmentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CompanyAttachedSegment[]|array A list of CompanyAttachedSegment items as assoc-arrays at
