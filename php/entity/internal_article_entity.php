...
// Intercom SDK InternalArticle entity
...
class InternalArticleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InternalArticleEntity($this->_client, $opts);
    }

    /**
     * @param InternalArticle|array $args InternalArticle data (assoc-array) to store.
     */
    ...
    /**
     * @return InternalArticle|array The current InternalArticle data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of InternalArticle fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of InternalArticle fields).
     */
    ...
    /**
     * Load a single InternalArticle.
     *
     * @param InternalArticleLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed InternalArticleLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return InternalArticle|array The loaded InternalArticle as an assoc-array at the
    ...
    /**
     * Update an existing InternalArticle.
     *
     * @param InternalArticleUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed InternalArticleUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return InternalArticle|array The updated InternalArticle as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
