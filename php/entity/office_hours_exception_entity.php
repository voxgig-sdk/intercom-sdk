...
// Intercom SDK OfficeHoursException entity
...
class OfficeHoursExceptionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "office_hours_exception";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OfficeHoursExceptionEntity($this->_client, $opts);
    }

    /**
     * @param OfficeHoursException|array $args OfficeHoursException data (assoc-array) to store.
     */
    ...
    /**
     * @return OfficeHoursException|array The current OfficeHoursException data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OfficeHoursException fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OfficeHoursException fields).
     */
    ...
    /**
     * Load a single OfficeHoursException.
     *
     * @param OfficeHoursExceptionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed OfficeHoursExceptionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OfficeHoursException|array The loaded OfficeHoursException as an assoc-array at the
    ...
    /**
     * List OfficeHoursException items matching the given filter.
     *
     * @param OfficeHoursExceptionListMatch|array|null $reqmatch Match filter (any subset
     *   of OfficeHoursException fields) as an assoc-array; OfficeHoursExceptionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OfficeHoursException[]|array A list of OfficeHoursException items as assoc-arrays at
    ...
    /**
     * Create a new OfficeHoursException.
     *
     * @param OfficeHoursExceptionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OfficeHoursExceptionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OfficeHoursException|array The created OfficeHoursException as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing OfficeHoursException.
     *
     * @param OfficeHoursExceptionUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OfficeHoursExceptionUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OfficeHoursException|array The updated OfficeHoursException as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
