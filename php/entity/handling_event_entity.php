...
class HandlingEventEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HandlingEventEntity($this->_client, $opts);
    }

    /**
     * @param HandlingEvent|array $args HandlingEvent data (assoc-array) to store.
     */
    ...
    /**
     * @return HandlingEvent|array The current HandlingEvent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of HandlingEvent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of HandlingEvent fields).
     */
    ...
    /**
     * List HandlingEvent items matching the given filter.
     *
     * @param HandlingEventListMatch|array|null $reqmatch Match filter (any subset
     *   of HandlingEvent fields) as an assoc-array; HandlingEventListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return HandlingEvent[]|array A list of HandlingEvent items as assoc-arrays at
