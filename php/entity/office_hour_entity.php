...
// Intercom SDK OfficeHour entity
...
class OfficeHourEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new OfficeHourEntity($this->_client, $opts);
    }

    /**
     * @param OfficeHour|array $args OfficeHour data (assoc-array) to store.
     */
    ...
    /**
     * @return OfficeHour|array The current OfficeHour data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OfficeHour fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OfficeHour fields).
     */
    ...
    /**
     * List OfficeHour items matching the given filter.
     *
     * @param OfficeHourListMatch|array|null $reqmatch Match filter (any subset
     *   of OfficeHour fields) as an assoc-array; OfficeHourListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OfficeHour[]|array A list of OfficeHour items as assoc-arrays at
    ...
    /**
     * Create a new OfficeHour.
     *
     * @param OfficeHourCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OfficeHourCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OfficeHour|array The created OfficeHour as an assoc-array at the
    ...
    /**
     * Remove an OfficeHour matching the given criteria.
     *
     * @param OfficeHourRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; OfficeHourRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OfficeHour|array The removed OfficeHour as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
