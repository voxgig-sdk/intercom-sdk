...
// Intercom SDK ExternalPage entity
...
class ExternalPageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ExternalPageEntity($this->_client, $opts);
    }

    /**
     * @param ExternalPage|array $args ExternalPage data (assoc-array) to store.
     */
    ...
    /**
     * @return ExternalPage|array The current ExternalPage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ExternalPage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ExternalPage fields).
     */
    ...
    /**
     * Load a single ExternalPage.
     *
     * @param ExternalPageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ExternalPageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ExternalPage|array The loaded ExternalPage as an assoc-array at the
    ...
    /**
     * List ExternalPage items matching the given filter.
     *
     * @param ExternalPageListMatch|array|null $reqmatch Match filter (any subset
     *   of ExternalPage fields) as an assoc-array; ExternalPageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ExternalPage[]|array A list of ExternalPage items as assoc-arrays at
    ...
    /**
     * Create a new ExternalPage.
     *
     * @param ExternalPageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ExternalPageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ExternalPage|array The created ExternalPage as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ExternalPage.
     *
     * @param ExternalPageUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ExternalPageUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ExternalPage|array The updated ExternalPage as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an ExternalPage matching the given criteria.
     *
     * @param ExternalPageRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ExternalPageRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ExternalPage|array The removed ExternalPage as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
