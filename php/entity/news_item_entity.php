...
class NewsItemEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NewsItemEntity($this->_client, $opts);
    }

    /**
     * @param NewsItem|array $args NewsItem data (assoc-array) to store.
     */
    ...
    /**
     * @return NewsItem|array The current NewsItem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NewsItem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NewsItem fields).
     */
    ...
    /**
     * Load a single NewsItem.
     *
     * @param NewsItemLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NewsItemLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NewsItem|array The loaded NewsItem as an assoc-array at the
     ...
     *
     * @param NewsItemCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NewsItemCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NewsItem|array The created NewsItem as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
     ...
     *
     * @param NewsItemUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NewsItemUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NewsItem|array The updated NewsItem as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
