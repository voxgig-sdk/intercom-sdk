...
class ContactAttachedCompanyEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "contact_attached_company";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ContactAttachedCompanyEntity($this->_client, $opts);
    }

    /**
     * @param ContactAttachedCompany|array $args ContactAttachedCompany data (assoc-array) to store.
     */
    ...
    /**
     * @return ContactAttachedCompany|array The current ContactAttachedCompany data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ContactAttachedCompany fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ContactAttachedCompany fields).
     */
    ...
    /**
     * List ContactAttachedCompany items matching the given filter.
     *
     * @param ContactAttachedCompanyListMatch|array|null $reqmatch Match filter (any subset
     *   of ContactAttachedCompany fields) as an assoc-array; ContactAttachedCompanyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContactAttachedCompany[]|array A list of ContactAttachedCompany items as assoc-arrays at
