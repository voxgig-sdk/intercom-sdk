...
class ActivityLogEventTypeEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "activity_log_event_type";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ActivityLogEventTypeEntity($this->_client, $opts);
    }

    /**
     * @param ActivityLogEventType|array $args ActivityLogEventType data (assoc-array) to store.
     */
    ...
    /**
     * @return ActivityLogEventType|array The current ActivityLogEventType data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActivityLogEventType fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActivityLogEventType fields).
     */
    ...
    /**
     * List ActivityLogEventType items matching the given filter.
     *
     * @param ActivityLogEventTypeListMatch|array|null $reqmatch Match filter (any subset
     *   of ActivityLogEventType fields) as an assoc-array; ActivityLogEventTypeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActivityLogEventType[]|array A list of ActivityLogEventType items as assoc-arrays at
