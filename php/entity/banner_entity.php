...
class BannerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BannerEntity($this->_client, $opts);
    }

    /**
     * @param Banner|array $args Banner data (assoc-array) to store.
     */
    ...
    /**
     * @return Banner|array The current Banner data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Banner fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Banner fields).
     */
    ...
    /**
     * List Banner items matching the given filter.
     *
     * @param BannerListMatch|array|null $reqmatch Match filter (any subset
     *   of Banner fields) as an assoc-array; BannerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Banner[]|array A list of Banner items as assoc-arrays at
