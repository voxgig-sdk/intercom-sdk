...
class InternalArticleSearchEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "internal_article_search";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new InternalArticleSearchEntity($this->_client, $opts);
    }

    /**
     * @param InternalArticleSearch|array $args InternalArticleSearch data (assoc-array) to store.
     */
    ...
    /**
     * @return InternalArticleSearch|array The current InternalArticleSearch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of InternalArticleSearch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of InternalArticleSearch fields).
     */
    ...
    /**
     * Load a single InternalArticleSearch.
     *
     * @param InternalArticleSearchLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed InternalArticleSearchLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return InternalArticleSearch|array The loaded InternalArticleSearch as an assoc-array at the
