...
class NewsfeedEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NewsfeedEntity($this->_client, $opts);
    }

    /**
     * @param Newsfeed|array $args Newsfeed data (assoc-array) to store.
     */
    ...
    /**
     * @return Newsfeed|array The current Newsfeed data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Newsfeed fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Newsfeed fields).
     */
    ...
    /**
     * Load a single Newsfeed.
     *
     * @param NewsfeedLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NewsfeedLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Newsfeed|array The loaded Newsfeed as an assoc-array at the
