...
// Intercom SDK IpAllowlist entity
...
class IpAllowlistEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IpAllowlistEntity($this->_client, $opts);
    }

    /**
     * @param IpAllowlist|array $args IpAllowlist data (assoc-array) to store.
     */
    ...
    /**
     * @return IpAllowlist|array The current IpAllowlist data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IpAllowlist fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IpAllowlist fields).
     */
    ...
    /**
     * List IpAllowlist items matching the given filter.
     *
     * @param IpAllowlistListMatch|array|null $reqmatch Match filter (any subset
     *   of IpAllowlist fields) as an assoc-array; IpAllowlistListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IpAllowlist[]|array A list of IpAllowlist items as assoc-arrays at
    ...
    /**
     * Update an existing IpAllowlist.
     *
     * @param IpAllowlistUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IpAllowlistUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IpAllowlist|array The updated IpAllowlist as an assoc-array at the
