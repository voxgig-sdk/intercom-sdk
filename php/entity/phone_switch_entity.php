...
class PhoneSwitchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PhoneSwitchEntity($this->_client, $opts);
    }

    /**
     * @param PhoneSwitch|array $args PhoneSwitch data (assoc-array) to store.
     */
    ...
    /**
     * @return PhoneSwitch|array The current PhoneSwitch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PhoneSwitch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PhoneSwitch fields).
     */
    ...
    /**
     * Create a new PhoneSwitch.
     *
     * @param PhoneSwitchCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PhoneSwitchCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PhoneSwitch|array The created PhoneSwitch as an assoc-array at the
