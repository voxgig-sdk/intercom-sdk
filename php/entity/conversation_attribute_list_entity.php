...
class ConversationAttributeListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversation_attribute_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationAttributeListEntity($this->_client, $opts);
    }

    /**
     * @param ConversationAttributeList|array $args ConversationAttributeList data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationAttributeList|array The current ConversationAttributeList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationAttributeList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationAttributeList fields).
     */
    ...
    /**
     * List ConversationAttributeList items matching the given filter.
     *
     * @param ConversationAttributeListListMatch|array|null $reqmatch Match filter (any subset
     *   of ConversationAttributeList fields) as an assoc-array; ConversationAttributeListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationAttributeList[]|array A list of ConversationAttributeList items as assoc-arrays at
