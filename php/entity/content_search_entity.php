...
class ContentSearchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ContentSearchEntity($this->_client, $opts);
    }

    /**
     * @param ContentSearch|array $args ContentSearch data (assoc-array) to store.
     */
    ...
    /**
     * @return ContentSearch|array The current ContentSearch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ContentSearch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ContentSearch fields).
     */
    ...
    /**
     * List ContentSearch items matching the given filter.
     *
     * @param ContentSearchListMatch|array|null $reqmatch Match filter (any subset
     *   of ContentSearch fields) as an assoc-array; ContentSearchListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContentSearch[]|array A list of ContentSearch items as assoc-arrays at
