...
class AiCallEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AiCallEntity($this->_client, $opts);
    }

    /**
     * @param AiCall|array $args AiCall data (assoc-array) to store.
     */
    ...
    /**
     * @return AiCall|array The current AiCall data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AiCall fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AiCall fields).
     */
    ...
    /**
     * Load a single AiCall.
     *
     * @param AiCallLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AiCallLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiCall|array The loaded AiCall as an assoc-array at the
     ...
     * Create a new AiCall.
     *
     * @param AiCallCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AiCallCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiCall|array The created AiCall as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
