...
class ConversationParticipantEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversation_participant";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationParticipantEntity($this->_client, $opts);
    }

    /**
     * @param ConversationParticipant|array $args ConversationParticipant data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationParticipant|array The current ConversationParticipant data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationParticipant fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationParticipant fields).
     */
     ...
     *
     * @param ConversationParticipantCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConversationParticipantCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationParticipant|array The created ConversationParticipant as an assoc-array at the
    ...
    /**
     * Remove an ConversationParticipant matching the given criteria.
     *
     * @param ConversationParticipantRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ConversationParticipantRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationParticipant|array The removed ConversationParticipant as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
