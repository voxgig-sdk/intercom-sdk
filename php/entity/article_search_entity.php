...
class ArticleSearchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ArticleSearchEntity($this->_client, $opts);
    }

    /**
     * @param ArticleSearch|array $args ArticleSearch data (assoc-array) to store.
     */
    ...
    /**
     * @return ArticleSearch|array The current ArticleSearch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ArticleSearch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ArticleSearch fields).
     */
    ...
    /**
     * Load a single ArticleSearch.
     *
     * @param ArticleSearchLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ArticleSearchLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ArticleSearch|array The loaded ArticleSearch as an assoc-array at the
