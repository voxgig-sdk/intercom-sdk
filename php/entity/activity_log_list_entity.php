...
class ActivityLogListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ActivityLogListEntity($this->_client, $opts);
    }

    /**
     * @param ActivityLogList|array $args ActivityLogList data (assoc-array) to store.
     */
    ...
    /**
     * @return ActivityLogList|array The current ActivityLogList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActivityLogList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActivityLogList fields).
     */
    ...
    /**
     * Create a new ActivityLogList.
     *
     * @param ActivityLogListCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ActivityLogListCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActivityLogList|array The created ActivityLogList as an assoc-array at the
