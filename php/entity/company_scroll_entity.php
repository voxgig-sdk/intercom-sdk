...
class CompanyScrollEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CompanyScrollEntity($this->_client, $opts);
    }

    /**
     * @param CompanyScroll|array $args CompanyScroll data (assoc-array) to store.
     */
    ...
    /**
     * @return CompanyScroll|array The current CompanyScroll data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CompanyScroll fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CompanyScroll fields).
     */
    ...
    /**
     * List CompanyScroll items matching the given filter.
     *
     * @param CompanyScrollListMatch|array|null $reqmatch Match filter (any subset
     *   of CompanyScroll fields) as an assoc-array; CompanyScrollListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CompanyScroll[]|array A list of CompanyScroll items as assoc-arrays at
