...
class AdminEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AdminEntity($this->_client, $opts);
    }

    /**
     * @param Admin|array $args Admin data (assoc-array) to store.
     */
    ...
    /**
     * @return Admin|array The current Admin data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Admin fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Admin fields).
     */
     ...
     * Load a single Admin.
     *
     * @param AdminLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AdminLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Admin|array The loaded Admin as an assoc-array at the
    ...
    /**
     * List Admin items matching the given filter.
     *
     * @param AdminListMatch|array|null $reqmatch Match filter (any subset
     *   of Admin fields) as an assoc-array; AdminListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Admin[]|array A list of Admin items as assoc-arrays at
     ...
     *
     * @param AdminUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AdminUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Admin|array The updated Admin as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
