...
// Intercom SDK TicketType entity
...
class TicketTypeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TicketTypeEntity($this->_client, $opts);
    }

    /**
     * @param TicketType|array $args TicketType data (assoc-array) to store.
     */
    ...
    /**
     * @return TicketType|array The current TicketType data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TicketType fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TicketType fields).
     */
    ...
    /**
     * Load a single TicketType.
     *
     * @param TicketTypeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TicketTypeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TicketType|array The loaded TicketType as an assoc-array at the
    ...
    /**
     * List TicketType items matching the given filter.
     *
     * @param TicketTypeListMatch|array|null $reqmatch Match filter (any subset
     *   of TicketType fields) as an assoc-array; TicketTypeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TicketType[]|array A list of TicketType items as assoc-arrays at
     ...
     *
     * @param TicketTypeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TicketTypeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TicketType|array The created TicketType as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
     ...
     *
     * @param TicketTypeUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TicketTypeUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TicketType|array The updated TicketType as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
