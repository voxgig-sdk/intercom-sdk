...
class TeamMetricListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TeamMetricListEntity($this->_client, $opts);
    }

    /**
     * @param TeamMetricList|array $args TeamMetricList data (assoc-array) to store.
     */
    ...
    /**
     * @return TeamMetricList|array The current TeamMetricList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TeamMetricList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TeamMetricList fields).
     */
    ...
    /**
     * List TeamMetricList items matching the given filter.
     *
     * @param TeamMetricListListMatch|array|null $reqmatch Match filter (any subset
     *   of TeamMetricList fields) as an assoc-array; TeamMetricListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TeamMetricList[]|array A list of TeamMetricList items as assoc-arrays at
