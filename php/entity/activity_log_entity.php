...
class ActivityLogEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ActivityLogEntity($this->_client, $opts);
    }

    /**
     * @param ActivityLog|array $args ActivityLog data (assoc-array) to store.
     */
    ...
    /**
     * @return ActivityLog|array The current ActivityLog data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ActivityLog fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ActivityLog fields).
     */
    ...
    /**
     * List ActivityLog items matching the given filter.
     *
     * @param ActivityLogListMatch|array|null $reqmatch Match filter (any subset
     *   of ActivityLog fields) as an assoc-array; ActivityLogListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActivityLog[]|array A list of ActivityLog items as assoc-arrays at
