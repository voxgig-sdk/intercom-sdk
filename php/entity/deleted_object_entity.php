...
class DeletedObjectEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DeletedObjectEntity($this->_client, $opts);
    }

    /**
     * @param DeletedObject|array $args DeletedObject data (assoc-array) to store.
     */
    ...
    /**
     * @return DeletedObject|array The current DeletedObject data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeletedObject fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeletedObject fields).
     */
    ...
    /**
     * Remove an DeletedObject matching the given criteria.
     *
     * @param DeletedObjectRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DeletedObjectRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeletedObject|array The removed DeletedObject as an assoc-array at the
