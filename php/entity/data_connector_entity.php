...
// Intercom SDK DataConnector entity
...
class DataConnectorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DataConnectorEntity($this->_client, $opts);
    }

    /**
     * @param DataConnector|array $args DataConnector data (assoc-array) to store.
     */
    ...
    /**
     * @return DataConnector|array The current DataConnector data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DataConnector fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DataConnector fields).
     */
    ...
    /**
     * Load a single DataConnector.
     *
     * @param DataConnectorLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DataConnectorLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DataConnector|array The loaded DataConnector as an assoc-array at the
    ...
    /**
     * List DataConnector items matching the given filter.
     *
     * @param DataConnectorListMatch|array|null $reqmatch Match filter (any subset
     *   of DataConnector fields) as an assoc-array; DataConnectorListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DataConnector[]|array A list of DataConnector items as assoc-arrays at
     ...
     *
     * @param DataConnectorCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DataConnectorCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DataConnector|array The created DataConnector as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing DataConnector.
     *
     * @param DataConnectorUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DataConnectorUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DataConnector|array The updated DataConnector as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
