...
class DataExportEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DataExportEntity($this->_client, $opts);
    }

    /**
     * @param DataExport|array $args DataExport data (assoc-array) to store.
     */
    ...
    /**
     * @return DataExport|array The current DataExport data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DataExport fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DataExport fields).
     */
     ...
     *
     * @param DataExportCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DataExportCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DataExport|array The created DataExport as an assoc-array at the
