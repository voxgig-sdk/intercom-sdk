...
// Intercom SDK CustomObjectInstance entity
...
class CustomObjectInstanceEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "custom_object_instance";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CustomObjectInstanceEntity($this->_client, $opts);
    }

    /**
     * @param CustomObjectInstance|array $args CustomObjectInstance data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomObjectInstance|array The current CustomObjectInstance data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomObjectInstance fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomObjectInstance fields).
     */
    ...
    /**
     * Load a single CustomObjectInstance.
     *
     * @param CustomObjectInstanceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CustomObjectInstanceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomObjectInstance|array The loaded CustomObjectInstance as an assoc-array at the
    ...
    /**
     * Create a new CustomObjectInstance.
     *
     * @param CustomObjectInstanceCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomObjectInstanceCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomObjectInstance|array The created CustomObjectInstance as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an CustomObjectInstance matching the given criteria.
     *
     * @param CustomObjectInstanceRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CustomObjectInstanceRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomObjectInstance|array The removed CustomObjectInstance as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
