...
// Intercom SDK ContentSnippet entity
...
class ContentSnippetEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ContentSnippetEntity($this->_client, $opts);
    }

    /**
     * @param ContentSnippet|array $args ContentSnippet data (assoc-array) to store.
     */
    ...
    /**
     * @return ContentSnippet|array The current ContentSnippet data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ContentSnippet fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ContentSnippet fields).
     */
    ...
    /**
     * Load a single ContentSnippet.
     *
     * @param ContentSnippetLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ContentSnippetLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContentSnippet|array The loaded ContentSnippet as an assoc-array at the
    ...
    /**
     * List ContentSnippet items matching the given filter.
     *
     * @param ContentSnippetListMatch|array|null $reqmatch Match filter (any subset
     *   of ContentSnippet fields) as an assoc-array; ContentSnippetListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContentSnippet[]|array A list of ContentSnippet items as assoc-arrays at
    ...
    /**
     * Create a new ContentSnippet.
     *
     * @param ContentSnippetCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ContentSnippetCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContentSnippet|array The created ContentSnippet as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ContentSnippet.
     *
     * @param ContentSnippetUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ContentSnippetUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContentSnippet|array The updated ContentSnippet as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an ContentSnippet matching the given criteria.
     *
     * @param ContentSnippetRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ContentSnippetRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContentSnippet|array The removed ContentSnippet as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
