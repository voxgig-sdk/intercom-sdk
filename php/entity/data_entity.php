...
class DataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DataEntity($this->_client, $opts);
    }

    /**
     * @param Data|array $args Data data (assoc-array) to store.
     */
    ...
    /**
     * @return Data|array The current Data data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Data fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Data fields).
     */
     ...
     * Load a single Data.
     *
     * @param DataLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DataLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Data|array The loaded Data as an assoc-array at the
     ...
     * Create a new Data.
     *
     * @param DataCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DataCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Data|array The created Data as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
