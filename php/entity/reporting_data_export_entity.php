...
// Intercom SDK ReportingDataExport entity
...
class ReportingDataExportEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "reporting_data_export";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ReportingDataExportEntity($this->_client, $opts);
    }

    /**
     * @param ReportingDataExport|array $args ReportingDataExport data (assoc-array) to store.
     */
    ...
    /**
     * @return ReportingDataExport|array The current ReportingDataExport data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ReportingDataExport fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ReportingDataExport fields).
     */
    ...
    /**
     * List ReportingDataExport items matching the given filter.
     *
     * @param ReportingDataExportListMatch|array|null $reqmatch Match filter (any subset
     *   of ReportingDataExport fields) as an assoc-array; ReportingDataExportListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReportingDataExport[]|array A list of ReportingDataExport items as assoc-arrays at
    ...
    /**
     * Create a new ReportingDataExport.
     *
     * @param ReportingDataExportCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ReportingDataExportCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ReportingDataExport|array The created ReportingDataExport as an assoc-array at the
