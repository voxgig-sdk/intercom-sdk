...
class TicketEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TicketEntity($this->_client, $opts);
    }

    /**
     * @param Ticket|array $args Ticket data (assoc-array) to store.
     */
    ...
    /**
     * @return Ticket|array The current Ticket data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Ticket fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Ticket fields).
     */
     ...
     *
     * @param TicketLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TicketLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ticket|array The loaded Ticket as an assoc-array at the
     ...
     * Create a new Ticket.
     *
     * @param TicketCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TicketCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ticket|array The created Ticket as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
     ...
     *
     * @param TicketUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TicketUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ticket|array The updated Ticket as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Ticket matching the given criteria.
     *
     * @param TicketRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; TicketRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Ticket|array The removed Ticket as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
