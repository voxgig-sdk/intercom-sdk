...
// Intercom SDK ConversationAttribute entity
...
class ConversationAttributeEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversation_attribute";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationAttributeEntity($this->_client, $opts);
    }

    /**
     * @param ConversationAttribute|array $args ConversationAttribute data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationAttribute|array The current ConversationAttribute data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationAttribute fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationAttribute fields).
     */
    ...
    /**
     * Load a single ConversationAttribute.
     *
     * @param ConversationAttributeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationAttributeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationAttribute|array The loaded ConversationAttribute as an assoc-array at the
    ...
    /**
     * Create a new ConversationAttribute.
     *
     * @param ConversationAttributeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConversationAttributeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationAttribute|array The created ConversationAttribute as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ConversationAttribute.
     *
     * @param ConversationAttributeUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConversationAttributeUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationAttribute|array The updated ConversationAttribute as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an ConversationAttribute matching the given criteria.
     *
     * @param ConversationAttributeRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ConversationAttributeRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationAttribute|array The removed ConversationAttribute as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
