...
class SideConversationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SideConversationEntity($this->_client, $opts);
    }

    /**
     * @param SideConversation|array $args SideConversation data (assoc-array) to store.
     */
    ...
    /**
     * @return SideConversation|array The current SideConversation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SideConversation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SideConversation fields).
     */
    ...
    /**
     * List SideConversation items matching the given filter.
     *
     * @param SideConversationListMatch|array|null $reqmatch Match filter (any subset
     *   of SideConversation fields) as an assoc-array; SideConversationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SideConversation[]|array A list of SideConversation items as assoc-arrays at
