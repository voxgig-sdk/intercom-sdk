...
class WorkflowEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WorkflowEntity($this->_client, $opts);
    }

    /**
     * @param Workflow|array $args Workflow data (assoc-array) to store.
     */
    ...
    /**
     * @return Workflow|array The current Workflow data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Workflow fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Workflow fields).
     */
     ...
     *
     * @param WorkflowLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WorkflowLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Workflow|array The loaded Workflow as an assoc-array at the
