...
class TicketListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TicketListEntity($this->_client, $opts);
    }

    /**
     * @param TicketList|array $args TicketList data (assoc-array) to store.
     */
    ...
    /**
     * @return TicketList|array The current TicketList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TicketList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TicketList fields).
     */
     ...
     *
     * @param TicketListCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TicketListCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TicketList|array The created TicketList as an assoc-array at the
