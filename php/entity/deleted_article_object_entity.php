...
class DeletedArticleObjectEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "deleted_article_object";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new DeletedArticleObjectEntity($this->_client, $opts);
    }

    /**
     * @param DeletedArticleObject|array $args DeletedArticleObject data (assoc-array) to store.
     */
    ...
    /**
     * @return DeletedArticleObject|array The current DeletedArticleObject data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DeletedArticleObject fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DeletedArticleObject fields).
     */
    ...
    /**
     * Remove an DeletedArticleObject matching the given criteria.
     *
     * @param DeletedArticleObjectRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DeletedArticleObjectRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DeletedArticleObject|array The removed DeletedArticleObject as an assoc-array at the
