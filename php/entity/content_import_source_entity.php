...
// Intercom SDK ContentImportSource entity
...
class ContentImportSourceEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "content_import_source";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ContentImportSourceEntity($this->_client, $opts);
    }

    /**
     * @param ContentImportSource|array $args ContentImportSource data (assoc-array) to store.
     */
    ...
    /**
     * @return ContentImportSource|array The current ContentImportSource data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ContentImportSource fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ContentImportSource fields).
     */
    ...
    /**
     * Load a single ContentImportSource.
     *
     * @param ContentImportSourceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ContentImportSourceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContentImportSource|array The loaded ContentImportSource as an assoc-array at the
    ...
    /**
     * List ContentImportSource items matching the given filter.
     *
     * @param ContentImportSourceListMatch|array|null $reqmatch Match filter (any subset
     *   of ContentImportSource fields) as an assoc-array; ContentImportSourceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContentImportSource[]|array A list of ContentImportSource items as assoc-arrays at
    ...
    /**
     * Create a new ContentImportSource.
     *
     * @param ContentImportSourceCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ContentImportSourceCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContentImportSource|array The created ContentImportSource as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ContentImportSource.
     *
     * @param ContentImportSourceUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ContentImportSourceUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ContentImportSource|array The updated ContentImportSource as an assoc-array at the
     *   SDK boundary; throws IntercomError on failure (item-5 convention).
     */
