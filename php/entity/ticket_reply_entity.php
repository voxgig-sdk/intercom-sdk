...
class TicketReplyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TicketReplyEntity($this->_client, $opts);
    }

    /**
     * @param TicketReply|array $args TicketReply data (assoc-array) to store.
     */
    ...
    /**
     * @return TicketReply|array The current TicketReply data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TicketReply fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TicketReply fields).
     */
     ...
     *
     * @param TicketReplyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TicketReplyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TicketReply|array The created TicketReply as an assoc-array at the
