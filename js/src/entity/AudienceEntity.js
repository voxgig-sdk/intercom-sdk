...
class AudienceEntity extends IntercomEntityBase {
  ...
  /**
   * @param {AudienceLoadMatch} [reqmatch]
   * @param {Object} [ctrl]
  ...
  /**
   * @param {AudienceListMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Audience[]>}
   */
  ...
  /**
   * @param {AudienceCreateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<Audience>}
   */
  ...
  /**
   * @param {AudienceUpdateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<Audience>}
   */
  ...
  /**
   * @param {AudienceRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Audience>}
   */
