...
describe('AdminEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    const admin_ref01_match = {}

    const admin_ref01_list = (await admin_ref01_ent.list(admin_ref01_match)).map((e) => e.data())
    ...
    assert(admin_ref01_resdata_up0[admin_ref01_markdef_up0.name] === admin_ref01_markdef_up0.value)


    // LOAD
    const admin_ref01_match_dt0 = {}
